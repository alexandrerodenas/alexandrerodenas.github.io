import{P as Z,j as O,p as x,y as L,h as q,dW as z,dX as F,dY as B,cM as _,t as P,N as v,dN as H,a2 as X,V as J,dZ as Y,d_ as Q,d$ as tt,e0 as et,e1 as nt,k as ot,dJ as rt,e2 as st,e3 as lt,e4 as it,df as at,de as ct,dd as ut,dk as ht,dj as ft,dl as pt,di as gt,dh as wt,dm as W,dq as dt,dp as mt,dn as It,e5 as V}from"./index-61yXXHxL.js";import{c as Et,r as Rt,s as yt,a as St,b as Tt,d as Mt,u as vt}from"./Unique_impl-Cds87zow.js";/**
 * @license
 ...
 * limitations under the License.
 * =============================================================================
 */function y(e){return(t,n,o,r,a)=>{const s=Z(t,n),l=s.length,i=O(s),c=x(s),h=L(a,c),f=t.length,w=n.length,d=O(t),g=O(n),I=q(t,s),u=q(n,s);if(I.length+u.length===0)for(let p=0;p<h.length;++p)h[p]=e(o[p%o.length],r[p%r.length]);else for(let p=0;p<h.length;++p){const m=z(p,l,i),R=m.slice(-f);I.forEach(b=>R[b]=0);const E=F(R,f,d),S=m.slice(-w);u.forEach(b=>S[b]=0);const T=F(S,w,g);h[p]=e(o[E],r[T])}return[h,s]}}/**
 * @license
 * Copyright 2020 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
 ...
 * limitations under the License.
 * =============================================================================
 */function bt(e,t,n,o){if(o==="int32"){const r=Int32Array.from(e);return[t,"int32",r]}if(o==="bool"){const r=B([0],n),[a,s]=y((l,i)=>l!==i?1:0)(t,[],e,r,"bool");return[s,"bool",a]}throw new Error(`Error in Cast: failed to cast ${n} to ${o}`)}/**
 * @license
 * Copyright 2020 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
 ...
 * limitations under the License.
 * =============================================================================
 */function Jt(e,t,n,o,r){const a=t.length,s=x(t),l=O(t),i=O(r),c=L(n,x(r));for(let h=0;h<s;++h){const f=z(h,a,l),w=new Array(f.length);for(let g=0;g<w.length;g++)w[g]=f[o[g]];const d=F(w,a,i);c[d]=e[h]}return c}/**
 * @license
 * Copyright 2020 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
 ...
 * limitations under the License.
 * =============================================================================
 */function Yt(e,t,n,o){const[r,a]=X(e,o),s=J(t,"int32"),l=_(x(r),s),i=x(a);for(let c=0;c<l.length;++c){const h=c*i;let f=1;for(let w=0;w<i;++w)f*=n[h+w];l[c]=f}return{outVals:l,outShape:r,outDtype:s}}/**
 * @license
 ...
 * limitations under the License.
 * =============================================================================
 */function pe(e,t,n,o,r,a=!1,s=0){const l=o.length,i=[t[0],e.length/t[0]],c=i[1],f=l>0?r[l-1]+1:0;if(f<0)throw new Error(W());const w=t.slice();w[0]=f;const d=w.reduce((R,E)=>R*E,1),g=v(n,d);if(l===0)return f>0&&g.fill(s),[g,w];if(f<=0)throw new Error(W());let I=0,u=1,p=0,m=r[I];for(;;){let R=0;if(u<l){if(R=r[u],m===R){++u;continue}if(m>=R)throw new Error(dt())}if(m<0||m>=f)throw new Error(mt(m,f));m>p&&g.fill(s,p*c,m*c);for(let E=I;E<u;++E){const S=o[E];if(S<0||S>=i[0])throw new Error(It(E,o[E],i[0]));for(let T=0;T<c;T++)g[m*c+T]+=e[S*c+T]}if(a)for(let E=0;E<c;E++)g[m*c+E]/=u-I;if(I=u,++u,p=m+1,m=R,u>l)break}return p<f&&g.fill(s,p*c,f*c),[g,w]}/**
 * @license
 * Copyright 2020 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the License);
 * you may not use this file except in compliance with the License.
 ...
 * limitations under the License.
 * =============================================================================
 */const we=y((e,t)=>{const n=e-t;return n*n});/**
 * @license
 * Copyright 2023 Google LLC.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
 ...
 * limitations under the License.
 * =============================================================================
 */const Te=Object.freeze(Object.defineProperty({__proto__:null,addImpl:Pt,bincountImpl:Dt,bincountReduceImpl:Ot,bitwiseAndImpl:Vt,castImpl:bt,ceilImpl:At,concatImpl:Et,equalImpl:Lt,expImpl:$t,expm1Impl:jt,floorDivImpl:zt,floorImpl:Ft,gatherNdImpl:_t,gatherV2Impl:qt,greaterEqualImpl:Ct,greaterImpl:Wt,lessEqualImpl:Nt,lessImpl:kt,linSpaceImpl:Gt,logImpl:Kt,maxImpl:Ut,maximumImpl:Zt,minimumImpl:Bt,multiplyImpl:K,negImpl:Ht,notEqualImpl:Xt,prodImpl:Yt,raggedGatherImpl:se,raggedRangeImpl:le,raggedTensorToTensorImpl:ie,rangeImpl:Rt,rsqrtImpl:ae,scatterImpl:ce,sigmoidImpl:ue,simpleAbsImpl:xt,sliceImpl:yt,sparseFillEmptyRowsImpl:he,sparseReshapeImpl:fe,sparseSegmentReductionImpl:pe,sqrtImpl:ge,squaredDifferenceImpl:we,staticRegexReplaceImpl:de,stridedSliceImpl:me,stringNGramsImpl:St,stringSplitImpl:Tt,stringToHashBucketFastImpl:Mt,subImpl:Ie,tileImpl:Ee,topKImpl:Re,transposeImpl:Jt,uniqueImpl:vt},Symbol.toStringTag,{value:"Module"}));export{Te as s};
