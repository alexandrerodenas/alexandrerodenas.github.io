import{_ as Rn,P as Ct,p as F,X as Js,Y as Ys,Z as Zs,$ as eu,a0 as En,T as tu,d5 as nu,a1 as Pn,a3 as rt,a4 as tn,a5 as je,a9 as Wn,a6 as Se,a2 as Oe,a7 as Be,aa as Tn,ab as au,ac as ru,ad as su,ae as uu,af as ou,ag as iu,ah as du,ak as On,al as st,am as cu,an as Ft,ao as pu,ap as lu,R as mu,O as fu,k as ge,aq as Bn,ar as hu,as as gu,d6 as bu,j as fe,d7 as _u,au as yu,av as Hn,aw as $n,ax as Vn,ay as Iu,az as wu,aA as Ln,d8 as ku,aB as Su,aE as Mu,aH as vu,aI as zn,aM as Au,aN as xu,aK as Gt,d9 as Du,aO as Un,aP as Gn,aQ as ut,aS as jn,aT as qn,aU as nn,aV as Xn,aW as Kn,aX as Nu,aY as Cu,aZ as Qn,a$ as Jn,a_ as Yn,b0 as Zn,b1 as Fu,b2 as ea,b3 as ta,b6 as Ru,b7 as na,b8 as an,b9 as aa,ba as ra,bk as Eu,bl as sa,bm as Pu,bn as Wu,bo as Tu,bp as Ou,bq as Bu,J as Hu,M as $u,bs as ua,bt as Vu,bu as Lu,bw as oa,bx as ia,by as da,bA as ca,bB as zu,bC as Uu,bD as Gu,bE as ju,bF as qu,bH as Xu,bI as Ku,bJ as Qu,bK as pa,bL as Ju,bM as Yu,bN as la,bO as Zu,bP as eo,bQ as to,bR as no,bS as ao,da as ro,bT as ma,bU as fa,ai as ha,bV as so,bW as ga,bX as uo,bY as oo,bZ as io,b_ as co,bz as po,aj as ba,b$ as _a,c0 as lo,c1 as ya,c3 as Ia,c4 as wa,c2 as mo,bc as fo,c5 as ho,c6 as ka,db as Sa,c8 as Ma,aC as go,ca as va,cc as bo,cd as _o,ce as yo,cf as Aa,cg as Io,ch as xa,ci as Da,cj as wo,ck as ko,cl as So,cm as Mo,cn as vo,co as Na,cp as Ca,cq as Fa,cr as Ra,cs as Ea,ct as Pa,cu as Ao,cv as xo,cw as Do,cx as Wa,cy as rn,cz as Ta,cA as No,cB as Co,cC as Fo,cD as Ro,cE as Eo,cF as Po,cG as Wo,cH as To,dc as Oo,dd as Bo,de as Ho,df as $o,dg as Oa,dh as Vo,di as Lo,dj as zo,dk as Uo,dl as Go,dm as kn,dn as jo,dp as qo,dq as Xo,cI as Ko,cJ as Qo,cL as Ba,cN as Jo,cO as Yo,cP as Zo,cQ as ei,cR as ti,cS as Ha,cT as $a,cU as ni,cV as ai,cW as ri,dr as si,ds as ui,cX as oi,bd as Va,cY as ii,cZ as di,c_ as La,cK as za,c$ as Ua,d0 as Ga,dt as ci,d1 as pi,cb as li,d4 as mi,f as Kt,du as We,dv as Sn,e as ja,K as fi,D as hi,m as gi,dw as Mn,dx as vn,dy as bi,dz as _i,z as yi}from"./index-61yXXHxL.js";import{s as An,c as Ii,r as wi,a as ki,b as Si,d as Mi,u as vi}from"./Unique_impl-Cds87zow.js";function qa(r,n){for(var s=0;s<n.length;s++){const o=n[s];if(typeof o!="string"&&!Array.isArray(o)){for(const a in o)if(a!=="default"&&!(a in r)){const t=Object.getOwnPropertyDescriptor(o,a);t&&Object.defineProperty(r,a,t.get?t:{enumerable:!0,get:()=>o[a]})}}}return Object.freeze(Object.defineProperty(r,Symbol.toStringTag,{value:"Module"}))}/**
 * @license
 ...
 * =============================================================================
 */var L;(function(r){r[r.float32=0]="float32",r[r.int32=1]="int32",r[r.bool=2]="bool",r[r.string=3]="string",r[r.complex64=4]="complex64"})(L||(L={}));var at;(function(r){r[r.linear=0]="linear",r[r.relu=1]="relu",r[r.relu6=2]="relu6",r[r.prelu=3]="prelu",r[r.leakyrelu=4]="leakyrelu",r[r.sigmoid=5]="sigmoid",r[r.elu=6]="elu"})(at||(at={}));/**
 * @license
 * Copyright 2019 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
 ...
 * limitations under the License.
 * =============================================================================
 */let Ya;function Ui(r){Ya=r.wasm.cwrap(Tn,null,["number, number, number"])}function Gi(r){const{backend:n,inputs:s,attrs:o}=r,{axis:a,keepDims:t}=o,{x:i}=s;let c=n.dataIdMap.get(i.dataId).id,u=i;const{transposed:e,axes:m,originalAxes:b,inputWasTransposed:l}=xe(i,a,n);if(l){const _=n.dataIdMap.get(e.dataId).id;u=e,c=_}const f=u.shape.length;Se("any",m,f);const[g,w]=Oe(u.shape,m),k=F(w),y=n.makeOutput(g,i.dtype);if(F(u.shape)!==0){const _=n.dataIdMap.get(y.dataId).id;Ya(c,k,_)}if(l&&n.disposeData(e.dataId),t){const _=Be(y.shape,b);y.shape=_}return y}const ji={kernelName:Tn,backendName:"wasm",setupFunc:Ui,kernelFunc:Gi};/**
 * @license
 * Copyright 2023 Google LLC.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
 ...
 * limitations under the License.
 * =============================================================================
 */function Za(r){let n;function s(a){n=a.wasm.cwrap(r,null,["number","number","number","number","number"])}function o(a){const{backend:t,inputs:i,attrs:d}=a,{axis:c}=d,{x:u}=i,e=t.dataIdMap.get(u.dataId).id;let m=e,b=u;const{transposed:l,axes:f,inputWasTransposed:g}=xe(u,c,t);if(g){const E=t.dataIdMap.get(l.dataId).id;E!==e&&(b=l,m=E)}const w=b.shape.slice(0,-1),k=t.makeOutput(w,"int32"),y=t.dataIdMap.get(k.dataId).id,_=F(k.shape),v=b.shape[f[0]];return n(m,L[b.dtype],_,v,y),g&&t.disposeData(l.dataId),k}return{kernelName:r,backendName:"wasm",setupFunc:s,kernelFunc:o}}/**
 * @license
 * Copyright 2019 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
 ...
 * limitations under the License.
 * =============================================================================
 */function Te(r){const{inputs:{x:n},attrs:{begin:s,size:o},backend:a}=r,[t,i]=gu(n,s,o),d=bu(n.shape,t,i),c=a.readSync(n.dataId),u=a.makeOutput(i,n.dtype),e=fe(n.shape),m=a.dataIdMap.get(u.dataId);if(d){const f=_u(t,e);return n.dtype==="string"?m.stringBytes=c.slice(f,f+F(i)):a.typedArrayFromHeap(u).set(c.subarray(f,f+F(i))),u}if(n.dtype==="string"){const f=An(c,t,i,n.shape,n.dtype);return m.stringBytes=f,u}const b=a.typedArrayFromHeap(u),l=n.shape.length;if(l===2)gd(c,e[0],b,t,i);else if(l===3)bd(c,e[0],e[1],b,t,i);else if(l===4)_d(c,e[0],e[1],e[2],b,t,i);else{const f=An(c,t,i,n.shape,n.dtype);b.set(f)}return u}function gd(r,n,s,o,a){let t=0;const i=o[0],d=o[1],c=i+a[0];for(let u=i;u<c;u++){const e=u*n+d;s.set(r.subarray(e,e+a[1]),t),t+=a[1]}}function bd(r,n,s,o,a,t){let i=0;const d=a[0],c=a[1],u=a[2],e=d+t[0],m=c+t[1];for(let b=d;b<e;b++)for(let l=c;l<m;l++){const f=b*n+l*s+u;o.set(r.subarray(f,f+t[2]),i),i+=t[2]}}function _d(r,n,s,o,a,t,i){let d=0;const c=t[0],u=t[1],e=t[2],m=c+i[0],b=u+i[1],l=e+i[2],f=t[3];for(let g=c;g<m;g++)for(let w=u;w<b;w++)for(let k=e;k<l;k++){const y=g*n+w*s+k*o+f;a.set(r.subarray(y,y+i[3]),d),d+=i[3]}}const yd={kernelName:hu,backendName:"wasm",kernelFunc:Te};/**
 * @license
 * Copyright 2021 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
 ...
 * limitations under the License.
 * =============================================================================
 */let sr;function kd(r){sr=r.wasm.cwrap(Ln,null,["number","number","boolean","number","number","number"])}function Sd(r){const{backend:n,inputs:s,attrs:o}=r,{x:a,weights:t}=s,{size:i}=o,d=t.shape.reduce((m,b)=>m*b,1)!==0,c=a.shape.length===1?[i]:[a.shape[0],i],u=n.makeOutput(c,t.dtype);function e(m){return n.dataIdMap.get(m.dataId).id}return sr(e(a),i,d,e(t),L[t.dtype],e(u)),u}const Md={kernelName:Ln,backendName:"wasm",setupFunc:kd,kernelFunc:Sd};/**
 * @license
 * Copyright 2023 Google LLC.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
 ...
 * limitations under the License.
 * =============================================================================
 */let ir;function Pd(r){ir=r.wasm.cwrap(Un,null,["number","number","number","number","number","number","number","number","number","number","number","number","number","number","number","number","number","number","number"])}function Wd(r){const{inputs:n,attrs:s,backend:o}=r,{x:a,filter:t}=n,i=o.dataIdMap.get(a.dataId).id,d=o.dataIdMap.get(t.dataId).id,{strides:c,dilations:u,pad:e,dimRoundingMode:m,dataFormat:b}=s,l=Gn(b),f=ut(a.shape,t.shape,c,u,e,m,!1,l),g=f.filterHeight,w=f.filterWidth,k=f.padInfo.top,y=f.padInfo.right,_=f.padInfo.bottom,v=f.padInfo.left,E=f.dilationHeight,R=f.dilationWidth,O=f.strideHeight,V=f.strideWidth,z=f.inChannels,H=f.outChannels,G=f.padInfo.type==="SAME"?1:0;if(f.dataFormat!=="channelsLast")throw new Error(`wasm backend Conv2D does not support dataFormat:'${f.dataFormat}'. Please use 'channelsLast'.`);const q=o.makeOutput(f.outShape,"float32"),J=o.dataIdMap.get(q.dataId).id;return ir(i,a.shape[0],a.shape[1],a.shape[2],d,g,w,k,y,_,v,G,E,R,O,V,z,H,J),q}const Td={kernelName:Un,backendName:"wasm",setupFunc:Pd,kernelFunc:Wd};/**
 * @license
 * Copyright 2020 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
 ...
 * limitations under the License.
 * =============================================================================
 */let pr;function zd(r){pr=r.wasm.cwrap(Xn,null,["number","number","number","number","number","number","number","number","number","number","number","number","number","number","number","number","number","number","number","number","number","number","number","number"])}function Ud(r){const{inputs:n,backend:s,attrs:o}=r,{x:a,dy:t}=n,{strides:i,pad:d,filterShape:c}=o;if(a.dtype!=="float32")throw new Error(`Tensor dy must have dtype float32, got ${a.dtype}`);if(t.dtype!=="float32")throw new Error(`Tensor filter must have dtype float32, got ${t.dtype}`);const u=nn(a.shape,c,i,1,d),e=s.makeOutput(u.filterShape,t.dtype);return pr(s.dataIdMap.get(a.dataId).id,s.dataIdMap.get(t.dataId).id,s.dataIdMap.get(e.dataId).id,u.batchSize,u.inDepth,u.inHeight,u.inWidth,u.inChannels,u.outDepth,u.outHeight,u.outWidth,u.outChannels,u.strideDepth,u.strideHeight,u.strideWidth,u.dilationDepth,u.dilationHeight,u.dilationWidth,u.filterDepth,u.filterHeight,u.filterWidth,u.padInfo.front,u.padInfo.top,u.padInfo.left),e}const Gd={kernelName:Xn,backendName:"wasm",setupFunc:zd,kernelFunc:Ud};/**
 * @license
 * Copyright 2023 Google LLC.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
 ...
 * limitations under the License.
 * =============================================================================
 */function Mr(r){const{attrs:{shape:n,value:s},backend:o}=r;let{attrs:{dtype:a}}=r;a=a||$u(s);const t=o.makeOutput(n,a);return o.typedArrayFromHeap(t).fill(s),t}const Oc={kernelName:Hu,backendName:"wasm",kernelFunc:Mr};/**
 * @license
 * Copyright 2019 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
 ...
 * limitations under the License.
 * =============================================================================
 */let Ar;function zc(r){Ar=r.wasm.cwrap(oa,null,["number","number","number","number","number","number","number"])}function Uc(r){const{backend:n,inputs:s,attrs:o}=r,{varianceEpsilon:a}=o,{x:t,mean:i,variance:d,offset:c,scale:u}=s,e=n.dataIdMap.get(t.dataId).id,m=n.dataIdMap.get(i.dataId).id,b=n.dataIdMap.get(d.dataId).id,l=c!=null?n.dataIdMap.get(c.dataId).id:0,f=u!=null?n.dataIdMap.get(u.dataId).id:0,g=n.makeOutput(t.shape,t.dtype);if(F(t.shape)===0)return g;const w=n.dataIdMap.get(g.dataId).id;return Ar(e,m,b,l,f,a,w),g}const Gc={kernelName:oa,backendName:"wasm",setupFunc:zc,kernelFunc:Uc};/**
 * @license
 * Copyright 2019 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
 ...
 * limitations under the License.
 * =============================================================================
 */let Nr;function Yc(r){Nr=r.wasm.cwrap(ca,null,["number","number","number","number","number","number","array","number"])}function Zc(r){const{backend:n,inputs:s}=r,{params:o,indices:a}=s,[t,i,d,c]=zu(o,a),u=n.makeOutput(t,o.dtype);if(i===0)return u;const e=a.shape,m=e[e.length-1],l=n.dataIdMap.get(o.dataId).id,g=n.dataIdMap.get(a.dataId).id,w=new Uint8Array(new Int32Array(c).buffer),k=n.dataIdMap.get(u.dataId).id;return Nr(l,L[o.dtype],g,i,m,d,w,k),u}const ep={kernelName:ca,backendName:"wasm",setupFunc:Yc,kernelFunc:Zc};/**
 * @license
 * Copyright 2019 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
 ...
 * limitations under the License.
 * =============================================================================
 */let Fr;function pp(r){Fr=r.wasm.cwrap(pa,null,["number","number","number","number"])}function lp(r){const{inputs:{x:n},attrs:{alpha:s},backend:o}=r,a=o.dataIdMap.get(n.dataId).id,t=o.makeOutput(n.shape,"float32");if(F(n.shape)!==0){const i=o.dataIdMap.get(t.dataId).id;Fr(a,L[n.dtype],s,i)}return t}const mp={kernelName:pa,backendName:"wasm",setupFunc:pp,kernelFunc:lp};/**
 * @license
 * Copyright 2019 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
 ...
 * limitations under the License.
 * =============================================================================
 */let Or;function zp(r){Or=r.wasm.cwrap("MaxPool3D",null,["number","number","number","number","number","number","number","number","number","number","number","number","number","number","number","number","number","number","number","number","number","number"])}function Up(r){const{inputs:n,backend:s,attrs:o}=r,{x:a}=n,{filterSize:t,strides:i,pad:d,dimRoundingMode:c,dataFormat:u}=o,e=Ft(a.shape,t,i,1,d,c,u),m=s.makeOutput(e.outShape,a.dtype);return Or(s.dataIdMap.get(a.dataId).id,s.dataIdMap.get(m.dataId).id,e.batchSize,e.inChannels,e.inDepth,e.inHeight,e.inWidth,e.outDepth,e.outHeight,e.outWidth,e.strideDepth,e.strideHeight,e.strideWidth,e.dilationDepth,e.dilationHeight,e.dilationWidth,e.effectiveFilterDepth,e.effectiveFilterHeight,e.effectiveFilterWidth,e.padInfo.front,e.padInfo.top,e.padInfo.left),m}const Gp={kernelName:uo,backendName:"wasm",setupFunc:zp,kernelFunc:Up};/**
 * @license
 * Copyright 2023 Google LLC.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
 ...
 * limitations under the License.
 * =============================================================================
 */let Ur;function pl(r){Ur=r.wasm.cwrap(Ia,null,["number","number","number","number"])}function Gr(r){const{backend:n,inputs:{logits:s},attrs:{dim:o}}=r,a=n.dataIdMap.get(s.dataId).id,t=n.makeOutput(s.shape,s.dtype),i=n.dataIdMap.get(t.dataId).id,d=s.shape[o],c=F(s.shape)/d;return F(t.shape)===0||Ur(a,i,d,c),t}const ll={kernelName:Ia,backendName:"wasm",setupFunc:pl,kernelFunc:Gr};/**
 * @license
 * Copyright 2023 Google LLC.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
 ...
 * limitations under the License.
 * =============================================================================
 */let es;function zl(r){es=r.wasm.cwrap(Da,null,["number","number","number","number"])}function Ul(r){const{backend:n,inputs:s,attrs:o}=r,{axis:a,keepDims:t}=o,{x:i}=s,d=n.dataIdMap.get(i.dataId).id;let c=d,u=i;const{transposed:e,axes:m,originalAxes:b,inputWasTransposed:l}=xe(i,a,n);let f=m;if(l){const _=n.dataIdMap.get(e.dataId).id;_!==d&&(u=e,c=_,f=je(f.length,u.shape.length))}Se("prod",f,u.shape.length);const[g,w]=Oe(u.shape,f),k=F(w),y=n.makeOutput(g,u.dtype);if(F(u.shape)!==0){const _=n.dataIdMap.get(y.dataId).id;es(c,k,L[y.dtype],_)}if(l&&n.disposeData(e.dataId),t){const _=Be(y.shape,b);y.shape=_}return y}const Gl={kernelName:Da,backendName:"wasm",setupFunc:zl,kernelFunc:Ul};/**
 * @license
 * Copyright 2020 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
 ...
 * limitations under the License.
 * =============================================================================
 */let os;function _m(r){os=r.wasm.cwrap(Wa,null,["number","number","number","number","number","number","array","number","number"])}function ym(r){const{backend:n,inputs:s,attrs:o}=r,{indices:a,updates:t}=s,{shape:i}=o,d=n.makeOutput(i,t.dtype);if(F(i)===0)return d;const{sliceRank:c,numUpdates:u,sliceSize:e,strides:m,outputSize:b}=rn(t,a,i),f=n.dataIdMap.get(a.dataId).id,w=n.dataIdMap.get(t.dataId).id,k=new Uint8Array(new Int32Array(m).buffer),y=n.dataIdMap.get(d.dataId).id;return os(f,w,L[t.dtype],c,u,e,k,b,y),d}const Im={kernelName:Wa,backendName:"wasm",setupFunc:_m,kernelFunc:ym};/**
 * @license
 * Copyright 2023 Google LLC.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
 ...
 * limitations under the License.
 * =============================================================================
 */function zm(r){return hs(r,!0)}const Um={kernelName:Ko,backendName:"wasm",setupFunc:fs,kernelFunc:zm};/**
 * @license
 * Copyright 2021 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
 ...
 * limitations under the License.
 * =============================================================================
 */function Gm(r){return hs(r,!1)}const jm={kernelName:Qo,backendName:"wasm",setupFunc:fs,kernelFunc:Gm};/**
 * @license
 * Copyright 2021 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
 ...
 * limitations under the License.
 * =============================================================================
 */let ks;function Af(r){ks=r.wasm.cwrap(Ua,null,["number","array","number","number","number","bool","number","number"])}const xf=({inputs:r,backend:n,attrs:s})=>{const{x:o}=r,{k:a,sorted:t}=s,i=n.dataIdMap.get(o.dataId).id,d=new Uint8Array(new Int32Array(o.shape).buffer),c=o.shape.slice();c[c.length-1]=a;const u=n.makeOutput(c,o.dtype),e=n.dataIdMap.get(u.dataId).id,m=n.makeOutput(c,"int32"),b=n.dataIdMap.get(m.dataId).id;return ks(i,d,o.shape.length,L[o.dtype],a,t,e,b),[u,m]},Df={kernelName:Ua,backendName:"wasm",setupFunc:Af,kernelFunc:xf};/**
 * @license
 * Copyright 2021 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
 ...
 * limitations under the License.
 * =============================================================================
 */const Bf=[Di,Ni,Ci,Fi,Ri,Wi,zi,ji,qi,Xi,Ki,Qi,Ji,Yi,Zi,nd,pd,sd,id,hd,wd,Md,vd,xd,Dd,Nd,Rd,Ed,Td,Hd,Ld,Gd,Xd,Kd,Qd,Zd,nc,sc,ic,pc,fc,bc,Ic,Sc,Ac,xc,Cc,Rc,Ec,Pc,Wc,Tc,Oc,$c,Vc,Lc,Gc,Xc,Jc,ep,ap,sp,op,Ti,ip,dp,cp,mp,hp,bp,Ip,kp,wp,Mp,vp,xp,Np,Rp,Wp,Bp,Hp,Lp,Gp,Xp,Jp,el,al,ul,ol,cl,hl,gl,bl,_l,wl,Ml,xl,Nl,Rl,Pl,Tl,Yr,Hl,Ll,Gl,ql,Xl,Kl,Ql,Jl,ld,em,am,um,dm,lm,hm,gm,bm,Im,Sm,Am,xm,Cm,Fm,Rm,Em,yd,ll,Pm,Tm,Hm,Lm,Um,jm,Km,Jm,Ym,Zm,ef,af,uf,df,pf,mf,ff,bf,_f,yf,kf,vf,Df,Ff,$i,Ef,Wf,Of];for(const r of Bf)mi(r);/**
 * @license
 * Copyright 2020 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
 ...
 * limitations under the License.
 * =============================================================================
 */const Cn=vs||$f,Gf=xs||Uf;class jf extends fi{constructor(n){super(),this.wasm=n,this.dataIdNextNumber=1,this.wasm.tfjs.initWithThreadsCount(Ds),en=this.wasm.tfjs.getThreadsCount(),this.dataIdMap=new hi(this,gi())}write(n,s,o){const a={id:this.dataIdNextNumber++};return this.move(a,n,s,o,1),a}numDataIds(){return this.dataIdMap.numDataIds()}async time(n){const s=Mn();return n(),{kernelMs:Mn()-s}}move(n,s,o,a,t){const i=this.dataIdNextNumber++;if(a==="string"){const e=s;this.dataIdMap.set(n,{id:i,stringBytes:e,shape:o,dtype:a,memoryOffset:null,refCount:t});return}const d=F(o),c=d*vn(a),u=this.wasm._malloc(c)>>>0;this.dataIdMap.set(n,{id:i,memoryOffset:u,shape:o,dtype:a,refCount:t}),this.wasm.tfjs.registerTensor(i,d,u),s!=null&&this.wasm.HEAPU8.set(new Uint8Array(s.buffer,s.byteOffset,c),u)}async read(n){return this.readSync(n)}readSync(n,s,o){const{memoryOffset:a,dtype:t,shape:i,stringBytes:d}=this.dataIdMap.get(n);if(t==="string")return(s==null||s===0)&&(o==null||o>=d.length)?d:d.slice(s,o);s=s||0,o=o||F(i);const c=vn(t),u=this.wasm.HEAPU8.slice(a+s*c,a+o*c);return Kf(u.buffer,t)}disposeData(n,s=!1){if(this.dataIdMap.has(n)){const o=this.dataIdMap.get(n);if(o.refCount--,!s&&o.refCount>0)return!1;this.wasm._free(o.memoryOffset),this.wasm.tfjs.disposeData(o.id),this.dataIdMap.delete(n)}return!0}refCount(n){return this.dataIdMap.has(n)?this.dataIdMap.get(n).refCount:0}incRef(n){const s=this.dataIdMap.get(n);s!=null&&s.refCount++}floatPrecision(){return 32}getMemoryOffset(n){return this.dataIdMap.get(n).memoryOffset}dispose(){this.wasm.tfjs.dispose(),"PThread"in this.wasm&&this.wasm.PThread.terminateAllThreads(),this.wasm=null}memory(){return{unreliable:!1}}makeOutput(n,s,o,a){let t;if(o==null)t=this.write(a??null,n,s);else{const i=this.dataIdNextNumber++;t={id:i},this.dataIdMap.set(t,{id:i,memoryOffset:o,shape:n,dtype:s,refCount:1});const d=F(n);this.wasm.tfjs.registerTensor(i,d,o)}return{dataId:t,shape:n,dtype:s}}typedArrayFromHeap({shape:n,dtype:s,dataId:o}){const a=this.wasm.HEAPU8.buffer,{memoryOffset:t}=this.dataIdMap.get(o),i=F(n);switch(s){case"float32":return new Float32Array(a,t,i);case"int32":return new Int32Array(a,t,i);case"bool":return new Uint8Array(a,t,i);default:throw new Error(`Unknown dtype ${s}`)}}}function qf(r){return(n,s)=>(_i(r,{credentials:"same-origin"}).then(o=>{o.ok||n.env.a(`failed to load wasm binary file at '${r}'`),o.arrayBuffer().then(a=>{WebAssembly.instantiate(a,n).then(t=>{s(t.instance,t.module)})})}),{})}function Fn(r,n,s){if(Nt!=null)return Nt;let o="tfjs-backend-wasm.wasm";return r&&n?o="tfjs-backend-wasm-threaded-simd.wasm":r&&(o="tfjs-backend-wasm-simd.wasm"),tt!=null&&tt[o]!=null?tt[o]:s+o}async function Xf(){const[r,n]=await Promise.all([Kt().getAsync("WASM_HAS_SIMD_SUPPORT"),Kt().getAsync("WASM_HAS_MULTITHREAD_SUPPORT")]);return new Promise((s,o)=>{const a={};a.locateFile=(d,c)=>{if(d.endsWith(".worker.js")){const u=Lf.wasmWorkerContents.replace(/\n/g,"\\n"),e=new Blob([u],{type:"application/javascript"});return URL.createObjectURL(e)}return d.endsWith(".wasm")?Fn(r,n,et??c):c+d},un&&(a.instantiateWasm=qf(Fn(r,n,et??"")));let t=!1;a.onAbort=()=>{if(t||nt)return;nt=!0,o({message:"Make sure the server can serve the `.wasm` file relative to the bundled js file. For more details see https://github.com/tensorflow/tfjs/blob/master/tfjs-backend-wasm/README.md#using-bundlers"})};let i;n&&r&&Nt==null?(a.mainScriptUrlOrBlob=new Blob(["var WasmBackendModuleThreadedSimd = "+Cn.toString()],{type:"text/javascript"}),i=Cn(a)):i=Gf(a),i.then(d=>{t=!0,nt=!1;const c=null;d.tfjs={init:d.cwrap("init",null,[]),initWithThreadsCount:d.cwrap("init_with_threads_count",null,["number"]),getThreadsCount:d.cwrap("get_threads_count","number",[]),registerTensor:d.cwrap("register_tensor",null,["number","number","number"]),disposeData:d.cwrap("dispose_data",c,["number"]),dispose:d.cwrap("dispose",c,[])},s({wasm:d})}).catch(o)})}function Kf(r,n){switch(n){case"float32":return new Float32Array(r);case"int32":return new Int32Array(r);case"bool":return new Uint8Array(r);default:throw new Error(`Unknown dtype ${n}`)}}const Qf=["tfjs-backend-wasm.wasm","tfjs-backend-wasm-simd.wasm","tfjs-backend-wasm-threaded-simd.wasm"];let Nt=null,et=null,tt={},nt=!1,un=!1;function eh(r,n=!1){if(bi("setWasmPath has been deprecated in favor of setWasmPaths and will be removed in a future release."),nt)throw new Error("The WASM backend was already initialized. Make sure you call `setWasmPath()` before you call `tf.setBackend()` or `tf.ready()`");Nt=r,un=n}function th(r,n=!1){if(nt)throw new Error("The WASM backend was already initialized. Make sure you call `setWasmPaths()` before you call `tf.setBackend()` or `tf.ready()`");if(typeof r=="string")et=r;else{tt=r;const s=Qf.filter(o=>tt[o]==null);if(s.length>0)throw new Error(`There were no entries found for the following binaries: ${s.join(",")}. Please either call setWasmPaths with a map providing a path for each binary, or with a string indicating the directory where all the binaries can be found.`)}un=n}let Ds=-1,en=-1;function nh(r){Ds=r}function ah(){if(en===-1)throw new Error("WASM backend not initialized.");return en}/** @license See the LICENSE file. */const rh="4.22.0";/**
 * @license
 * Copyright 2020 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
 ...
 * limitations under the License.
 * =============================================================================
 */const Jf=2;yi("wasm",async()=>{const{wasm:r}=await Xf();return new jf(r)},Jf);export{jf as BackendWasm,ah as getThreadsCount,nh as setThreadsCount,eh as setWasmPath,th as setWasmPaths,rh as version_wasm};
