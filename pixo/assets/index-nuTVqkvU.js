import{g as V,cP as $t,cH as fe,cQ as Se,cF as E,cR as us,cS as ds,cT as Me,cU as Oe,cV as lt,cW as N,cX as Ye,Q as he,cY as ct,cZ as ls,c_ as cs,c$ as hs,d0 as Dt,d1 as ps,d2 as fs,d3 as ms,d4 as gs,d5 as xs,d6 as Cs,d7 as ws,d8 as ys,d9 as Ss,da as bs,db as vs,dc as Is,dd as ks,de as Rs,df as J,dg as Ps,dh as ht,di as $s,dj as Ds,dk as be,dl as pt,dm as Ns,dn as zs,dp as As,dq as Fs,dr as Ls,ds as Es,dt as je,du as re,dv as Re,dw as Pe,dx as Qe,dy as _s,dz as Bs,dA as Ws,dB as Ts,dC as Vs,dD as Us,dE as Ms,dF as Os,dG as Gs,dH as Hs,dI as Xs,dJ as Ks,dK as qs,dL as Ys,dM as $e,dN as js,dO as _e,dP as Qs,dQ as Zs,dR as Js,dS as eo,dT as to,dU as so,dV as oo,dW as Nt,dX as zt,dY as At,dZ as io,d_ as ro,d$ as ao,e0 as no,e1 as uo,e2 as lo,e3 as co,z as ho,e4 as po,e5 as fo,e6 as mo,e7 as go,e8 as ve,e9 as xo,ea as Co,eb as wo,ec as yo,ed as De,ee,ef as So,eg as bo,eh as vo,ei as Ze,ej as Io,ek as ko,el as Ro,em as Po,en as $o,eo as Ft,ep as Do,eq as No,er as zo,es as Ao,et as Fo,eu as Lo,ev as Eo,ew as _o,ex as Bo,ey as Je,ez as Wo,eA as To,eB as Vo,eC as Uo,eD as Mo,eE as Oo,eF as Go,eG as Ho,eH as Xo,eI as Ko,eJ as qo,eK as Yo,eL as jo,eM as Qo,eN as Zo,eO as Jo,eP as ei,eQ as ti,eR as si,eS as oi,eT as ii,eU as ri,eV as ai,eW as ni,eX as ui,eY as di,eZ as Lt,e_ as li,e$ as ci,f0 as hi,f1 as pi,f2 as fi,f3 as mi,f4 as gi,f5 as xi,f6 as Ci,f7 as wi,f8 as yi,f9 as Si,fa as bi,fb as vi,fc as Ii,fd as ki,fe as Ri,ff as Pi,fg as $i,fh as Di,fi as Ni,fj as zi,fk as Ai,fl as Fi,fm as Li,fn as Ei,fo as _i,fp as Bi,fq as Wi,fr as Ti,fs as Vi,ft as Ui,fu as Mi,fv as Oi,fw as Gi,fx as Hi,fy as Xi,fz as Ki,fA as qi,fB as Yi,fC as ji,fD as Qi,fE as Zi,fF as Ji,fG as er,fH as tr,fI as sr,fJ as or,fK as ir,fL as rr,fM as ar,fN as nr,fO as ur,fP as dr,fQ as lr,fR as cr,fS as hr,fT as pr,fU as fr,fV as mr,fW as gr,fX as xr,fY as et,fZ as Cr,f_ as wr,f$ as yr,g0 as Sr,g1 as br,g2 as vr,g3 as Ir,g4 as kr,g5 as Rr,g6 as Pr,g7 as $r,g8 as Dr,g9 as Nr,ga as zr,gb as Ar,gc as Fr,gd as Lr,ge as Er,gf as _r,gg as Br,gh as Wr,gi as Tr,gj as Vr,gk as Ur,gl as Mr,gm as Or,gn as Gr,go as Hr,gp as Xr,gq as Kr,gr as qr,gs as Yr,gt as jr,gu as Qr}from"./index-vnJBY934.js";import{s as Zr}from"./shared-Bdfsxe19.js";import"./index-yu6PrY-W.js";import"./index-DnFN-ov5.js";import"./Unique_impl-BFOlkeKa.js";/**
 * @license
...
`;function Ae(s,t=""){const e=s.length,i=t!==""?`get${t.charAt(0).toUpperCase()+t.slice(1)}CoordsFromIndex`:"getCoordsFromIndex",o=t!==""?`${t.charAt(0).toLowerCase()+t.slice(1)}ShapeStrides`:"outShapeStrides";if(e<=1)return`fn ${i}(index : i32) -> i32 { return index; }`;const r=Se(s),a=_(e),n=[];for(let d=0;d<e;d++)n.push(`d${d}`);if(r.length===1)return`    fn ${i}(index : i32) -> vec2<i32> {
  ...
  `}function ua(s,t){const e=s.name,i=s.shape.length,o=_(i),r="get"+e.charAt(0).toUpperCase()+e.slice(1),a=["d0","d1","d2","d3","d4","d5"].slice(0,i),n=a.map(l=>`${l} : i32`).join(", ");if(i<1)return`
      fn ${r}() -> ${z(t)} {
        return ${z(t)}(${e}[0]);
      }
   ...
   `}function da(s,t,e,i){const o=s.name,r=o.charAt(0).toUpperCase()+o.slice(1),a="get"+r+"ByOutput",n=s.shape.length,u=t.length,d=_(u);if(fe(s.shape,t)&&i)return`
...
`}function la(s,t,e,i){let o=ua(s,e);return s.shape.length<=t.length&&(o+=da(s,t,e,i)),o}function ca(s,t){const{x:e,y:i=[],z:o=[]}=t,r=s.length,a=e.length+i.length+o.length;if(a!==r)return"";if(e.length===r)return`fn getOutputCoords() -> ${_(r)}{
...
`,Na="return f32(a >= 1.0 && b >= 1.0);",za=`return (vec4<f32>(a >= vec4<f32>(1.0)) *
  ...
  vec4<f32>(b >= vec4<f32>(1.0)), vec4<f32>(1.0));`,La="let resultTemp = max(a, b);",Ea="let resultTemp = min(a, b);",_a=`
  let isNaN = b == 0.;
  var resultTemp = a % b;
...
`,Ha="let resultTemp = (a - b) * (a - b);",Xa="let resultTemp = a - b;";function rt(s,t){let e;do{switch(s){case $.ATAN2:e=wa;break;case $.MAX:e=La;break;case $.MIN:e=Ea;break;case $.MOD:e=t?Ba:_a;break;case $.NOT_EQUAL:e=t?Va:Ta;break;case $.POW:e=t?Ma:Ua;break;default:continue}let i,o,r;return t?(i="isnanVec4",o="vec4<f32>",r="vec4<bool>"):(i="isnan",o="f32",r="bool"),`
      let aIsNaN = ${i}(a);
...
`,yn="return 1.0 / a;",Sn="return select(a, 0.0, a < 0.0);",bn="return clamp(a, 0.0, 6.0);",vn="return clamp(a, vec4<f32>(0.0, 0.0, 0.0, 0.0), vec4<f32>(6.0, 6.0, 6.0, 6.0));",In=`
...
`,Wn="return f32(i32((a)));";function se(s,t){switch(s){case y.ABS:return Ka;case y.ACOS:return qa;case y.ACOSH:return Ya;case y.ASIN:return ja;case y.ASINH:return Qa;case y.ATAN:return Za;case y.ATANH:return Ja;case y.COS:return tn;case y.COSH:return sn;case y.CEIL:return en;case y.ELU:return t?an:rn;case y.ERF:return nn;case y.EXP:return un;case y.EXPM1:return on;case y.FLOOR:return dn;case y.IS_FINITE:return ln;case y.IS_INF:return cn;case y.IS_NAN:return hn;case y.LINEAR:return pn;case y.LOG:return fn;case y.LOG1P:return mn;case y.LOGICAL_NOT:return gn;case y.NEG:return xn;case y.LEAKYRELU:return t?wn:Cn;case y.RECIPROCAL:return yn;case y.RELU:return t?In:Sn;case y.RELU6:return t?vn:bn;case y.ROUND:return kn;case y.RSQRT:return Rn;case y.SELU:return Pn;case y.SIGMOID:return $n;case y.SIGN:return Dn;case y.SIN:return Nn;case y.SINH:return zn;case y.SOFTPLUS:return An;case y.SQRT:return Fn;case y.SQUARE:return Ln;case y.STEP:return En;case y.TAN:return _n;case y.TANH:return Bn;case y.TO_INT:return Wn;default:throw new Error(`BinaryType ${s} is not implemented!`)}}/**
 * @license
 * Copyright 2021 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
 ...
 * limitations under the License.
 * =============================================================================
 */function Z(s,t=!1,e=!1,i=3){if(s===null)return"";let o="";if(s==="linear")o=se(y.LINEAR);else if(s==="relu")o=se(y.RELU,e);else if(s==="elu")o=se(y.ELU,e);else if(s==="relu6")o=se(y.RELU6,e);else if(s==="prelu")o=rt($.PRELU,e);else if(s==="sigmoid")o=se(y.SIGMOID,e);else if(s==="leakyrelu")o=se(y.LEAKYRELU,e);else throw new Error(`Activation ${s} has not been implemented for the WebGPU backend.`);const a=z(e?4:1);let n="";return t?n=`
 ...
 * limitations under the License.
 * =============================================================================
 */function Bt(s,t,e=!1,i=!1,o=!1,r=1){E(s&&r===1||!s,()=>`transposeA ${s} is not compatible with component size ${r}`);const a=`
 ...
 * limitations under the License.
 * =============================================================================
 */class Qn{constructor(t){this.variableNames=[],this.outputShape=[],this.uniforms="value : f32,",this.workgroupSize=[64,1,1],this.size=!0,this.outputShape=t,this.dispatchLayout=I(this.outputShape),this.dispatch=b(this.dispatchLayout,this.outputShape,this.workgroupSize),this.shaderKey="fill"}getUserCode(){return`
    ${S("index")} {
      if (index < uniforms.size) {
 ...
 * limitations under the License.
 * =============================================================================
 */function X(s){const{backend:t,attrs:e}=s,{shape:i,value:o}=e;let{dtype:r}=e;if(r=r||vs(o),r==="string"){const a=Is(r,N(i));return a.fill(o),t.makeTensorInfo(i,r,a)}else{const a=new Qn(i),n=[{type:"float32",data:[o]}];return t.runWebGPUProgram(a,[],r,n)}}const Zn={kernelName:bs,backendName:"webgpu",kernelFunc:X};/**
 * @license
 * Copyright 2021 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
 ...
 * limitations under the License.
 * =============================================================================
 */class St{constructor(t,e,i){this.variableNames=["AReal","AImag","BReal","BImag"],this.workgroupSize=[128,1,1],this.size=!0,this.outputShape=J(e,i),this.dispatchLayout=I(this.outputShape),this.dispatch=b(this.dispatchLayout,this.outputShape,this.workgroupSize),this.shaderKey=`binaryOpComplex_${t}`,this.op=t}getUserCode(){return`
      fn binaryOpComplex(
 ...
 * limitations under the License.
 * =============================================================================
 */const Wu=L({opType:y.ABS,cpuKernelImpl:Nu}),Tu={kernelName:Ns,backendName:"webgpu",kernelFunc:Wu};/**
 * @license
 * Copyright 2022 Google LLC.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
 ...
 * limitations under the License.
 * =============================================================================
 */const Vu=L({opType:y.ACOS}),Uu={kernelName:zs,backendName:"webgpu",kernelFunc:Vu};/**
 * @license
 * Copyright 2022 Google LLC.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
 ...
 * limitations under the License.
 * =============================================================================
 */const Mu=L({opType:y.ACOSH}),Ou={kernelName:As,backendName:"webgpu",kernelFunc:Mu};/**
 * @license
 * Copyright 2021 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
 ...
 * limitations under the License.
 * =============================================================================
 */const Gu=U({opType:$.ADD,cpuKernelImpl:iu,supportsComplex:!0}),Hu={kernelName:Fs,backendName:"webgpu",kernelFunc:Gu};/**
 * @license
 * Copyright 2021 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
 ...
 * limitations under the License.
 * =============================================================================
 */function Ku(s){const{inputs:t,backend:e}=s,i=t;if(i.length===1)return K({inputs:{x:i[0]},backend:e});const o=i.map(n=>n.dtype).reduce((n,u)=>be(n,u)),r=i.map(n=>n.shape),a=new Xu(r);return e.runWebGPUProgram(a,i,o)}const qu={kernelName:Ls,backendName:"webgpu",kernelFunc:Ku};/**
 * @license
 * Copyright 2019 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
 ...
 * limitations under the License.
 * =============================================================================
 */const Ju={mean:"float32",all:"bool",any:"bool"};function ue(s,t,e,i,o){const r=s.shape.length,a=[],n=re(t,s.shape);let u=n;const d=Re(u,r);let l=s;d!=null&&(l=j({inputs:{x:s},attrs:{perm:d},backend:o}),u=Pe(u.length,r),a.push(l)),Qe(i,u,r);const[h,c]=je(l.shape,u);let p=h;e&&(p=_s(h,n));let f;if((i==="max"||i==="prod")&&o.shouldExecuteOnCPU([l])){const m=o.tensorMap.get(l.dataId).values;switch(i){case"max":const g=yu(m,N(c),p,s.dtype);f=o.makeTensorInfo(p,s.dtype,g);break;case"prod":const{outVals:x,outShape:C,outDtype:w}=Ru(l.shape,l.dtype,m,u);f=o.makeTensorInfo(C,w,x);break;default:throw new Error(`${i} CPU implementation is not yet supported.`)}}else{const m=N(c),x=N(l.shape)/m,C={windowSize:m,inSize:m,batchSize:x,outSize:1},w=Ju[i]||Bs(s.dtype),v=[{type:"int32",data:[m]}],k=new Zu(C,i,o.device.limits.maxComputeWorkgroupSizeX),P=o.runWebGPUProgram(k,[l],w,v);a.push(P),f=R({inputs:{x:P},attrs:{shape:p},backend:o})}return a.forEach(m=>o.disposeData(m.dataId)),f}/**
 * @license
 * Copyright 2022 Google LLC.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
 ...
 * limitations under the License.
 * =============================================================================
 */function ed(s){const{inputs:t,backend:e,attrs:i}=s,{x:o}=t,{keepDims:r,axis:a}=i;return ue(o,a,r,"all",e)}const td={kernelName:Ws,backendName:"webgpu",kernelFunc:ed};/**
 * @license
 * Copyright 2022 Google LLC.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
 ...
 * limitations under the License.
 * =============================================================================
 */function sd(s){const{inputs:t,backend:e,attrs:i}=s,{x:o}=t,{keepDims:r,axis:a}=i;return ue(o,a,r,"any",e)}const od={kernelName:Ts,backendName:"webgpu",kernelFunc:sd};/**
 * @license
 * Copyright 2019 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
 ...
 * limitations under the License.
 * =============================================================================
 */const ud=L({opType:y.ASIN}),dd={kernelName:Ms,backendName:"webgpu",kernelFunc:ud};/**
 * @license
 * Copyright 2022 Google LLC.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
 ...
 * limitations under the License.
 * =============================================================================
 */const ld=L({opType:y.ASINH}),cd={kernelName:Os,backendName:"webgpu",kernelFunc:ld};/**
 * @license
 * Copyright 2022 Google LLC.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
 ...
 * limitations under the License.
 * =============================================================================
 */const hd=L({opType:y.ATAN}),pd={kernelName:Gs,backendName:"webgpu",kernelFunc:hd};/**
 * @license
 * Copyright 2022 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
 ...
 * limitations under the License.
 * =============================================================================
 */const fd=U({opType:$.ATAN2}),md={kernelName:Hs,backendName:"webgpu",kernelFunc:fd};/**
 * @license
 * Copyright 2022 Google LLC.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
 ...
 * limitations under the License.
 * =============================================================================
 */const gd=L({opType:y.ATANH}),xd={kernelName:Xs,backendName:"webgpu",kernelFunc:gd};/**
 * @license
 * Copyright 2021 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
 ...
 * limitations under the License.
 * =============================================================================
 */function Vt(s){const{inputs:t,backend:e,attrs:i}=s,{x:o}=t,{reductionIndices:r,keepDims:a}=i;return ue(o,r,a,"max",e)}const wd={kernelName:Ks,backendName:"webgpu",kernelFunc:Vt};/**
 * @license
 * Copyright 2021 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
 ...
 * limitations under the License.
 * =============================================================================
 */function Ut(s){const{inputs:t,backend:e,attrs:i}=s,{x:o}=t,{keepDims:r,axis:a}=i;return ue(o,a,r,"mean",e)}const yd={kernelName:qs,backendName:"webgpu",kernelFunc:Ut};/**
 * @license
 * Copyright 2022 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
 ...
 * limitations under the License.
 * =============================================================================
 */function Sd(s){const{inputs:t,backend:e,attrs:i}=s,{x:o}=t,{filterSize:r,strides:a,pad:n,dimRoundingMode:u}=i,l=$e(o.shape,r,a,1,n,u);return Mt(o,l,"avg",e)}const bd={kernelName:Ys,backendName:"webgpu",kernelFunc:Sd};/**
 * @license
 ...
 * limitations under the License.
 * =============================================================================
 */function Pd(s){const{inputs:t,backend:e,attrs:i}=s,{dy:o,input:r}=t,a=r,{filterSize:n,strides:u,pad:d,dimRoundingMode:l}=i,h=_e(a.shape,n,u,1,d,l),c=new Rd(h),p=1/(h.filterDepth*h.filterHeight*h.filterWidth),f=[{type:"int32",data:[h.strideDepth,h.strideHeight,h.strideWidth]},{type:"int32",data:[h.effectiveFilterDepth-1-h.padInfo.front,h.effectiveFilterHeight-1-h.padInfo.top,h.effectiveFilterWidth-1-h.padInfo.left]},{type:"int32",data:[h.effectiveFilterDepth,h.effectiveFilterHeight,h.effectiveFilterWidth]},{type:"int32",data:[h.outDepth]},{type:"int32",data:[h.outHeight]},{type:"int32",data:[h.outWidth]},{type:"float32",data:[p]}];return e.runWebGPUProgram(c,[o],a.dtype,f)}const $d={kernelName:Qs,backendName:"webgpu",kernelFunc:Pd};/**
 * @license
 * Copyright 2022 Google LLC.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
 ...
 * limitations under the License.
 * =============================================================================
 */function zd(s){const{inputs:t,backend:e,attrs:i}=s,{a:o,b:r}=t,{transposeA:a,transposeB:n}=i;return Ve({a:o,b:r,transposeA:a,transposeB:n,backend:e})}const Ad={kernelName:Js,backendName:"webgpu",kernelFunc:zd};/**
 * @license
 * Copyright 2019 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
 ...
 * limitations under the License.
 * =============================================================================
 */function Vd(s){const{inputs:t,backend:e,attrs:i}=s,{x:o,weights:r}=t,{size:a}=i,n=N(o.shape),d=N(r.shape)>0,l=[a],h=r.dtype,c=X({backend:e,attrs:{shape:l,value:0,dtype:h}}),p=new Ot([n],d),f=[{type:"int32",data:[a]}],m=d?[o,r]:[o];return e.runWebGPUProgram(p,m,h,f,c)}const Ud={kernelName:ao,backendName:"webgpu",kernelFunc:Vd};/**
 * @license
 * Copyright 2023 Google LLC.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
 ...
 * limitations under the License.
 * =============================================================================
 */const Gt=U({opType:$.NOT_EQUAL,dtype:"bool",cpuKernelImpl:ku}),Hd={kernelName:uo,backendName:"webgpu",kernelFunc:Gt};/**
 * @license
 * Copyright 2021 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
 ...
 * limitations under the License.
 * =============================================================================
 */function Ne(s){const{inputs:t,backend:e}=s,{input:i}=t,o=e.tensorMap.get(i.dataId);return K({inputs:{x:o.complexTensorInfos.real},backend:e})}const Xd={kernelName:lo,backendName:"webgpu",kernelFunc:Ne};/**
 * @license
 * Copyright 2021 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
 ...
 * limitations under the License.
 * =============================================================================
 */function Kd(s,t){const e=new me(s.shape,y.TO_INT),i=t.runWebGPUProgram(e,[s],"int32");return{dataId:i.dataId,shape:i.shape,dtype:i.dtype}}/**
 * @license
 * Copyright 2021 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
 ...
 * limitations under the License.
 * =============================================================================
 */function Ke(s){const{inputs:t,backend:e,attrs:i}=s,{x:o}=t,{dtype:r}=i;if(r==="complex64"){if(o.dtype==="complex64")return K({inputs:{x:o},backend:e});const a=ho(o.shape),n=Ke({inputs:{x:o},backend:e,attrs:{dtype:"float32"}}),u=ne({inputs:{real:n,imag:a},backend:e});return a.dispose(),e.disposeData(n.dataId),u}if(o.dtype==="complex64"){const a=Ne({inputs:{input:o},backend:e}),n=Ke({inputs:{x:a},backend:e,attrs:{dtype:r}});return e.disposeData(a.dataId),n}if(!po(o.dtype,r)){const a=K({inputs:{x:o},backend:e});return{dataId:a.dataId,shape:a.shape,dtype:r}}if(e.shouldExecuteOnCPU([o])){const a=e.tensorMap.get(o.dataId).values,[n,u,d]=ru(a,o.shape,o.dtype,r);return e.makeTensorInfo(n,u,d)}if(r==="int32")return Kd(o,e);if(r==="bool"){const a=e.makeTensorInfo([],"bool",Dt("bool",1)),u=Gt({inputs:{a:o,b:a},backend:e});return e.disposeData(a.dataId),u}throw new Error(`Error in Cast: failed to cast ${o.dtype} to ${r}`)}const qd={kernelName:co,backendName:"webgpu",kernelFunc:Ke};/**
 * @license
 * Copyright 2021 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
 ...
 * limitations under the License.
 * =============================================================================
 */const Yd=L({opType:y.CEIL,cpuKernelImpl:au}),jd={kernelName:fo,backendName:"webgpu",kernelFunc:Yd};/**
 * @license
 ...
 * limitations under the License.
 * =============================================================================
 */class Zd{constructor(t){this.variableNames=["A"],this.uniforms="minVal : f32, maxVal : f32,",this.workgroupSize=[64,1,1],this.size=!0,this.outputShape=t,this.dispatchLayout=I(this.outputShape),this.dispatch=b(this.dispatchLayout,this.outputShape,this.workgroupSize),this.shaderKey="clip"}getUserCode(){return`
      ${S("index")} {
        if(index < uniforms.size) {
          let value = getAByOutputIndex(index);
          if (isnan(value)) {
 ...
 * limitations under the License.
 * =============================================================================
 */function Jd(s){const{inputs:t,backend:e,attrs:i}=s,{x:o}=t,{clipValueMin:r,clipValueMax:a}=i;let n;const u=[{type:"float32",data:[r]},{type:"float32",data:[a]}];return N(o.shape)%4===0?n=new Qd(o.shape):n=new Zd(o.shape),e.runWebGPUProgram(n,[o],o.dtype,u)}const el={kernelName:mo,backendName:"webgpu",kernelFunc:Jd};/**
 * @license
 * Copyright 2023 Google LLC.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
 ...
 * limitations under the License.
 * =============================================================================
 */class tl{constructor(t){this.outputShape=[],this.variableNames=["real","imag"],this.workgroupSize=[64,1,1],this.size=!0,this.outputShape=t,this.dispatchLayout=I(this.outputShape),this.dispatch=b(this.dispatchLayout,this.outputShape,this.workgroupSize),this.shaderKey="complexAbs"}getUserCode(){return`
    ${S("index")} {
      if (index < uniforms.size) {
 ...
 * limitations under the License.
 * =============================================================================
 */function bt(s,t){return{dataId:t.dataId,dtype:t.dtype,shape:s.shape}}function sl(s){const{inputs:t,backend:e}=s,{x:i}=t,o=e.tensorMap.get(i.dataId),r=new tl(i.shape),a=[bt(i,o.complexTensorInfos.real),bt(i,o.complexTensorInfos.imag)];return e.runWebGPUProgram(r,a,a[0].dtype)}const ol={kernelName:go,backendName:"webgpu",kernelFunc:sl};/**
 * @license
 * Copyright 2019 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
 ...
 * limitations under the License.
 * =============================================================================
 */function Ue(s){const{inputs:t,backend:e}=s,{input:i}=t,o=e.tensorMap.get(i.dataId);return K({inputs:{x:o.complexTensorInfos.imag},backend:e})}const rl={kernelName:xo,backendName:"webgpu",kernelFunc:Ue};/**
 * @license
 * Copyright 2021 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
 ...
 * limitations under the License.
 * =============================================================================
 */function Ht(s){const{inputs:t,backend:e,attrs:i}=s,{axis:o}=i,r=re(o,t[0].shape)[0],a=t.map(d=>d.shape);wo(a,r);const n=ve(t.map(d=>d.shape),r);if(N(n)===0)return e.makeTensorInfo(n,t[0].dtype,[]);const u=t.filter(d=>N(d.shape)>0);return u.length===1?K({inputs:{x:u[0]},backend:e}):we(u,r,e)}const nl={kernelName:Co,backendName:"webgpu",kernelFunc:Ht};/**
 * @license
 * Copyright 2019 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
 ...
 * limitations under the License.
 * =============================================================================
 */function bl(s=4){const t=r=>{switch(r){case 1:return"return W[getIndexFromCoords4D(coord, uniforms.wShape)];";case 4:return`
 ...
 * limitations under the License.
 * =============================================================================
 */const Fl=L({opType:y.COS}),Ll={kernelName:Ro,backendName:"webgpu",kernelFunc:Fl};/**
 * @license
 * Copyright 2021 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
 ...
 * limitations under the License.
 * =============================================================================
 */const El=L({opType:y.COSH}),_l={kernelName:Po,backendName:"webgpu",kernelFunc:El};/**
 * @license
 * Copyright 2019 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
 ...
 * limitations under the License.
 * =============================================================================
 */const Wl=s=>{const{inputs:t,backend:e,attrs:i}=s,{image:o,boxes:r,boxInd:a}=t,{cropSize:n,method:u,extrapolationValue:d}=i,l=new Bl(o.shape[3],r.shape,n,u),h=[{type:"float32",data:[d]}];return e.runWebGPUProgram(l,[o,r,a],"float32",h)},Tl={kernelName:$o,backendName:"webgpu",kernelFunc:Wl};/**
 * @license
 * Copyright 2022 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
 ...
 * limitations under the License.
 * =============================================================================
 */function Vl(s){const{inputs:t,backend:e,attrs:i}=s,{x:o}=t,{axis:r,exclusive:a,reverse:n}=i;return Kt(ke.Prod,o,e,r,a,n)}const Ul={kernelName:Do,backendName:"webgpu",kernelFunc:Vl};/**
 * @license
 * Copyright 2022 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
 ...
 * limitations under the License.
 * =============================================================================
 */function Ml(s){const{inputs:t,backend:e,attrs:i}=s,{x:o}=t,{axis:r,exclusive:a,reverse:n}=i;return Kt(ke.Sum,o,e,r,a,n)}const Ol={kernelName:No,backendName:"webgpu",kernelFunc:Ml};/**
 * @license
 * Copyright 2022 Google LLC.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
 ...
 * limitations under the License.
 * =============================================================================
 */class ic{constructor(t){this.variableNames=["x"],this.workgroupSize=[64,1,1],this.size=!0,this.outputShape=[t,t],this.dispatchLayout=I(this.outputShape),this.dispatch=b(this.dispatchLayout,this.outputShape,this.workgroupSize),this.shaderKey="diag"}getUserCode(){return`
      ${S("index")} {
        if (index < uniforms.size) {
          let coords = getOutputCoords();
 ...
 * limitations under the License.
 * =============================================================================
 */const jt=U({opType:$.MUL,cpuKernelImpl:vu,supportsComplex:!0}),wc={kernelName:Uo,backendName:"webgpu",kernelFunc:jt};/**
 * @license
 * Copyright 2021 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
 ...
 * limitations under the License.
 * =============================================================================
 */function Qt(s){const{inputs:t,backend:e,attrs:i}=s,{x:o}=t,{axis:r,keepDims:a}=i;return ue(o,r,a,"sum",e)}const yc={kernelName:Mo,backendName:"webgpu",kernelFunc:Qt};/**
 * @license
 * Copyright 2021 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
 ...
 * limitations under the License.
 * =============================================================================
 */function Sc(s){const{inputs:t,backend:e,attrs:i}=s,{equation:o}=i,r=t,{allDims:a,summedDims:n,idDims:u}=Go(o,r.length);Ho(a.length,u,r);const{path:d,steps:l}=Xo(n,u),h=l.length;let c=null,p=a.length;const f=[];for(let m=0;m<h;++m){for(const g of l[m]){const{permutationIndices:x,expandDims:C}=Ko(p,u[g]);let w;qo(x)?w=r[g]:(w=j({inputs:{x:r[g]},backend:e,attrs:{perm:x}}),f.push(w));const v=w.shape.slice();for(let k=0;k<C.length;++k)v.splice(C[k],0,1);fe(w.shape,v)||(w=R({inputs:{x:w},backend:e,attrs:{shape:v}}),f.push(w)),c===null?c=w:(c=jt({inputs:{a:w,b:c},backend:e}),f.push(c))}m<h-1&&(d[m]>=0&&(c=Qt({inputs:{x:c},backend:e,attrs:{axis:d[m]-(a.length-p),keepDims:!1}}),f.push(c)),p--)}for(const m of f)m!==c&&e.disposeData(m.dataId);return c}const bc={kernelName:Oo,backendName:"webgpu",kernelFunc:Sc};/**
 * @license
 * Copyright 2021 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
 ...
 * limitations under the License.
 * =============================================================================
 */const vc=L({opType:y.ELU}),Ic={kernelName:Yo,backendName:"webgpu",kernelFunc:vc};/**
 * @license
 * Copyright 2023 Google LLC.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
 ...
 * limitations under the License.
 * =============================================================================
 */const kc=s=>{const{inputs:t,backend:e}=s,{dy:i,y:o}=t,r=new Fe($.ELU_DER,i.shape,o.shape);return e.runWebGPUProgram(r,[i,o],i.dtype)},Rc={kernelName:jo,backendName:"webgpu",kernelFunc:kc};/**
 * @license
 * Copyright 2021 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
 ...
 * limitations under the License.
 * =============================================================================
 */const Pc=U({opType:$.EQUAL,dtype:"bool",cpuKernelImpl:uu}),$c={kernelName:Qo,backendName:"webgpu",kernelFunc:Pc};/**
 * @license
 * Copyright 2022 Google LLC.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
 ...
 * limitations under the License.
 * =============================================================================
 */const Dc=L({opType:y.ERF}),Nc={kernelName:Zo,backendName:"webgpu",kernelFunc:Dc};/**
 * @license
 * Copyright 2021 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
 ...
 * limitations under the License.
 * =============================================================================
 */const zc=L({opType:y.EXP,cpuKernelImpl:du,dtype:"float32"}),Ac={kernelName:Jo,backendName:"webgpu",kernelFunc:zc};/**
 * @license
 * Copyright 2021 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the License);
 * you may not use this file except in compliance with the License.
 ...
 * limitations under the License.
 * =============================================================================
 */function qe(s){const{inputs:t,attrs:e,backend:i}=s,{dim:o}=e,{input:r}=t,a=r.shape.length,n=r.shape.slice();let u=o;return o<0&&(E(-(a+1)<=o,()=>`Axis must be in the interval [${-(a+1)}, ${a}]`),u=a+o+1),n.splice(u,0,1),R({inputs:{x:r},backend:i,attrs:{shape:n}})}const Fc={kernelName:ei,backendName:"webgpu",kernelFunc:qe};/**
 * @license
 * Copyright 2021 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
 ...
 * limitations under the License.
 * =============================================================================
 */const Lc=L({opType:y.EXPM1,cpuKernelImpl:lu}),Ec={kernelName:ti,backendName:"webgpu",kernelFunc:Lc};/**
 * @license
 * Copyright 2022 Google LLC.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
 ...
 * limitations under the License.
 * =============================================================================
 */function _c(s){const{inputs:t,backend:e}=s,{input:i}=t;return Zt(i,!1,e)}const Bc={kernelName:si,backendName:"webgpu",kernelFunc:_c};/**
 * @license
 * Copyright 2021 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
 ...
 * limitations under the License.
 * =============================================================================
 */class Wc{constructor(t){this.outputShape=[],this.variableNames=["x"],this.workgroupSize=[64,1,1],this.size=!0,this.outputShape=t,this.dispatchLayout=I(this.outputShape),this.dispatch=b(this.dispatchLayout,this.outputShape,this.workgroupSize),this.shaderKey="flipLeftRight"}getUserCode(){return`
      ${S("index")} {
        if (index < uniforms.size) {
          let coords = getCoordsFromIndex(index);
 ...
 * limitations under the License.
 * =============================================================================
 */const Tc={kernelName:oi,backendName:"webgpu",kernelFunc:({inputs:s,backend:t})=>{const{image:e}=s,i=t,o=new Wc(e.shape);return i.runWebGPUProgram(o,[e],e.dtype)}};/**
 * @license
 * Copyright 2021 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
 ...
 * limitations under the License.
 * =============================================================================
 */const Vc=L({opType:y.FLOOR,cpuKernelImpl:cu}),Uc={kernelName:ii,backendName:"webgpu",kernelFunc:Vc};/**
 * @license
 * Copyright 2021 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
 ...
 * limitations under the License.
 * =============================================================================
 */const Mc=U({opType:$.FLOOR_DIV,cpuKernelImpl:hu,dtype:"int32"}),Oc={kernelName:ri,backendName:"webgpu",kernelFunc:Mc};/**
 * @license
 * Copyright 2022 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
 ...
 * limitations under the License.
 * =============================================================================
 */function Yc(s){const{inputs:t,backend:e,attrs:i}=s,{x:o,filter:r,bias:a,preluActivationWeights:n}=t,{strides:u,pad:d,dataFormat:l,dilations:h,dimRoundingMode:c,activation:p,leakyreluAlpha:f}=i,m=De(l),g=ee(o.shape,r.shape,u,h,d,c,!1,m);return Xt({x:o,filter:r,convInfo:g,backend:e,bias:a,preluActivationWeights:n,leakyreluAlpha:f,activation:p})}const jc={kernelName:ui,backendName:"webgpu",kernelFunc:Yc};/**
 * @license
 * Copyright 2020 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
 ...
 * limitations under the License.
 * =============================================================================
 */function eh(s){const{inputs:t,backend:e}=s,{params:i,indices:o}=t,r=o.shape,a=r[r.length-1],n=N(i.shape),[u,d,l,h]=ci(i,o),c=R({inputs:{x:o},backend:e,attrs:{shape:[d,a]}}),p=R({inputs:{x:i},backend:e,attrs:{shape:[N(i.shape)/l,l]}});if(e.shouldExecuteOnCPU([i,o])||i.dtype==="string"){const C=e.readSync(o.dataId),w=e.bufferSync(i),v=pu(C,w,i.dtype,d,a,l,h,i.shape,n);return e.makeTensorInfo(u,i.dtype,v.values)}const f=new Jc(a,[d,l]),m=[{type:"int32",data:[a]},{type:"int32",data:h}],g=e.runWebGPUProgram(f,[p,c],p.dtype,m),x=R({inputs:{x:g},backend:e,attrs:{shape:u}});return e.disposeData(c.dataId),e.disposeData(p.dataId),e.disposeData(g.dataId),x}const th={kernelName:li,backendName:"webgpu",kernelFunc:eh};/**
 * @license
 * Copyright 2021 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
 ...
 * limitations under the License.
 * =============================================================================
 */const rh=U({opType:$.GREATER,cpuKernelImpl:gu,dtype:"bool"}),ah={kernelName:fi,backendName:"webgpu",kernelFunc:rh};/**
 * @license
 * Copyright 2021 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
 ...
 * limitations under the License.
 * =============================================================================
 */const nh=U({opType:$.GREATER_EQUAL,dtype:"bool",cpuKernelImpl:mu}),uh={kernelName:mi,backendName:"webgpu",kernelFunc:nh};/**
 * @license
 * Copyright 2022 Google LLC.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
 ...
 * limitations under the License.
 * =============================================================================
 */function dh(s){const{inputs:t,backend:e}=s,{input:i}=t;return Zt(i,!0,e)}const lh={kernelName:gi,backendName:"webgpu",kernelFunc:dh};/**
 * @license
 * Copyright 2022 Google LLC.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
 ...
 * limitations under the License.
 * =============================================================================
 */const ch=L({opType:y.IS_FINITE,dtype:"bool"}),hh={kernelName:xi,backendName:"webgpu",kernelFunc:ch};/**
 * @license
 * Copyright 2022 Google LLC.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
 ...
 * limitations under the License.
 * =============================================================================
 */const ph=L({opType:y.IS_INF,dtype:"bool"}),fh={kernelName:Ci,backendName:"webgpu",kernelFunc:ph};/**
 * @license
 * Copyright 2022 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
 ...
 * limitations under the License.
 * =============================================================================
 */const mh=L({opType:y.IS_NAN,dtype:"bool"}),gh={kernelName:wi,backendName:"webgpu",kernelFunc:mh};/**
 * @license
 * Copyright 2021 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
 ...
 * limitations under the License.
 * =============================================================================
 */function xh(s){const{inputs:t,backend:e,attrs:i}=s,{x:o}=t,{alpha:r}=i,a=[{type:"float32",data:[r]}],n=new me(o.shape,y.LEAKYRELU,"alpha : f32,");return e.runWebGPUProgram(n,[o],"float32",a)}const Ch={kernelName:yi,backendName:"webgpu",kernelFunc:xh};/**
 * @license
 * Copyright 2021 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
 ...
 * limitations under the License.
 * =============================================================================
 */const wh=U({opType:$.LESS,dtype:"bool",cpuKernelImpl:Cu}),yh={kernelName:Si,backendName:"webgpu",kernelFunc:wh};/**
 * @license
 * Copyright 2021 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
 ...
 * limitations under the License.
 * =============================================================================
 */const Sh=U({opType:$.LESS_EQUAL,dtype:"bool",cpuKernelImpl:xu}),bh={kernelName:bi,backendName:"webgpu",kernelFunc:Sh};/**
 * @license
 * Copyright 2022 Google LLC.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
 ...
 * limitations under the License.
 * =============================================================================
 */function Ih(s){const{backend:t,attrs:e}=s,{start:i,stop:o,num:r}=e,a=(o-i)/(r-1),n=new vh(r),u=[{type:"float32",data:[i]},{type:"float32",data:[a]}];return t.runWebGPUProgram(n,[],"float32",u)}const kh={kernelName:vi,backendName:"webgpu",kernelFunc:Ih};/**
 * @license
 * Copyright 2021 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
 ...
 * limitations under the License.
 * =============================================================================
 */const Rh=L({opType:y.LOG,cpuKernelImpl:wu}),Ph={kernelName:Ii,backendName:"webgpu",kernelFunc:Rh};/**
 * @license
 * Copyright 2022 Google LLC.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
 ...
 * limitations under the License.
 * =============================================================================
 */const $h=L({opType:y.LOG1P}),Dh={kernelName:ki,backendName:"webgpu",kernelFunc:$h};/**
 * @license
 * Copyright 2021 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
 ...
 * limitations under the License.
 * =============================================================================
 */const Nh=U({opType:$.LOGICAL_AND,dtype:"bool"}),zh={kernelName:Ri,backendName:"webgpu",kernelFunc:Nh};/**
 * @license
 * Copyright 2021 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
 ...
 * limitations under the License.
 * =============================================================================
 */const Ah=L({opType:y.LOGICAL_NOT}),Fh={kernelName:Pi,backendName:"webgpu",kernelFunc:Ah};/**
 * @license
 * Copyright 2022 Google LLC.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
 ...
 * limitations under the License.
 * =============================================================================
 */const Lh=U({opType:$.LOGICAL_OR}),Eh={kernelName:$i,backendName:"webgpu",kernelFunc:Lh};/**
 * @license
 * Copyright 2022 Google LLC.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
...
`;class _h{constructor(t){this.outputShape=[],this.variableNames=["x"],this.uniforms="radius : i32, bias : f32, alpha : f32, beta : f32,",this.workgroupSize=[64,1,1],this.size=!0,this.outputShape=t,this.dispatchLayout=I(this.outputShape),this.dispatch=b(this.dispatchLayout,this.outputShape,this.workgroupSize),this.shaderKey="lrn"}getUserCode(){return`
    ${S("index")} {
      if (index < uniforms.size) {
        let coords = getOutputCoords();
        let b = coords[0];
 ...
 * limitations under the License.
 * =============================================================================
 */function Wh(s){const{inputs:t,backend:e,attrs:i}=s,{x:o}=t,{depthRadius:r,bias:a,alpha:n,beta:u}=i;let d;r>16?d=new _h(o.shape):d=new Bh(o.shape,r);const l=[{type:"int32",data:[r]},{type:"float32",data:[a]},{type:"float32",data:[n]},{type:"float32",data:[u]}];return e.runWebGPUProgram(d,[o],o.dtype,l)}const Th={kernelName:Di,backendName:"webgpu",kernelFunc:Wh};/**
 * @license
 * Copyright 2023 Google LLC.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
 ...
 * limitations under the License.
 * =============================================================================
 */function Uh(s){const{inputs:t,backend:e,attrs:i}=s,{x:o,y:r,dy:a}=t,{depthRadius:n,bias:u,alpha:d,beta:l}=i,h=new Vh(o.shape),c=[{type:"int32",data:[n]},{type:"float32",data:[u]},{type:"float32",data:[d]},{type:"float32",data:[l]}];return e.runWebGPUProgram(h,[o,r,a],o.dtype,c)}const Mh={kernelName:Ni,backendName:"webgpu",kernelFunc:Uh};/**
 * @license
 * Copyright 2020 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
 ...
 * limitations under the License.
 * =============================================================================
 */const Oh=U({opType:$.MAX,cpuKernelImpl:Su}),Gh={kernelName:zi,backendName:"webgpu",kernelFunc:Oh};/**
 * @license
 * Copyright 2021 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
 ...
 * limitations under the License.
 * =============================================================================
 */function Hh(s){const{inputs:t,backend:e,attrs:i}=s,{x:o}=t,{filterSize:r,strides:a,pad:n,dimRoundingMode:u}=i,l=$e(o.shape,r,a,1,n,u);return Mt(o,l,"max",e)}const Xh={kernelName:Ai,backendName:"webgpu",kernelFunc:Hh};/**
 * @license
 * Copyright 2023 Google LLC.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
 ...
 * limitations under the License.
 * =============================================================================
 */function Kh(s){const{inputs:t,backend:e,attrs:i}=s,{x:o}=t,{filterSize:r,strides:a,pad:n,dataFormat:u,dimRoundingMode:d}=i,l=[1,1,1],h=_e(o.shape,r,a,l,n,d,u),c=new nt(h,"max"),p=[{type:"int32",data:[h.strideDepth,h.strideHeight,h.strideWidth]},{type:"int32",data:[h.padInfo.front,h.padInfo.top,h.padInfo.left]},{type:"int32",data:[h.inDepth,h.inHeight,h.inWidth]},{type:"int32",data:[h.effectiveFilterDepth,h.effectiveFilterHeight,h.effectiveFilterWidth]}];return e.runWebGPUProgram(c,[o],o.dtype,p)}const qh={kernelName:Fi,backendName:"webgpu",kernelFunc:Kh};/**
 * @license
 * Copyright 2023 Google LLC.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
 ...
 * limitations under the License.
 * =============================================================================
 */function op(s){const{inputs:t,backend:e,attrs:i}=s,{x:o}=t,{axis:r,keepDims:a}=i;return ue(o,r,a,"min",e)}const ip={kernelName:Bi,backendName:"webgpu",kernelFunc:op};/**
 * @license
 * Copyright 2021 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
 ...
 * limitations under the License.
 * =============================================================================
 */const rp=U({opType:$.MIN,cpuKernelImpl:bu}),ap={kernelName:Wi,backendName:"webgpu",kernelFunc:rp};/**
 * @license
 * Copyright 2020 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
 ...
 * limitations under the License.
 * =============================================================================
 */const up={kernelName:Ti,backendName:"webgpu",kernelFunc:({inputs:s,attrs:t,backend:e})=>{const{x:i}=s,{paddings:o,mode:r}=t,a=e,n=o.map(l=>({type:"int32",data:[l[0],l[1]]})),u=new np(i.shape,o,r);return a.runWebGPUProgram(u,[i],i.dtype,n)}};/**
 * @license
 * Copyright 2022 Google LLC.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
 ...
 * limitations under the License.
 * =============================================================================
 */const dp=U({opType:$.MOD}),lp={kernelName:Vi,backendName:"webgpu",kernelFunc:dp};/**
 * @license
 * Copyright 2023 Google LLC.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
 ...
 * limitations under the License.
 * =============================================================================
 */function gp(s){const{inputs:t,backend:e}=s,{x:i}=t;if(e.shouldExecuteOnCPU([i])){const r=e.tensorMap.get(i.dataId),[a,n]=Iu(r.values,i.shape,i.dtype);return e.makeTensorInfo(n,i.dtype,a)}const o=new me(i.shape,y.NEG);return e.runWebGPUProgram(o,[i],i.dtype)}const xp={kernelName:Oi,backendName:"webgpu",kernelFunc:gp};/**
 * @license
 * Copyright 2020 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
 ...
 * limitations under the License.
 * =============================================================================
 */function yp(s){console.warn("tf.nonMaxSuppression() in webgpu locks the UI thread. Call tf.nonMaxSuppressionAsync() instead");const{inputs:t,backend:e,attrs:i}=s,{boxes:o,scores:r}=t,{maxOutputSize:a,iouThreshold:n,scoreThreshold:u,softNmsSigma:d}=i,l=e.readSync(o.dataId),h=e.readSync(r.dataId),c=a,p=n,f=u,m=d,{selectedIndices:g,selectedScores:x}=Ki(l,h,c,p,f,m);return[e.makeTensorInfo([g.length],"int32",new Int32Array(g)),e.makeTensorInfo([x.length],"float32",new Float32Array(x))]}const Sp={kernelName:Xi,backendName:"webgpu",kernelFunc:yp};/**
 * @license
 * Copyright 2022 Google LLC.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
 ...
 * limitations under the License.
 * =============================================================================
 */class bp{constructor(t,e){this.variableNames=["x"],this.uniforms="onValue : f32, offValue : f32,",this.workgroupSize=[64,1,1],this.size=!0,this.outputShape=[t,e],this.dispatchLayout=I(this.outputShape),this.dispatch=b(this.dispatchLayout,this.outputShape,this.workgroupSize),this.shaderKey="onehot"}getUserCode(){return`
      ${S("index")} {
        if(index < uniforms.size) {
          let coords = getCoordsFromIndex(index);
 ...
 * limitations under the License.
 * =============================================================================
 */function vp(s){const{inputs:t,backend:e,attrs:i}=s,{indices:o}=t,{dtype:r,depth:a,onValue:n,offValue:u}=i,d=N(o.shape),l=new bp(d,a),h=R({inputs:{x:o},backend:e,attrs:{shape:[d]}}),c=[{type:"float32",data:[n]},{type:"float32",data:[u]}],p=e.runWebGPUProgram(l,[h],r,c);e.disposeData(h.dataId);const f=[...o.shape,a],m=R({inputs:{x:p},backend:e,attrs:{shape:f}});return e.disposeData(p.dataId),m}const Ip={kernelName:qi,backendName:"webgpu",kernelFunc:vp};/**
 * @license
 * Copyright 2021 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
 ...
 * limitations under the License.
 * =============================================================================
 */function Pp(s){const{inputs:t,backend:e,attrs:i}=s,{axis:o}=i;if(t.length===1)return qe({inputs:{input:t[0]},backend:e,attrs:{dim:o}});const r=t[0].shape,a=t[0].dtype;t.forEach(l=>{Zi(r,l.shape,"All tensors passed to stack must have matching shapes"),E(a===l.dtype,()=>"All tensors passed to stack must have matching dtypes")});const n=[],u=t.map(l=>{const h=qe({inputs:{input:l},backend:e,attrs:{dim:o}});return n.push(h),h}),d=Ht({inputs:u,backend:e,attrs:{axis:o}});return n.forEach(l=>e.disposeData(l.dataId)),d}const $p={kernelName:Qi,backendName:"webgpu",kernelFunc:Pp};/**
 * @license
 * Copyright 2019 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
 ...
 * limitations under the License.
 * =============================================================================
 */function os(s,t=!1){const e=s.length,i=_(e),o=s.map((h,c)=>`uniforms.pad${c}[0]`).join(","),r=s.map((h,c)=>`uniforms.pad${c}[0] + uniforms.xShape${e>1?`[${c}]`:""}`).join(","),a=e>1?`${i}(${o})`:`${o}`,n=e>1?`${i}(${r})`:`${r}`,u=e>1?"any(paddedCoords < start)":"paddedCoords < start",d=e>1?"any(paddedCoords >= end)":"paddedCoords >= end",l=e>1?["coords[0]","coords[1]","coords[2]","coords[3]"].slice(0,e):"coords";return`
        let start = ${a};
        let end = ${n};
        if (${u} || ${d}) {
 ...
 * limitations under the License.
 * =============================================================================
 */const Ap=U({opType:$.POW}),Fp={kernelName:er,backendName:"webgpu",kernelFunc:Ap};/**
 * @license
 * Copyright 2021 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
 ...
 * limitations under the License.
 * =============================================================================
 */function Lp(s){const{inputs:t,backend:e}=s,{x:i,alpha:o}=t,r=new Fe($.PRELU,i.shape,o.shape);return e.runWebGPUProgram(r,[i,o],"float32")}const Ep={kernelName:tr,backendName:"webgpu",kernelFunc:Lp};/**
 * @license
 * Copyright 2021 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
 ...
 * limitations under the License.
 * =============================================================================
 */function _p(s){const{inputs:t,backend:e,attrs:i}=s,{x:o}=t,{axis:r,keepDims:a}=i;return ue(o,r,a,"prod",e)}const Bp={kernelName:sr,backendName:"webgpu",kernelFunc:_p};/**
 * @license
 * Copyright 2021 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
 ...
 * limitations under the License.
 * =============================================================================
 */const Wp=s=>{const{backend:t,attrs:e}=s,{start:i,stop:o,step:r,dtype:a}=e,n=Pu(i,o,r,a);return t.makeTensorInfo([n.length],a,n)},Tp={kernelName:or,backendName:"webgpu",kernelFunc:Wp};/**
 * @license
 * Copyright 2021 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
 ...
 * limitations under the License.
 * =============================================================================
 */const Vp=U({opType:$.DIV}),Up={kernelName:ir,backendName:"webgpu",kernelFunc:Vp};/**
 * @license
 * Copyright 2022 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
 ...
 * limitations under the License.
 * =============================================================================
 */const Mp=L({opType:y.RECIPROCAL}),Op={kernelName:rr,backendName:"webgpu",kernelFunc:Mp};/**
 * @license
 * Copyright 2021 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
 ...
 * limitations under the License.
 * =============================================================================
 */const Gp=L({opType:y.RELU}),Hp={kernelName:ar,backendName:"webgpu",kernelFunc:Gp};/**
 * @license
 * Copyright 2021 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
 ...
 * limitations under the License.
 * =============================================================================
 */const Xp=L({opType:y.RELU6}),Kp={kernelName:nr,backendName:"webgpu",kernelFunc:Xp};/**
 * @license
 * Copyright 2019 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
 ...
 * limitations under the License.
 * =============================================================================
 */function Yp(s){const{inputs:t,backend:e,attrs:i}=s,{images:o}=t,{alignCorners:r,size:a,halfPixelCenters:n}=i,[u,d]=a,l=r&&u>1?1:0,h=r&&d>1?1:0,p=[{type:"float32",data:[l,h]},{type:"float32",data:[n?.5:0]}],f=new qp(o.shape,u,d);return e.runWebGPUProgram(f,[o],"float32",p)}const jp={kernelName:ur,backendName:"webgpu",kernelFunc:Yp};/**
 * @license
 * Copyright 2023 Google LLC.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
 ...
 * limitations under the License.
 * =============================================================================
 */function tf(s){const{inputs:t,backend:e,attrs:i}=s,{images:o}=t,{alignCorners:r,halfPixelCenters:a,size:n}=i,[u,d]=n,l=r&&u>1?1:0,h=r&&d>1?1:0,p=[{type:"float32",data:[l,h]},{type:"float32",data:[r?.5:0]}],f=new ef(o.shape,u,d,a);return e.runWebGPUProgram(f,[o],o.dtype,p)}const sf={kernelName:lr,backendName:"webgpu",kernelFunc:tf};/**
 * @license
 * Copyright 2023 Google LLC.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
 ...
 * limitations under the License.
 * =============================================================================
 */class nf{constructor(t){this.variableNames=["x"],this.workgroupSize=[64,1,1],this.size=!0,this.outputShape=t,this.dispatchLayout=I(this.outputShape),this.dispatch=b(this.dispatchLayout,this.outputShape,this.workgroupSize),this.uniforms=" axis : vec4<i32>,",this.shaderKey="reverse"}getUserCode(){return`
 ...
 * limitations under the License.
 * =============================================================================
 */class lf{constructor(t,e){this.outputShape=[],this.variableNames=["x"],this.workgroupSize=[64,1,1],this.size=!0,this.outputShape=t,this.dispatchLayout=I(this.outputShape),this.dispatch=b(this.dispatchLayout,this.outputShape,this.workgroupSize),this.uniforms=`centerX : f32, centerY : f32, sinRadians : f32,
 ...
 * limitations under the License.
 * =============================================================================
 */const cf={kernelName:pr,backendName:"webgpu",kernelFunc:({inputs:s,attrs:t,backend:e})=>{const{image:i}=s,{radians:o,fillValue:r,center:a}=t,n=e,u=new lf(i.shape,r),[d,l]=fr(a,i.shape[1],i.shape[2]),h=[{type:"float32",data:[d]},{type:"float32",data:[l]},{type:"float32",data:[Math.sin(o)]},{type:"float32",data:[Math.cos(o)]}];return typeof r=="number"?h.push({type:"float32",data:[Number.parseFloat(r.toFixed(2))]}):h.push({type:"float32",data:r}),n.runWebGPUProgram(u,[i],i.dtype,h)}};/**
 * @license
 * Copyright 2022 Google LLC.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
 ...
 * limitations under the License.
 * =============================================================================
 */const hf=L({opType:y.ROUND}),pf={kernelName:mr,backendName:"webgpu",kernelFunc:hf};/**
 * @license
 * Copyright 2021 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
 ...
 * limitations under the License.
 * =============================================================================
 */const ff=L({opType:y.RSQRT,cpuKernelImpl:$u}),mf={kernelName:gr,backendName:"webgpu",kernelFunc:ff};/**
 * @license
 * Copyright 2021 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
 ...
 * limitations under the License.
 * =============================================================================
 */function gf(s){const{inputs:t,backend:e,attrs:i}=s,{indices:o,updates:r}=t,{shape:a}=i,{sliceRank:n,numUpdates:u,sliceSize:d,strides:l,outputSize:h}=et(r,o,a),c=[h/d,d];if(h===0)return e.makeTensorInfo(a,o.dtype);const p=R({inputs:{x:o},backend:e,attrs:{shape:[u,n]}}),f=R({inputs:{x:r},backend:e,attrs:{shape:[u,d]}}),m=f.dtype,g=X({backend:e,attrs:{shape:c,value:0,dtype:m}}),x=N(f.shape),C=[{type:"int32",data:[n]},{type:"int32",data:l},{type:"int32",data:[x]}],w=new ye(f.shape,n,p.shape.length,f.shape.length,l,c,m),v=e.runWebGPUProgram(w,[f,p],m,C,g),k=R({inputs:{x:v},backend:e,attrs:{shape:a}});return e.disposeData(p.dataId),e.disposeData(f.dataId),e.disposeData(v.dataId),k}const xf={kernelName:xr,backendName:"webgpu",kernelFunc:gf};/**
 * @license
 * Copyright 2022 Google LLC.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
 ...
 * limitations under the License.
 * =============================================================================
 */function wf(s){const{inputs:t,backend:e,attrs:i}=s,{sortedSequence:o,values:r}=t,{side:a}=i,n=new Cf([r.shape[0],r.shape[1]],a),u=[{type:"int32",data:[o.shape[1]]}];return e.runWebGPUProgram(n,[o,r],"int32",u)}const yf={kernelName:Cr,backendName:"webgpu",kernelFunc:wf};/**
 * @license
 * Copyright 2019 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
 ...
 * limitations under the License.
 * =============================================================================
 */function bf(s){const{inputs:t,backend:e}=s,{condition:i,t:o,e:r}=t,a=new Sf(i.shape.length,o.shape,o.shape.length);return e.runWebGPUProgram(a,[i,o,r],be(o.dtype,r.dtype))}const vf={kernelName:wr,backendName:"webgpu",kernelFunc:bf};/**
 * @license
 * Copyright 2022 Google LLC.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
 ...
 * limitations under the License.
 * =============================================================================
 */const If=L({opType:y.SELU}),kf={kernelName:yr,backendName:"webgpu",kernelFunc:If};/**
 * @license
 * Copyright 2021 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
 ...
 * limitations under the License.
 * =============================================================================
 */const Rf=L({opType:y.SIGMOID}),Pf={kernelName:Sr,backendName:"webgpu",kernelFunc:Rf};/**
 * @license
 * Copyright 2022 Google LLC.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
 ...
 * limitations under the License.
 * =============================================================================
 */const $f=L({opType:y.SIGN}),Df={kernelName:br,backendName:"webgpu",kernelFunc:$f};/**
 * @license
 * Copyright 2021 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
 ...
 * limitations under the License.
 * =============================================================================
 */const Nf=L({opType:y.SIN}),zf={kernelName:vr,backendName:"webgpu",kernelFunc:Nf};/**
 * @license
 * Copyright 2021 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
 ...
 * limitations under the License.
 * =============================================================================
 */const Af=L({opType:y.SINH}),Ff={kernelName:Ir,backendName:"webgpu",kernelFunc:Af};/**
 * @license
 * Copyright 2022 Google LLC.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
 ...
 * limitations under the License.
 * =============================================================================
 */const Lf=L({opType:y.SOFTPLUS}),Ef={kernelName:kr,backendName:"webgpu",kernelFunc:Lf};/**
 * @license
 * Copyright 2023 Google LLC.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
 ...
 * limitations under the License.
 * =============================================================================
 */const Bf=s=>{const{inputs:t,backend:e,attrs:i}=s,{x:o}=t,{blockShape:r,paddings:a}=i;E(o.shape.length<=4,()=>"spaceToBatchND for rank > 4 with a WebGPU backend not implemented yet");const n=r.reduce((C,w)=>C*w),u=[[0,0]];u.push(...a);for(let C=1+r.length;C<o.shape.length;++C)u.push([0,0]);const d=u.map((C,w)=>C[0]+o.shape[w]+C[1]),l=Nt(d,r,n,!1),h=zt(l.length,r.length,!1),c=At(d,r,n,!1),p=Se(d),f=new _f(o.shape,d,u,l,h,p.length),m=[{type:"int32",data:l},{type:"int32",data:p}];u.map(C=>m.push({type:"int32",data:[C[0],C[1]]}));const g=e.runWebGPUProgram(f,[o],o.dtype,m),x=R({inputs:{x:g},backend:e,attrs:{shape:c}});return e.disposeData(g.dataId),x},Wf={kernelName:Rr,backendName:"webgpu",kernelFunc:Bf};/**
 * @license
 * Copyright 2023 Google LLC.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
 ...
 */class Tf{constructor(t,e,i){this.variableNames=["input","indices","segmentIds"],this.outputShape=[],this.uniforms="segmentSize : i32, sparseSize : i32,",this.workgroupSize=[64,1,1],this.atomic=!0,this.outputShape=t,this.type=i,this.dispatchLayout=I([e]),this.dispatch=b(this.dispatchLayout,[e],this.workgroupSize),this.shaderKey="sparseSegmentSum"}getUserCode(){return`
  ...
  `}}class Vf{constructor(t,e){this.variableNames=["segmentIds"],this.outputShape=[],this.workgroupSize=[64,1,1],this.atomic=!0,this.outputShape=[t],this.dispatchLayout=I(e),this.dispatch=b(this.dispatchLayout,e,this.workgroupSize),this.shaderKey="sparseSegmentIdCountProgram"}getUserCode(){return`
    ${S("index")} {
 ...
 * limitations under the License.
 * =============================================================================
 */function Mf(s){const{inputs:t,backend:e}=s,{data:i,indices:o,segmentIds:r}=t;return is(i,o,r,!1,e)}const Of={kernelName:Pr,backendName:"webgpu",kernelFunc:Mf};/**
 * @license
 * Copyright 2023 Google LLC.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
 ...
 * limitations under the License.
 * =============================================================================
 */function Gf(s){const{inputs:t,backend:e}=s,{data:i,indices:o,segmentIds:r}=t;return is(i,o,r,!0,e)}const Hf={kernelName:$r,backendName:"webgpu",kernelFunc:Gf};/**
 * @license
 * Copyright 2021 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
 ...
 * limitations under the License.
 * =============================================================================
 */function Yf(s){const{inputs:t,backend:e,attrs:i}=s,{sparseIndices:o,sparseValues:r,defaultValue:a}=t,{outputShape:n}=i,{sliceRank:u,numUpdates:d,sliceSize:l,strides:h,outputSize:c}=et(r,o,n),p=!1;if(r.dtype==="string"){const F=e.bufferSync(o),A=e.bufferSync(r),B=Ye(e.readSync(a.dataId)[0]),W=Du(F,A,n,c,l,d,u,h,B,p);return e.makeTensorInfo(n,W.dtype,W.values)}const f=[c/l,l],m=R({inputs:{x:o},backend:e,attrs:{shape:[d,u]}}),g=r.shape.length?R({inputs:{x:r},backend:e,attrs:{shape:[d,l]}}):K({inputs:{x:r},backend:e}),x=g.dtype,C=e.makeTensorInfo([],x,zr(1,x)),w=R({inputs:{x:a},backend:e,attrs:{shape:Array(f.length).fill(1)}}),v=ut({inputs:{x:w},backend:e,attrs:{reps:f}}),k=N([d,l]),P=[{type:"int32",data:[u]},{type:"int32",data:h},{type:"int32",data:[k]}];switch(d){case 0:break;case 1:{const F=new ye([d,l],u,m.shape.length,g.shape.length,h,f,x,p);e.runWebGPUProgram(F,[g,m],x,P,v)}break;default:{const F=new ye([d,l],u,m.shape.length,C.shape.length,h,f,x,p);e.runWebGPUProgram(F,[C,m],x,P,v)}{const F=new ye([d,l],u,m.shape.length,g.shape.length,h,f,x);e.runWebGPUProgram(F,[g,m],x,P,v)}}const D=R({inputs:{x:v},backend:e,attrs:{shape:n}});return e.disposeData(m.dataId),e.disposeData(g.dataId),e.disposeData(w.dataId),e.disposeData(C.dataId),e.disposeData(v.dataId),D}const jf={kernelName:Nr,backendName:"webgpu",kernelFunc:Yf};/**
 * @license
 * Copyright 2021 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
 ...
 * limitations under the License.
 * =============================================================================
 */function Qf(s){const{inputs:t,backend:e,attrs:i}=s,{x:o}=t,{numOrSizeSplits:r,axis:a}=i,n=re(a,o.shape)[0],u=Fr(o,r,n),d=o.shape.length,l=new Array(d).fill(0),h=o.shape.slice();return u.map(c=>{const p=[...h];p[n]=c;const f=ge({inputs:{x:o},backend:e,attrs:{begin:l,size:p}});return l[n]+=c,f})}const Zf={kernelName:Ar,backendName:"webgpu",kernelFunc:Qf};/**
 * @license
 * Copyright 2021 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
 ...
 * limitations under the License.
 * =============================================================================
 */const Jf=L({opType:y.SQRT}),em={kernelName:Lr,backendName:"webgpu",kernelFunc:Jf};/**
 * @license
 * Copyright 2020 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
 ...
 * limitations under the License.
 * =============================================================================
 */const tm={kernelName:Er,backendName:"webgpu",kernelFunc:({inputs:s,backend:t})=>{const{x:e}=s,i=t,o=new me(e.shape,y.SQUARE);return i.runWebGPUProgram(o,[e],e.dtype)}};/**
 * @license
 * Copyright 2020 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
 ...
 * limitations under the License.
 * =============================================================================
 */function im({inputs:s,attrs:t,backend:e}){const{x:i}=s,o=new me(i.shape,y.STEP,"stepAlpha : f32,"),r=[{type:"float32",data:[t.alpha]}];return e.runWebGPUProgram(o,[i],i.dtype,r)}const rm={kernelName:Br,backendName:"webgpu",kernelFunc:im};/**
 * @license
 * Copyright 2019 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
 ...
 * limitations under the License.
 * =============================================================================
 */function nm(s){const{inputs:t,backend:e,attrs:i}=s,{x:o}=t,{begin:r,end:a,strides:n,beginMask:u,endMask:d,ellipsisMask:l,newAxisMask:h,shrinkAxisMask:c}=i,{finalShapeSparse:p,finalShape:f,isIdentity:m,sliceDim0:g,isSimpleSlice:x,begin:C,end:w,strides:v}=Tr(o.shape,r,a,n,u,d,l,h,c);let k;if(m)k=R({inputs:{x:o},backend:e,attrs:{shape:f}});else if(g||x){E(o.shape.length>=1,()=>`Input must have rank at least 1, got: ${o.shape.length}`);const P=Vr(C,w,v),D=ge({inputs:{x:o},backend:e,attrs:{begin:C,size:P}});k=R({inputs:{x:D},backend:e,attrs:{shape:f}}),e.disposeData(D.dataId)}else if(e.shouldExecuteOnCPU([o])){const D=e.readSync(o.dataId),F=he(o.shape,o.dtype,D),A=Au(p,F,v,C);k=e.makeTensorInfo(f,o.dtype,A.values)}else{const D=new am(p),F=[{type:"int32",data:C},{type:"int32",data:v}],A=e.runWebGPUProgram(D,[o],o.dtype,F);k=R({inputs:{x:A},backend:e,attrs:{shape:f}}),e.disposeData(A.dataId)}return k}const um={kernelName:Wr,backendName:"webgpu",kernelFunc:nm};/**
 * @license
 * Copyright 2021 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
 ...
 * limitations under the License.
 * =============================================================================
 */const cm=U({opType:$.SUB,cpuKernelImpl:Lu,supportsComplex:!0}),hm={kernelName:Mr,backendName:"webgpu",kernelFunc:cm};/**
 * @license
 * Copyright 2022 Google LLC.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
 ...
 * limitations under the License.
 * =============================================================================
 */const pm=L({opType:y.TAN}),fm={kernelName:Or,backendName:"webgpu",kernelFunc:pm};/**
 * @license
 * Copyright 2021 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
 ...
 * limitations under the License.
 * =============================================================================
 */const mm=L({opType:y.TANH}),gm={kernelName:Gr,backendName:"webgpu",kernelFunc:mm};/**
 * @license
 * Copyright 2023 Google LLC.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
 ...
 * limitations under the License.
 * =============================================================================
 */function xm(s){const{inputs:t,backend:e,attrs:i}=s,{tensor:o,indices:r,updates:a}=t,{sliceRank:n,numUpdates:u,sliceSize:d,strides:l,outputSize:h}=et(a,r,o.shape),c=[h/d,d];if(h===0)return e.makeTensorInfo(o.shape,r.dtype);const p=[],f=R({inputs:{x:r},backend:e,attrs:{shape:[u,n]}});p.push(f);const m=R({inputs:{x:a},backend:e,attrs:{shape:[u,d]}});p.push(m);const g=R({inputs:{x:o},backend:e,attrs:{shape:c}});p.push(g);const x=ut({inputs:{x:g},backend:e,attrs:{reps:Array(c.length).fill(1)}}),C=new ye([u,d],n,f.shape.length,m.shape.length,l,c,o.dtype,!1),w=N([u,d]),v=[{type:"int32",data:[n]},{type:"int32",data:l},{type:"int32",data:[w]}],k=e.runWebGPUProgram(C,[m,f],g.dtype,v,x);p.push(k);const P=R({inputs:{x:k},backend:e,attrs:{shape:o.shape}});return p.forEach(D=>e.disposeData(D.dataId)),P}const Cm={kernelName:Hr,backendName:"webgpu",kernelFunc:xm};/**
 * @license
 * Copyright 2021 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
 ...
 * limitations under the License.
 * =============================================================================
 */class wm{constructor(t){this.variableNames=["x","indices"],this.workgroupSize=[256,1,1],this.size=!0,this.outputShape=t,this.dispatchLayout=I(this.outputShape),this.dispatch=b(this.dispatchLayout,this.outputShape,this.workgroupSize),this.uniforms=`inputSize : i32, firstPass : i32, negativeInf : f32,
      ...
      `}}class ym{constructor(t){this.variableNames=["x","indices"],this.workgroupSize=[256,1,1],this.size=!0,this.outputShape=t,this.dispatchLayout=I(this.outputShape),this.dispatch=b(this.dispatchLayout,this.outputShape,this.workgroupSize),this.uniforms="inputSize : i32, firstPass : i32, k : i32,",this.shaderKey="merge"}getUserCode(){return`
        ${S("index")} {
          if (index < uniforms.size) {
            let outC = getCoordsFromIndex(index);
            let batch = outC[0];
 ...
 * limitations under the License.
 * =============================================================================
 */function ce(s,t){t!==null&&s.disposeData(t.dataId)}function Pt(s){let t=1;for(;t<s;)t*=2;return t}function Sm(s){const{inputs:t,backend:e,attrs:i}=s,{x:o}=t,{k:r,sorted:a}=i,n=o.shape,u=n[n.length-1];if(e.shouldExecuteOnCPU([o])){const k=e.readSync(o.dataId),[P,D]=_u(k,n,o.dtype,r,a);return[e.makeTensorInfo(P.shape,P.dtype,P.values),e.makeTensorInfo(D.shape,D.dtype,D.values)]}if(r===0)return n[n.length-1]=0,[e.makeTensorInfo(n,o.dtype,[]),e.makeTensorInfo(n,"int32",[])];if(u===1)return[o,X({attrs:{shape:n,dtype:"int32",value:0},backend:e})];const l=N(n)/u,h=R({inputs:{x:o},attrs:{shape:[l,u]},backend:e}),c=Pt(r),p=Pt(u);let f=null;const m=()=>f===null?[h,h]:[h,f],g=(k,P,D)=>{const F=m(),A=new wm(D),W=[{type:"int32",data:[u]},{type:"int32",data:[f===null?1:0]},{type:"float32",data:[Number.NEGATIVE_INFINITY]},{type:"int32",data:[k]},{type:"int32",data:[P]}],H=f;f=e.runWebGPUProgram(A,F,"int32",W),ce(e,H)};for(let k=1;k<c;k*=2){const P=k*2;for(let D=k;D>=1;D/=2)g(P,D,[l,p])}for(let k=p;k>c;k/=2){const P=m(),D=new ym([l,k/2]),A=[{type:"int32",data:[u]},{type:"int32",data:[f===null?1:0]},{type:"int32",data:[c]}],B=f;f=e.runWebGPUProgram(D,P,"int32",A),ce(e,B);const W=c/2,H=W*2;for(let O=W;O>=1;O/=2)g(H,O,f.shape)}let x=f;f=ge({inputs:{x:f},backend:e,attrs:{begin:0,size:[l,r]}}),ce(e,x);let C=Jt({inputs:{x:h,indices:f},backend:e,attrs:{axis:1,batchDims:1}});ce(e,h);const w=n.slice(0,-1);w.push(r),x=f,f=R({inputs:{x:f},attrs:{shape:w},backend:e}),ce(e,x);const v=C;return C=R({inputs:{x:C},attrs:{shape:w},backend:e}),ce(e,v),[C,f]}const bm={kernelName:Xr,backendName:"webgpu",kernelFunc:Sm};/**
 * @license
 * Copyright 2021 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
 ...
 * limitations under the License.
 * =============================================================================
 */function Rm(s){const{inputs:t,backend:e,attrs:i}=s,{value:o}=t;let{axis:r}=i;r<0&&(r+=o.shape.length);const a=o,n=a.shape.length,u=o.shape[r],d=new Array(n-1);let l=0;for(let m=0;m<n;m++)m!==r&&(d[l++]=a.shape[m]);const h=[],c=new Array(n).fill(0),p=a.shape.slice();p[r]=1;const f=new Array(u);for(let m=0;m<f.length;m++){c[r]=m;const g=ge({inputs:{x:a},backend:e,attrs:{begin:c,size:p}}),x=R({inputs:{x:g},backend:e,attrs:{shape:d}});f[m]=x,h.push(g)}return h.forEach(m=>e.disposeData(m.dataId)),f}const Pm={kernelName:qr,backendName:"webgpu",kernelFunc:Rm};/**
 * @license
 * Copyright 2023 Google LLC.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
 ...
 * limitations under the License.
 * =============================================================================
 */function Dm(s){const{inputs:t,backend:e,attrs:i}=s,{x:o,segmentIds:r}=t,{numSegments:a}=i,n=o.shape.length,u=[];let d=0;const l=Re([d],n);let h=o;l!=null&&(h=j({inputs:{x:o},backend:e,attrs:{perm:l}}),u.push(h),d=Pe(1,n)[0]);const c=jr(h.shape,d,a),p=N([h.shape[d]]),f=R({inputs:{x:h},backend:e,attrs:{shape:[-1,p]}});u.push(f);const m=o.dtype,g=[f.shape[0],a],x=X({backend:e,attrs:{shape:g,value:0,dtype:m}}),C=new $m(f.shape,g,m),w=[{type:"int32",data:[a]},{type:"int32",data:[N(f.shape)]}],v=e.runWebGPUProgram(C,[f,r],m,w,x),k=R({inputs:{x:v},backend:e,attrs:{shape:c}});u.push(v);let P=k;if(l!=null){u.push(k);const D=Ft(l);P=j({inputs:{x:P},backend:e,attrs:{perm:D}})}return u.forEach(D=>e.disposeData(D.dataId)),P}const Nm={kernelName:Yr,backendName:"webgpu",kernelFunc:Dm};/**
 * @license
 * Copyright 2020 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
 ...
 * limitations under the License.
 * =============================================================================
 */const zm=[tu,Tu,Uu,Ou,Hu,qu,td,od,rd,nd,dd,cd,pd,md,xd,bd,Id,$d,Nd,Ad,Bd,Ud,Gd,qd,jd,el,ou,ol,nl,ml,Sl,kl,$l,Nl,Al,Ll,_l,Tl,Ul,Ol,Hl,ql,tc,oc,Ql,ac,dc,pc,mc,Cc,bc,Ic,Rc,$c,Nc,Ac,Fc,Ec,Bc,Zn,Tc,Hc,Uc,Oc,qc,jc,Zc,th,ih,ah,uh,su,lh,rl,hh,fh,gh,Ch,yh,bh,kh,Dh,Ph,zh,Fh,Eh,Th,Mh,wd,Gh,Xh,ep,qh,Zh,sp,yd,ip,ap,up,lp,mp,wc,xp,wp,Sp,Hd,Ip,Rp,$p,zp,Fp,Ep,Bp,Tp,Xd,Up,Op,Hp,Kp,Jn,jp,Jp,sf,af,df,cf,pf,mf,xf,yf,vf,kf,Pf,Df,zf,Ff,Ed,rm,um,lm,pp,Ef,Wf,Of,Hf,jf,Zf,em,tm,om,hm,yc,fm,gm,Cm,qf,bm,km,Qu,Pm,Nm,kp];for(const s of zm)Qr(s);export{Be as WebGPUBackend,Bm as webgpu_util};
