import{N as I,p as G,W as T,cM as v,d6 as A,j as b,d7 as W,t as P,d9 as z,x as N,e6 as M,a3 as y,e4 as E}from"./index-3qA-kFFc.js";/**
 * @license
 ...
 * =============================================================================
 */function $(o,i,t,s){const a=I(t,G(i));if(s&&t!=="string"){let e=0;o.forEach(n=>{const h=G(n.shape);a.set(n.vals,e),e+=h})}else{let e=0;o.forEach(n=>{const h=t==="string"?T(n.vals):n.vals;let r=0;for(let c=0;c<n.shape[0];++c){const f=c*i[1]+e;for(let l=0;l<n.shape[1];++l)a[f+l]=h[r++]}e+=n.shape[1]})}return a}/**
 * @license
 * Copyright 2020 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
 ...
 * limitations under the License.
 * =============================================================================
 */function D(o,i,t,s,a){const e=A(s,i,t),n=G(t),h=b(s);if(e){const l=W(i,h);return a==="string"?o.slice(l,l+n):o.subarray(l,l+n)}const r=a==="string"?T(o):o,c=P(s,a,r),f=P(t,a);for(let l=0;l<f.size;++l){const g=f.indexToLoc(l),S=g.map((u,x)=>u+i[x]);f.set(c.get(...S),...g)}return a==="string"?z(f.values):f.values}/**
 * @license
 ...
 * limitations under the License.
 * =============================================================================
 */function U(o,i){const t=I("int32",o.length);for(let s=0;s<o.length;++s)t[s]=M(o[s]).modulo(i).getLowBitsUnsigned();return t}/**
 * @license
 * Copyright 2020 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
 ...
 * limitations under the License.
 * =============================================================================
 */function j(o,i,t,s){const a=y(i,t)[0],e=[1,t[0],1];for(let u=0;u<a;u++)e[0]*=t[u];e[1]=t[a];for(let u=a+1;u<t.length;u++)e[2]*=t[u];const n=new Map,h=new Int32Array(t[a]),r=new E(e,s,o),c=[],f=e[0]===1&&e[2]===1;for(let u=0;u<t[a];u++){let x;if(f)x=o[u].toString();else{const d=[];for(let m=0;m<e[0];m++)for(let w=0;w<e[2];w++)d.push(r.get(m,u,w));x=d.join(",")}const p=n.get(x);if(p!=null)h[u]=p;else{const d=n.size;n.set(x,d),h[u]=d,c.push(u)}}const l=e.slice();l[1]=n.size;const g=new E(l,s);c.forEach((u,x)=>{for(let p=0;p<e[0];p++)for(let d=0;d<e[2];d++)g.set(r.get(p,u,d),p,x,d)});const S=t.slice();return S[a]=l[1],{outputValues:g.values,outputShape:S,indices:h}}export{F as a,q as b,$ as c,U as d,k as r,D as s,j as u};
