 ...
 */var Jy;function cE(){if(Jy)return Ri;Jy=1;var t=Symbol.for("react.transitional.element"),e=Symbol.for("react.fragment");function a(r,i,l){var c=null;if(l!==void 0&&(c=""+l),i.key!==void 0&&(c=""+i.key),"key"in i){l={};for(var f in i)f!=="key"&&(l[f]=i[f])}else l=i;return i=l.ref,{$$typeof:t,type:r,key:c,ref:i!==void 0?i:null,props:l}}return Ri.Fragment=e,Ri.jsx=a,Ri.jsxs=a,Ri}var e0;function fE(){return e0||(e0=1,qf.exports=cE()),qf.exports}var T=fE(),Ff={exports:{}},xe={};/**
 * @license React
 * react.production.js
 *
 * Copyright (c) Meta Platforms, Inc. and affiliates.
 ...
 * limitations under the License.
 * =============================================================================
 */function J0(t){let e=t.length,a=0;for(;e>0;)a=Math.random()*e|0,e--,Hl(t,e,a)}function kE(t,e){if(t.length!==e.length)throw new Error(`Array sizes must match to be shuffled together First array length was ${t.length}Second array length was ${e.length}`);let a=t.length,r=0;for(;a>0;)r=Math.random()*a|0,a--,Hl(t,a,r),Hl(e,a,r)}function qi(t,e,a){return Math.max(t,Math.min(e,a))}function _E(t){return t%2===0?t:t+1}function Hl(t,e,a){const r=t[e];t[e]=t[a],t[a]=r}function AE(t){let e=0;for(let a=0;a<t.length;a++)e+=t[a];return e}function OE(t,e){const a=Math.random();return e*a+(1-a)*t}function $E(t,e){let a=0;for(let r=0;r<t.length;r++){const i=Number(t[r])-Number(e[r]);a+=i*i}return a}function E(t,e){if(!t)throw new Error(typeof e=="string"?e:e())}function Dt(t,e,a=""){E(Nn(t,e),()=>a+` Shapes ${t} and ${e} must match`)}function _s(t){E(t!=null,()=>"The input to the tensor constructor must be a non-null value.")}function Ue(t){if(t.length===0)return 1;let e=t[0];for(let a=1;a<t.length;a++)e*=t[a];return e}function DE(t){return t.length===0}function eb(t,e){if(t===e)return!0;if(t==null||e==null||t.length!==e.length)return!1;for(let a=0;a<t.length;a++)if(t[a]!==null&&e[a]!==null&&t[a]!==e[a])return!1;return!0}function Nn(t,e){if(t===e)return!0;if(t==null||e==null||t.length!==e.length)return!1;for(let a=0;a<t.length;a++)if(t[a]!==e[a])return!1;return!0}function Nr(t){return t%1===0}function RE(t){if(Math.tanh!=null)return Math.tanh(t);if(t===1/0)return 1;if(t===-1/0)return-1;{const e=Math.exp(2*t);return(e-1)/(e+1)}}function CE(t){const e=Math.ceil(Math.sqrt(t));return[e,Math.ceil(t/e)]}function zE(t){const e=new Uint32Array(t);for(let a=0;a<t;++a)e[a]=a;return J0(e),e}function Bi(t,e){return e<=t.length?t:t+" ".repeat(e-t.length)}function jE(t,e=i=>0,a,r){return new Promise((i,l)=>{let c=0;const f=()=>{if(t()){i();return}c++;const h=e(c);if(a!=null&&c>=a){l();return}r!=null?r(f,h):setTimeout(f,h)};f()})}function ME(t,e){let a=1,r=-1;for(let l=0;l<t.length;++l)if(t[l]>=0)a*=t[l];else if(t[l]===-1){if(r!==-1)throw Error(`Shapes can only have 1 implicit size. Found -1 at dim ${r} and dim ${l}`);r=l}else if(t[l]<0)throw Error(`Shapes can not be < 0. Found ${t[l]} at dim ${l}`);if(r===-1){if(e>0&&e!==a)throw Error(`Size(${e}) must match the product of shape ${t}`);return t}if(a===0)throw Error(`Cannot infer the missing size in [${t}] when there are 0 elements`);if(e%a!==0)throw Error(`The implicit shape can't be a fractional number. Got ${e} / ${a}`);const i=t.slice();return i[r]=e/a,i}function to(t,e){const a=e.length;return t=t==null?e.map((r,i)=>i):[].concat(t),E(t.every(r=>r>=-a&&r<a),()=>`All values in axis param must be in range [-${a}, ${a}) but got axis ${t}`),E(t.every(r=>Nr(r)),()=>`All values in axis param must be integers but got axis ${t}`),t.map(r=>r<0?a+r:r)}function tb(t,e){const a=[],r=[],i=e!=null&&Array.isArray(e)&&e.length===0,l=e==null||i?null:to(e,t).sort();let c=0;for(let f=0;f<t.length;++f){if(l!=null){if(l[c]===f&&t[f]!==1)throw new Error(`Can't squeeze axis ${f} since its dim '${t[f]}' is not 1`);(l[c]==null||l[c]>f)&&t[f]===1&&(a.push(t[f]),r.push(f)),l[c]<=f&&c++}t[f]!==1&&(a.push(t[f]),r.push(f))}return{newShape:a,keptDims:r}}function nb(t,e){return Gh(t,e)}function Gh(t,e){let a=null;if(t==null||t==="float32")a=new Float32Array(e);else if(t==="int32")a=new Int32Array(e);else if(t==="bool")a=new Uint8Array(e);else if(t==="string")a=new Array(e);else throw new Error(`Unknown data type ${t}`);return a}function ab(t,e){for(let a=0;a<t.length;a++){const r=t[a];if(isNaN(r)||!isFinite(r))throw Error(`A tensor of type ${e} being uploaded contains ${r}.`)}}function sb(t){return t==="bool"||t==="complex64"||t==="float32"||t==="int32"||t==="string"}function LE(t,e){return!(e==="complex64"||e==="float32"&&t!=="complex64"||e==="int32"&&t!=="float32"&&t!=="complex64"||e==="bool"&&t==="bool")}function Gl(t){if(t==="float32"||t==="int32")return 4;if(t==="complex64")return 8;if(t==="bool")return 1;throw new Error(`Unknown dtype ${t}`)}function rb(t){if(t==null)return 0;let e=0;return t.forEach(a=>e+=a.length),e}function Ca(t){return typeof t=="string"||t instanceof String}function ib(t){return typeof t=="boolean"}function ob(t){return typeof t=="number"}function no(t){return Array.isArray(t)?no(t[0]):t instanceof Float32Array?"float32":t instanceof Int32Array||t instanceof Uint8Array||t instanceof Uint8ClampedArray?"int32":ob(t)?"float32":Ca(t)?"string":ib(t)?"bool":"float32"}function La(t){return!!(t&&t.constructor&&t.call&&t.apply)}function Kl(t,e){for(let a=e;a<t;++a)if(t%a===0)return a;return t}function $r(t){const e=t.length;if(e<2)return[];const a=new Array(e-1);a[e-2]=t[e-1];for(let r=e-3;r>=0;--r)a[r]=a[r+1]*t[r+1];return a}function lb(t,e,a,r=!1){const i=new Array;if(e.length===1){const l=e[0]*(r?2:1);for(let c=0;c<l;c++)i[c]=a[t+c]}else{const l=e[0],c=e.slice(1),f=c.reduce((h,p)=>h*p)*(r?2:1);for(let h=0;h<l;h++)i[h]=lb(t+h*f,c,a,r)}return i}function bs(t,e,a=!1){if(t.length===0)return e[0];const r=t.reduce((i,l)=>i*l)*(a?2:1);if(r===0)return[];if(r!==e.length)throw new Error(`[${t}] does not match the input size ${e.length}${a?" for a complex tensor":""}.`);return lb(0,t,e,a)}function IE(t,e){if(Array.isArray(t))return t;if(e==="float32")return t instanceof Float32Array?t:new Float32Array(t);if(e==="int32")return t instanceof Int32Array?t:new Int32Array(t);if(e==="bool"||e==="string")return Uint8Array.from(new Int32Array(t));throw new Error(`Unknown dtype ${e}`)}function Kh(t,e){const a=ou(t,e);for(let r=0;r<a.length;r++)a[r]=1;return a}function ou(t,e){if(e==null||e==="float32"||e==="complex64")return new Float32Array(t);if(e==="int32")return new Int32Array(t);if(e==="bool")return new Uint8Array(t);throw new Error(`Unknown data type ${e}`)}function BE(t,e){const a=t.reduce((r,i)=>r*i,1);if(e==null||e==="float32")return bs(t,new Float32Array(a));if(e==="int32")return bs(t,new Int32Array(a));if(e==="bool")return bs(t,new Uint8Array(a));throw new Error(`Unknown data type ${e}`)}function Gt(t){t.forEach(e=>{E(Number.isInteger(e)&&e>=0,()=>`Tensor must have a shape comprised of positive integers but got shape [${t}].`)})}function UE(t,e,a){if(e===0)return 0;if(e===1)return t[0];let r=t[t.length-1];for(let i=0;i<t.length-1;++i)r+=a[i]*t[i];return r}function qE(t,e,a){if(e===0)return[];if(e===1)return[t];const r=new Array(e);for(let i=0;i<r.length-1;++i)r[i]=Math.floor(t/a[i]),t-=r[i]*a[i];return r[r.length-1]=t,r}function Ia(t){return t&&t.then&&typeof t.then=="function"}/**
 * @license
 ...
 * limitations under the License.
 * =============================================================================
 */let Yf;function cb(){if(Yf==null){let t;if(typeof window<"u")t=window;else if(typeof global<"u")t=global;else if(typeof process<"u")t=process;else if(typeof self<"u")t=self;else throw new Error("Could not find a global object");Yf=t}return Yf}function KE(){const t=cb();return t._tfGlobals==null&&(t._tfGlobals=new Map),t._tfGlobals}function Ph(t,e){const a=KE();if(a.has(t))return a.get(t);{const r=e();return a.set(t,r),a.get(t)}}const fb="Abs",hb="Acos",db="Acosh",Xh="Add",pb="AddN",mb="All",gb="Any",yb="ArgMax",bb="ArgMin",vb="Asin",wb="Asinh",Sb="Atan",Nb="Atanh",xb="Atan2",Tb="AvgPool",YE="AvgPoolGrad",Eb="AvgPool3D",PE="AvgPool3DGrad",kb="BatchMatMul",_b="BatchToSpaceND",Ab="Bincount",Ob="BitwiseAnd",XE="BroadcastTo",$b="BroadcastArgs",Zh="Cast",Db="Ceil",Rb="ClipByValue",Cb="Complex",zb="ComplexAbs",jb="Concat",Mb="Conv2D",Lb="Conv2DBackpropFilter",Ib="Conv2DBackpropInput",Bb="Conv3D",ZE="Conv3DBackpropFilterV2",Ub="Conv3DBackpropInputV2",qb="Cos",Fb="Cosh",Vb="Cumprod",Hb="Cumsum",Gb="CropAndResize",Kb="DenseBincount",Yb="DepthToSpace",Pb="DepthwiseConv2dNative",Xb="DepthwiseConv2dNativeBackpropFilter",Zb="DepthwiseConv2dNativeBackpropInput",Wb="Diag",Qb="Dilation2D",WE="Dilation2DBackpropInput",QE="Dilation2DBackpropFilter",Wh="Draw",Jb="RealDiv",e1="Einsum",t1="Elu",JE="EluGrad",n1="Erf",a1="Equal",s1="Exp",r1="ExpandDims",i1="Expm1",o1="FFT",l1="Fill",u1="FlipLeftRight",c1="Floor",f1="FloorDiv",h1="FusedBatchNorm",d1="GatherV2",p1="GatherNd",m1="Greater",g1="GreaterEqual",Qh="Identity",y1="IFFT",b1="Imag",v1="IsFinite",w1="IsInf",S1="IsNan",N1="LeakyRelu",x1="Less",T1="LessEqual",E1="LinSpace",k1="Log",_1="Log1p",A1="LogicalAnd",O1="LogicalNot",$1="LogicalOr",e3="LogicalXor",t3="LogSoftmax",n3="LowerBound",D1="LRN",a3="LRNGrad",s3="MatrixBandPart",R1="Max",C1="Maximum",z1="MaxPool",r3="MaxPoolGrad",j1="MaxPool3D",i3="MaxPool3DGrad",M1="MaxPoolWithArgmax",L1="Mean",I1="Min",B1="Minimum",U1="MirrorPad",q1="Mod",F1="Multinomial",V1="Multiply",H1="Neg",G1="NotEqual",K1="NonMaxSuppressionV3",Y1="NonMaxSuppressionV4",P1="NonMaxSuppressionV5",X1="OnesLike",Z1="OneHot",W1="Pack",Q1="PadV2",o3="Pool",J1="Pow",e2="Prelu",t2="Prod",n2="RaggedGather",a2="RaggedRange",s2="RaggedTensorToTensor",r2="Range",i2="Real",o2="Reciprocal",l2="Relu",u2="Reshape",c2="ResizeNearestNeighbor",l3="ResizeNearestNeighborGrad",f2="ResizeBilinear",u3="ResizeBilinearGrad",h2="Relu6",d2="Reverse",p2="Round",m2="Rsqrt",g2="ScatterNd",y2="TensorScatterUpdate",b2="SearchSorted",v2="Select",w2="Selu",S2="Slice",N2="Sin",x2="Sinh",T2="Sign",E2="Sigmoid",k2="Softplus",_2="Sqrt",A2="Sum",O2="SpaceToBatchND",$2="SplitV",D2="Softmax",R2="SparseFillEmptyRows",C2="SparseReshape",z2="SparseSegmentMean",j2="SparseSegmentSum",M2="SparseToDense",L2="SquaredDifference",c3="Square",I2="StaticRegexReplace",B2="StridedSlice",U2="StringNGrams",q2="StringSplit",F2="StringToHashBucketFast",V2="Sub",H2="Tan",G2="Tanh",Jh="Tile",K2="TopK",Y2="Transform",Cl="Transpose",P2="Unique",X2="Unpack",Z2="UnsortedSegmentSum",f3="UpperBound",W2="ZerosLike",Q2="Step",ih="FromPixels",J2="RotateWithOffset",oh="_FusedMatMul",lh="FusedConv2D",uh="FusedDepthwiseConv2D";/**
 * @license
 ...
 * limitations under the License.
 * =============================================================================
 */function Da(...t){ve().getBool("IS_TEST")||ve().getBool("PROD")||console.warn(...t)}function h3(...t){ve().getBool("IS_TEST")||ve().getBool("PROD")||console.log(...t)}/**
 * @license
 ...
 * limitations under the License.
 * =============================================================================
 */const xr=Ph("kernelRegistry",()=>new Map),Fi=Ph("gradRegistry",()=>new Map);function Vi(t,e){const a=ed(t,e);return xr.get(a)}function ch(t){return Fi.get(t)}function Yl(t){const e=xr.entries(),a=[];for(;;){const{done:r,value:i}=e.next();if(r)break;const[l,c]=i,[f]=l.split("_");f===t&&a.push(c)}return a}function ev(t){const{kernelName:e,backendName:a}=t,r=ed(e,a);xr.has(r)&&Da(`The kernel '${e}' for backend '${a}' is already registered`),xr.set(r,t)}function d3(t){const{kernelName:e}=t;Fi.has(e)&&ve().getBool("DEBUG")&&Da(`Overriding the gradient for '${e}'`),Fi.set(e,t)}function p3(t,e){const a=ed(t,e);if(!xr.has(a))throw new Error(`The kernel '${t}' for backend '${e}' is not registered`);xr.delete(a)}function m3(t){if(!Fi.has(t))throw new Error(`The gradient '${t}' for backend is not registered`);Fi.delete(t)}function g3(t,e){Yl(t).forEach(r=>{const i=Object.assign({},r,{backendName:e});ev(i)})}function ed(t,e){return`${e}_${t}`}/**
 * @license
 ...
 * limitations under the License.
 * =============================================================================
 */const ps=av||b3;function ao(t){return ps.fromString(t,!0,16)}const sv=ao("c3a5c85c97cb3127"),ds=ao("b492b66fbe98f273"),At=ao("9ae16a3b2f90404f");function fh(t){return t.xor(t.shru(47))}function rv(t,e,a){const r=t.slice(e,e+a);return ps.fromBytes(Array.from(r),!0,!0)}function Ke(t,e){return rv(t,e,8)}function h0(t,e){return rv(t,e,4)}function ft(t,e){return e===0?t:t.shru(e).or(t.shl(64-e))}function Ma(t,e,a=ao("9ddfea08eb382d69")){let r=t.xor(e).mul(a);r=r.xor(r.shru(47));let i=e.xor(r).mul(a);return i=i.xor(i.shru(47)),i=i.mul(a),i}function v3(t,e,a,r,i,l){i=i.add(t),l=ft(l.add(i).add(r),21);const c=i;return i=i.add(e),i=i.add(a),l=l.add(ft(i,44)),[i.add(r),l.add(c)]}function $l(t,e,a,r){return v3(Ke(t,e),Ke(t,e+8),Ke(t,e+16),Ke(t,e+24),a,r)}function w3(t,e=t.length){if(e>=8){const a=At.add(e*2),r=Ke(t,0).add(At),i=Ke(t,e-8),l=ft(i,37).mul(a).add(r),c=ft(r,25).add(i).mul(a);return Ma(l,c,a)}if(e>=4){const a=At.add(e*2),r=h0(t,0);return Ma(r.shl(3).add(e),h0(t,e-4),a)}if(e>0){const a=t[0],r=t[e>>1],i=t[e-1],l=a+(r<<8),c=e+(i<<2);return fh(At.mul(l).xor(sv.mul(c))).mul(At)}return At}function S3(t,e=t.length){const a=At.add(e*2),r=Ke(t,0).mul(ds),i=Ke(t,8),l=Ke(t,e-8).mul(a),c=Ke(t,e-16).mul(At);return Ma(ft(r.add(i),43).add(ft(l,30)).add(c),r.add(ft(i.add(At),18)).add(l),a)}function N3(t,e=t.length){const a=At.add(e*2),r=Ke(t,0).mul(At),i=Ke(t,8),l=Ke(t,e-8).mul(a),c=Ke(t,e-16).mul(At),f=ft(r.add(i),43).add(ft(l,30)).add(c),h=Ma(f,r.add(ft(i.add(At),18)).add(l),a),p=Ke(t,16).mul(a),g=Ke(t,24),y=f.add(Ke(t,e-32)).mul(a),v=h.add(Ke(t,e-24)).mul(a);return Ma(ft(p.add(g),43).add(ft(y,30)).add(v),p.add(ft(g.add(r),18)).add(y),a)}function x3(t,e=t.length){const a=ps.fromNumber(81,!0);if(e<=32)return e<=16?w3(t,e):S3(t,e);if(e<=64)return N3(t,e);let r=a,i=a.mul(ds).add(113),l=fh(i.mul(At).add(113)).mul(At),c=[ps.UZERO,ps.UZERO],f=[ps.UZERO,ps.UZERO];r=r.mul(At).add(Ke(t,0));let h=0;const p=(e-1>>6)*64,g=p+(e-1&63)-63;do r=ft(r.add(i).add(c[0]).add(Ke(t,h+8)),37).mul(ds),i=ft(i.add(c[1]).add(Ke(t,h+48)),42).mul(ds),r=r.xor(f[1]),i=i.add(c[0]).add(Ke(t,h+40)),l=ft(l.add(f[0]),33).mul(ds),c=$l(t,h,c[1].mul(ds),r.add(f[0])),f=$l(t,h+32,l.add(f[1]),i.add(Ke(t,h+16))),[l,r]=[r,l],h+=64;while(h!==p);const y=ds.add(l.and(255).shl(1));return h=g,f[0]=f[0].add(e-1&63),c[0]=c[0].add(f[0]),f[0]=f[0].add(c[0]),r=ft(r.add(i).add(c[0]).add(Ke(t,h+8)),37).mul(y),i=ft(i.add(c[1]).add(Ke(t,h+48)),42).mul(y),r=r.xor(f[1].mul(9)),i=i.add(c[0].mul(9).add(Ke(t,h+40))),l=ft(l.add(f[0]),33).mul(y),c=$l(t,h,c[1].mul(y),r.add(f[0])),f=$l(t,h+32,l.add(f[1]),i.add(Ke(t,h+16))),[l,r]=[r,l],Ma(Ma(c[0],f[0],y).add(fh(i).mul(sv)).add(l),Ma(c[1],f[1],y).add(r),y)}/**
 * @license
 * Copyright 2017 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
 ...
 * limitations under the License.
 * =============================================================================
 */function T3(t,e){return e==="string"?so(t):lu([t],e)}function E3(t,e){return t instanceof Float32Array&&e==="float32"||t instanceof Int32Array&&e==="int32"||t instanceof Uint8Array&&e==="bool"}function lu(t,e){if(e==="string")throw new Error("Cannot convert a string[] to a TypedArray");if(Array.isArray(t)&&(t=Ba(t)),ve().getBool("DEBUG")&&ab(t,e),E3(t,e))return t;if(e==null||e==="float32"||e==="complex64")return new Float32Array(t);if(e==="int32")return new Int32Array(t);if(e==="bool"){const a=new Uint8Array(t.length);for(let r=0;r<a.length;++r)Math.round(t[r])!==0&&(a[r]=1);return a}else throw new Error(`Unknown data type ${e}`)}function Hi(){return ve().platform.now()}function k3(t,e){return ve().platform.fetch(t,e)}function so(t,e="utf-8"){return e=e||"utf-8",ve().platform.encode(t,e)}function Pl(t,e="utf-8"){return e=e||"utf-8",ve().platform.decode(t,e)}function ht(t){return ve().platform.isTypedArray!=null?ve().platform.isTypedArray(t):tv(t)}function Ba(t,e=[],a=!1){if(e==null&&(e=[]),typeof t=="boolean"||typeof t=="number"||typeof t=="string"||Ia(t)||t==null||ht(t)&&a)e.push(t);else if(Array.isArray(t)||ht(t))for(let r=0;r<t.length;++r)Ba(t[r],e,a);else{let r=-1;for(const i of Object.keys(t))/^([1-9]+[0-9]*|0)$/.test(i)&&(r=Math.max(r,Number(i)));for(let i=0;i<=r;i++)Ba(t[i],e,a)}return e}const _3=Object.freeze(Object.defineProperty({__proto__:null,arraysEqual:Nn,arraysEqualWithNull:eb,assert:E,assertNonNegativeIntegerDimensions:Gt,assertNonNull:_s,assertShapesMatch:Dt,bytesFromStringArray:rb,bytesPerElement:Gl,checkConversionForErrors:ab,clamp:qi,computeStrides:$r,convertBackendValuesAndArrayBuffer:IE,createScalarValue:T3,createShuffledIndices:zE,decodeString:Pl,distSquared:$E,encodeString:so,fetch:k3,fingerPrint64:x3,flatten:Ba,getArrayFromDType:Gh,getTypedArrayFromDType:nb,hasEncodingLoss:LE,hexToLong:ao,indexToLoc:qE,inferDtype:no,inferFromImplicitShape:ME,isBoolean:ib,isFunction:La,isInt:Nr,isNumber:ob,isPromise:Ia,isScalarShape:DE,isString:Ca,isTypedArray:ht,isValidDtype:sb,locToIndex:UE,makeOnesTypedArray:Kh,makeZerosNestedTypedArray:BE,makeZerosTypedArray:ou,nearestDivisor:Kl,nearestLargerEven:_E,now:Hi,parseAxisParam:to,randUniform:OE,repeatedTry:jE,rightPad:Bi,shuffle:J0,shuffleCombo:kE,sizeFromShape:Ue,sizeToSquarishShape:CE,squeezeShape:tb,sum:AE,swap:Hl,tanh:RE,toNestedArray:bs,toTypedArray:lu},Symbol.toStringTag,{value:"Module"}));/**
 * @license
 * Copyright 2018 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
 ...
 * limitations under the License.
 * =============================================================================
 */class A3{constructor(e,a){this.backendTimer=e,this.logger=a,a==null&&(this.logger=new $3)}profileKernel(e,a,r){let i;const l=()=>{i=r()};let c;const f=Hi();if(this.backendTimer.timerAvailable())c=this.backendTimer.time(l);else{l();for(const p of i)p.dataSync();c=Promise.resolve({kernelMs:Hi()-f})}if(ve().getBool("CHECK_COMPUTATION_FOR_ERRORS"))for(let p=0;p<i.length;p++){const g=i[p];g.data().then(y=>{O3(y,g.dtype,e)})}return{kernelName:e,outputs:i,inputs:a,timeMs:c.then(p=>p.kernelMs),extraInfo:c.then(p=>p.getExtraProfileInfo!=null?p.getExtraProfileInfo():"")}}logKernelProfile(e){const{kernelName:a,outputs:r,timeMs:i,inputs:l,extraInfo:c}=e;r.forEach(f=>{Promise.all([f.data(),i,c]).then(h=>{this.logger.logKernelProfile(a,f,h[0],h[1],l,h[2])})})}}function O3(t,e,a){if(e!=="float32")return!1;for(let r=0;r<t.length;r++){const i=t[r];if(isNaN(i)||!isFinite(i))return console.warn(`Found ${i} in the result of '${a}'`),!0}return!1}class $3{logKernelProfile(e,a,r,i,l,c){const f=typeof i=="number"?Bi(`${i}ms`,9):i.error,h=Bi(e,25),p=a.rank,g=a.size,y=Bi(a.shape.toString(),14);let v="";for(const S in l){const k=l[S];if(k!=null){const $=k.shape||a.shape,A=$.length;v+=`${S}: ${A}D ${A>0?$:""} `}}console.log(`%c${h}	%c${f}	%c${p}D ${y}	%c${g}	%c${v}	%c${c}`,"font-weight:bold","color:red","color:blue","color: orange","color: green","color: steelblue")}}/**
 * @license
 * Copyright 2017 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
 ...
 * limitations under the License.
 * =============================================================================
 */const d0=20,ji=3,Xf=7;function C3(t,e,a,r){const i=$r(e),l=z3(t,e,a,i),c=e.length,f=zl(t,e,a,i,l),h=["Tensor"];return r&&(h.push(`  dtype: ${a}`),h.push(`  rank: ${c}`),h.push(`  shape: [${e}]`),h.push("  values:")),h.push(f.map(p=>"    "+p).join(`
`)),h.join(`
`)}function z3(t,e,a,r){const i=Ue(e),l=r[r.length-1],c=new Array(l).fill(0),f=e.length,h=a==="complex64"?Ii(t):t;if(f>1)for(let p=0;p<i/l;p++){const g=p*l;for(let y=0;y<l;y++)c[y]=Math.max(c[y],Li(h[g+y],0,a).length)}return c}function Li(t,e,a){let r;return Array.isArray(t)?r=`${parseFloat(t[0].toFixed(Xf))} + ${parseFloat(t[1].toFixed(Xf))}j`:Ca(t)?r=`'${t}'`:a==="bool"?r=iv(t):r=parseFloat(t.toFixed(Xf)).toString(),Bi(r,e)}function iv(t){return t===0?"false":"true"}function zl(t,e,a,r,i,l=!0){const c=a==="complex64"?2:1,f=e[0],h=e.length;if(h===0){if(a==="complex64"){const $=Ii(t);return[Li($[0],0,a)]}return a==="bool"?[iv(t[0])]:[t[0].toString()]}if(h===1){if(f>d0){const A=ji*c;let M=Array.from(t.slice(0,A)),X=Array.from(t.slice((f-ji)*c,f*c));return a==="complex64"&&(M=Ii(M),X=Ii(X)),["["+M.map((z,I)=>Li(z,i[I],a)).join(", ")+", ..., "+X.map((z,I)=>Li(z,i[f-ji+I],a)).join(", ")+"]"]}return["["+(a==="complex64"?Ii(t):Array.from(t)).map((A,M)=>Li(A,i[M],a)).join(", ")+"]"]}const p=e.slice(1),g=r.slice(1),y=r[0]*c,v=[];if(f>d0){for(let $=0;$<ji;$++){const A=$*y,M=A+y;v.push(...zl(t.slice(A,M),p,a,g,i,!1))}v.push("...");for(let $=f-ji;$<f;$++){const A=$*y,M=A+y;v.push(...zl(t.slice(A,M),p,a,g,i,$===f-1))}}else for(let $=0;$<f;$++){const A=$*y,M=A+y;v.push(...zl(t.slice(A,M),p,a,g,i,$===f-1))}const S=h===2?",":"";v[0]="["+(f>0?v[0]+S:"");for(let $=1;$<v.length-1;$++)v[$]=" "+v[$]+S;let k=`,
`;for(let $=2;$<h;$++)k+=`
`;return v[v.length-1]=" "+v[v.length-1]+"]"+(l?"":k),v}function Ii(t){const e=[];for(let a=0;a<t.length;a+=2)e.push([t[a],t[a+1]]);return e}/**
 * @license
 * Copyright 2017 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
 ...
 * limitations under the License.
 * =============================================================================
 */var hh;(function(t){t.R0="R0",t.R1="R1",t.R2="R2",t.R3="R3",t.R4="R4",t.R5="R5",t.R6="R6"})(hh||(hh={}));var dh;(function(t){t.float32="float32",t.int32="int32",t.bool="int32",t.complex64="complex64"})(dh||(dh={}));var ph;(function(t){t.float32="float32",t.int32="int32",t.bool="bool",t.complex64="complex64"})(ph||(ph={}));var mh;(function(t){t.float32="float32",t.int32="float32",t.bool="float32",t.complex64="complex64"})(mh||(mh={}));var gh;(function(t){t.float32="complex64",t.int32="complex64",t.bool="complex64",t.complex64="complex64"})(gh||(gh={}));const L3={float32:mh,int32:dh,bool:ph,complex64:gh};function uu(t,e){if(t==="string"||e==="string"){if(t==="string"&&e==="string")return"string";throw new Error(`Can not upcast ${t} with ${e}`)}return L3[t][e]}function I3(t){return uu(t,"int32")}function lv(t){return t!=null&&typeof t=="object"&&"texture"in t&&t.texture instanceof WebGLTexture}function uv(t){return typeof GPUBuffer<"u"&&t!=null&&typeof t=="object"&&"buffer"in t&&t.buffer instanceof GPUBuffer}/**
 * @license
 * Copyright 2018 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
 ...
 * limitations under the License.
 * =============================================================================
 */function et(t,e){if(t.dtype===e.dtype)return[t,e];const a=uu(t.dtype,e.dtype);return[t.cast(a),e.cast(a)]}function cv(t,e){E(t.dtype===e.dtype,()=>`The dtypes of the first(${t.dtype}) and second(${e.dtype}) input must match`)}function B3(t,e){return e.some(a=>a.id===t.id)}function td(t){const e=[];return fv(t,e,new Set),e}function fv(t,e,a){if(t==null)return;if(t instanceof Je){e.push(t);return}if(!U3(t))return;const r=t;for(const i in r){const l=r[i];a.has(l)||(a.add(l),fv(l,e,a))}}function U3(t){return Array.isArray(t)||typeof t=="object"}const q3=Object.freeze(Object.defineProperty({__proto__:null,assertTypesMatch:cv,getTensorsInContainer:td,isTensorInList:B3,makeTypesMatch:et},Symbol.toStringTag,{value:"Module"}));/**
 * @license
 * Copyright 2018 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
 ...
 * limitations under the License.
 * =============================================================================
 */const nd="__op";function R(t){const e=Object.keys(t);if(e.length!==1)throw new Error(`Please provide an object with a single key (operation name) mapping to a function. Got an object with ${e.length} keys.`);let a=e[0];const r=t[a];a.endsWith("_")&&(a=a.substring(0,a.length-1)),a=a+nd;const i=(...l)=>{C.startScope(a);try{const c=r(...l);return Ia(c)&&console.error("Cannot return a Promise inside of tidy."),C.endScope(c),c}catch(c){throw C.endScope(null),c}};return Object.defineProperty(i,"name",{value:a,configurable:!0}),i}/**
 * @license
 * Copyright 2020 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
 ...
 * limitations under the License.
 * =============================================================================
 */function P3(t,e){const a=x(t,"real","complex"),r=x(e,"imag","complex");Dt(a.shape,r.shape,`real and imag shapes, ${a.shape} and ${r.shape}, must match in call to tf.complex().`);const i={real:a,imag:r};return C.runKernel(Cb,i)}const aa=R({complex_:P3});/**
 * @license
 * Copyright 2018 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
 ...
 * limitations under the License.
 * =============================================================================
 */const Ss={float32:4,float16:2,int32:4,uint16:2,uint8:1,bool:1,complex64:8};class xn{static join(e){return new xn(e).slice()}constructor(e){if(this.shards=[],this.previousShardIndex=0,e==null||(e instanceof Array||(e=[e]),e=e.map(r=>ht(r)?r.buffer:r),e.length===0))return;this.bufferUniformSize=e[0].byteLength;let a=0;for(let r=0;r<e.length;r++){const i=e[r];r!==e.length-1&&i.byteLength!==this.bufferUniformSize&&(this.bufferUniformSize=void 0);const l=a+i.byteLength;this.shards.push({buffer:i,start:a,end:l}),a=l}this.shards.length===0&&(this.byteLength=0),this.byteLength=this.shards[this.shards.length-1].end}slice(e=0,a=this.byteLength){if(this.shards.length===0)return new ArrayBuffer(0);if(e=isNaN(Number(e))?0:e,a=isNaN(Number(a))?0:a,e=Math.max(0,e),a=Math.min(this.byteLength,a),a<=e)return new ArrayBuffer(0);const r=this.findShardForByte(e);if(r===-1)throw new Error(`Could not find start shard for byte ${e}`);const i=a-e,l=new ArrayBuffer(i),c=new Uint8Array(l);let f=0;for(let h=r;h<this.shards.length;h++){const p=this.shards[h],y=e+f-p.start,v=f,k=Math.min(a,p.end)-p.start,$=new Uint8Array(p.buffer,y,k-y);if(c.set($,v),f+=$.length,a<p.end)break}return l}findShardForByte(e){if(this.shards.length===0||e<0||e>=this.byteLength)return-1;if(this.bufferUniformSize!=null)return this.previousShardIndex=Math.floor(e/this.bufferUniformSize),this.previousShardIndex;function a(i){return e<i.start?-1:e>=i.end?1:0}if(a(this.shards[this.previousShardIndex])===0)return this.previousShardIndex;const r=X3(this.shards,a);return r===-1?-1:(this.previousShardIndex=r,this.previousShardIndex)}}function X3(t,e){let a=0,r=t.length;for(;a<=r;){const i=Math.floor((r-a)/2)+a,l=e(t[i]);if(l===0)return i;l<0?r=i:a=i+1}return-1}/**
 * @license
 * Copyright 2018 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
 ...
 * limitations under the License.
 * =============================================================================
 */function Z3(){ve().set("PROD",!0)}function W3(){ve().set("DEBUG",!0)}function Q3(){ve().set("DEPRECATION_WARNINGS_ENABLED",!1),console.warn("TensorFlow.js deprecation warnings have been disabled.")}function J3(t){ve().getBool("DEPRECATION_WARNINGS_ENABLED")&&console.warn(t+" You can disable deprecation warnings with tf.disableDeprecationWarnings().")}function ek(){C.disposeVariables()}function tk(){return C}function nk(){return C.memory()}function ak(t){return C.profile(t)}function Ce(t,e){return C.tidy(t,e)}function $t(t){td(t).forEach(a=>a.dispose())}function vn(t){return C.keep(t)}function sk(t){return C.time(t)}function rk(t){return C.setBackend(t)}function ik(){return C.ready()}function mv(){return C.backendName}function ok(t){C.removeBackend(t)}function lk(t){return C.findBackend(t)}function uk(t){return C.findBackendFactory(t)}function ck(t,e,a=1){return C.registerBackend(t,e,a)}function gv(){return C.backend}function fk(t,e){ve().setPlatform(t,e)}/**
 * @license
 * Copyright 2018 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
 ...
 * limitations under the License.
 * =============================================================================
 */class Fk{constructor(){this.messageName="setTimeoutCustom",this.functionRefs=[],this.handledMessageCount=0,this.hasEventListener=!1}fetch(e,a){return fetch(e,a)}now(){return performance.now()}encode(e,a){if(a!=="utf-8"&&a!=="utf8")throw new Error(`Browser's encoder only supports utf-8, but got ${a}`);return this.textEncoder==null&&(this.textEncoder=new TextEncoder),this.textEncoder.encode(e)}decode(e,a){return new TextDecoder(a).decode(e)}setTimeoutCustom(e,a){if(typeof window>"u"||!ve().getBool("USE_SETTIMEOUTCUSTOM")){setTimeout(e,a);return}this.functionRefs.push(e),setTimeout(()=>{window.postMessage({name:this.messageName,index:this.functionRefs.length-1},"*")},a),this.hasEventListener||(this.hasEventListener=!0,window.addEventListener("message",r=>{if(r.source===window&&r.data.name===this.messageName){r.stopPropagation();const i=this.functionRefs[r.data.index];i(),this.handledMessageCount++,this.handledMessageCount===this.functionRefs.length&&(this.functionRefs=[],this.handledMessageCount=0)}},!0))}isTypedArray(e){return tv(e)}}if(ve().get("IS_BROWSER")){ve().setPlatform("browser",new Fk);try{_t.registerManager(xs.URL_SCHEME,new Lk)}catch{}try{_t.registerManager(Ns.URL_SCHEME,new Ok)}catch{}}/**
 * @license
 * Copyright 2019 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
 ...
 * limitations under the License.
 * =============================================================================
 */const Vk={importFetch:()=>require("node-fetch")};let Wf;class Hk{constructor(){this.util=require("util"),this.textEncoder=new this.util.TextEncoder}fetch(e,a){return ve().global.fetch!=null?ve().global.fetch(e,a):(Wf==null&&(Wf=Vk.importFetch()),Wf(e,a))}now(){const e=process.hrtime();return e[0]*1e3+e[1]/1e6}encode(e,a){if(a!=="utf-8"&&a!=="utf8")throw new Error(`Node built-in encoder only supports utf-8, but got ${a}`);return this.textEncoder.encode(e)}decode(e,a){return e.length===0?"":new this.util.TextDecoder(a).decode(e)}isTypedArray(e){return this.util.types.isFloat32Array(e)||this.util.types.isInt32Array(e)||this.util.types.isUint8Array(e)||this.util.types.isUint8ClampedArray(e)}}ve().get("IS_NODE")&&!ve().get("IS_BROWSER")&&ve().setPlatform("node",new Hk);/**
 * @license
 ...
 * limitations under the License.
 * =============================================================================
 */function Gk(t,e){const a=x(t,"x","cast");if(!sb(e))throw new Error(`Failed to cast to unknown dtype ${e}`);if(e==="string"&&a.dtype!=="string"||e!=="string"&&a.dtype==="string")throw new Error("Only strings can be casted to strings");const r={x:a},i={dtype:e};return C.runKernel(Zh,r,i)}const He=R({cast_:Gk});/**
 * @license
 * Copyright 2020 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
 ...
 * limitations under the License.
 * =============================================================================
 */function Kk(t){const a={x:x(t,"x","clone","string_or_numeric")};return C.runKernel(Qh,a)}const ta=R({clone_:Kk});/**
 * @license
 * Copyright 2020 Google Inc. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
 ...
 * limitations under the License.
 * =============================================================================
 */hv();const Yk={buffer:Rn,cast:He,clone:ta,print:id};M3(Yk);/**
 * @license
 * Copyright 2020 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
 ...
 * limitations under the License.
 * =============================================================================
 */function Pk(t,e){let a=x(t,"a","add"),r=x(e,"b","add");[a,r]=et(a,r);const i={a,b:r};return C.runKernel(Xh,i)}const be=R({add_:Pk});/**
 * @license
 * Copyright 2020 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
 ...
 * limitations under the License.
 * =============================================================================
 */function Xk(t,e){let a=x(t,"a","floorDiv"),r=x(e,"b","floorDiv");[a,r]=et(a,r);const i={a,b:r};return C.runKernel(f1,i)}const od=R({floorDiv_:Xk});/**
 * @license
 * Copyright 2020 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
 ...
 * limitations under the License.
 * =============================================================================
 */function Zk(t,e){let a=x(t,"a","div"),r=x(e,"b","div");if([a,r]=et(a,r),a.dtype==="int32"&&r.dtype==="int32")return od(a,r);const i={a,b:r},l={};return C.runKernel(Jb,i,l)}const Pe=R({div_:Zk});/**
 * @license
 * Copyright 2020 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
 ...
 * limitations under the License.
 * =============================================================================
 */function Wk(t,e){let a=x(t,"a","mul"),r=x(e,"b","mul");[a,r]=et(a,r);const i={a,b:r};return C.runKernel(V1,i)}const le=R({mul_:Wk});/**
 * @license
 * Copyright 2018 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
 ...
 * limitations under the License.
 * =============================================================================
 */function Qk(t){const e=x(t,"x","abs");if(e.dtype==="complex64"){const a={x:e};return C.runKernel(zb,a)}else{const a={x:e};return C.runKernel(fb,a)}}const Vt=R({abs_:Qk});/**
 * @license
 * Copyright 2018 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
 ...
 * limitations under the License.
 * =============================================================================
 */function Jk(t){const a={x:x(t,"x","acos")};return C.runKernel(hb,a)}const Av=R({acos_:Jk});/**
 * @license
 * Copyright 2018 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
 ...
 * limitations under the License.
 * =============================================================================
 */function e_(t){const a={x:x(t,"x","acosh")};return C.runKernel(db,a)}const Ov=R({acosh_:e_});/**
 * @license
 * Copyright 2020 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
 ...
 * limitations under the License.
 * =============================================================================
 */function n_(t,e=null,a=!1){const i={x:x(t,"x","all","bool")},l={axis:e,keepDims:a};return C.runKernel(mb,i,l)}const Dv=R({all_:n_});/**
 * @license
 * Copyright 2020 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
 ...
 * limitations under the License.
 * =============================================================================
 */function a_(t,e=null,a=!1){const i={x:x(t,"x","any","bool")},l={axis:e,keepDims:a};return C.runKernel(gb,i,l)}const Rv=R({any_:a_});/**
 * @license
 * Copyright 2020 Google Inc. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
 ...
 * limitations under the License.
 * =============================================================================
 */function s_(t,e=0){const r={x:x(t,"x","argMax")},i={axis:e};return C.runKernel(yb,r,i)}const Cv=R({argMax_:s_});/**
 * @license
 * Copyright 2020 Google Inc. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
 ...
 * limitations under the License.
 * =============================================================================
 */function r_(t,e=0){const r={x:x(t,"x","argMin")},i={axis:e};return C.runKernel(bb,r,i)}const zv=R({argMin_:r_});/**
 * @license
 * Copyright 2018 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
 ...
 * limitations under the License.
 * =============================================================================
 */function i_(t){const a={x:x(t,"x","asin")};return C.runKernel(vb,a)}const jv=R({asin_:i_});/**
 * @license
 * Copyright 2018 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
 ...
 * limitations under the License.
 * =============================================================================
 */function o_(t){const a={x:x(t,"x","asinh")};return C.runKernel(wb,a)}const Mv=R({asinh_:o_});/**
 * @license
 * Copyright 2018 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
 ...
 * limitations under the License.
 * =============================================================================
 */function l_(t){const a={x:x(t,"x","atan")};return C.runKernel(Sb,a)}const Lv=R({atan_:l_});/**
 * @license
 * Copyright 2020 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
 ...
 * limitations under the License.
 * =============================================================================
 */function u_(t,e){let a=x(t,"a","atan2"),r=x(e,"b","atan2");[a,r]=et(a,r);const i={a,b:r};return C.runKernel(xb,i)}const Iv=R({atan2_:u_});/**
 * @license
 * Copyright 2018 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
 ...
 * limitations under the License.
 * =============================================================================
 */function c_(t){const a={x:x(t,"x","atanh")};return C.runKernel(Nb,a)}const Bv=R({atanh_:c_});/**
 * @license
 * Copyright 2020 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
 ...
 * limitations under the License.
 * =============================================================================
 */function y_(t,e){const r={x:x(t,"x","reshape","string_or_numeric")},i={shape:e};return C.runKernel(u2,r,i)}const ee=R({reshape_:y_});/**
 * @license
 * Copyright 2020 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
 ...
 * limitations under the License.
 * =============================================================================
 */function b_(t,e,a,r,i){const l=x(t,"x","avgPool","float32"),c=1;E(sa(a,c),()=>`Error in avgPool: Either strides or dilations must be 1. Got strides ${a} and dilations '${c}'`);let f=l,h=!1;l.rank===3&&(h=!0,f=ee(l,[1,l.shape[0],l.shape[1],l.shape[2]])),E(f.rank===4,()=>`Error in avgPool: x must be rank 4 but got rank ${f.rank}.`),pn("avgPool",r,i);const p={x:f},g={filterSize:e,strides:a,pad:r,dimRoundingMode:i};let y=C.runKernel(Tb,p,g);return y=He(y,l.dtype),h?ee(y,[y.shape[1],y.shape[2],y.shape[3]]):y}const ud=R({avgPool_:b_});/**
 * @license
 * Copyright 2020 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
 ...
 * limitations under the License.
 * =============================================================================
 */function w_(t,e=0){E(t.length>=1,()=>"Pass at least one tensor to concat");const a=Ki(t,"tensors","concat","string_or_numeric");if(a[0].dtype==="complex64"&&a.forEach(l=>{if(l.dtype!=="complex64")throw new Error(`Cannot concatenate complex64 tensors with a tensor
          with dtype ${l.dtype}. `)}),a.length===1)return ta(a[0]);const r=a,i={axis:e};return C.runKernel(jb,r,i)}const Nt=R({concat_:w_});/**
 * @license
 * Copyright 2020 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
 ...
 * limitations under the License.
 * =============================================================================
 */function S_(t,e,a=!1,r=!1){let i=x(t,"a","matMul"),l=x(e,"b","matMul");[i,l]=et(i,l);const c={a:i,b:l},f={transposeA:a,transposeB:r};return C.runKernel(kb,c,f)}const Me=R({matMul_:S_});/**
 * @license
 * Copyright 2018 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
 ...
 * limitations under the License.
 * =============================================================================
 */function N_(t){const a={x:x(t,"x","sigmoid","float32")};return C.runKernel(E2,a)}const vs=R({sigmoid_:N_});/**
 * @license
 * Copyright 2018 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
 ...
 * limitations under the License.
 * =============================================================================
 */function x_(t,e,a){const r=x(t,"x","slice","string_or_numeric");if(r.rank===0)throw new Error("Slicing scalar is not possible");const i={x:r},l={begin:e,size:a};return C.runKernel(S2,i,l)}const Be=R({slice_:x_});/**
 * @license
 * Copyright 2018 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
 ...
 * limitations under the License.
 * =============================================================================
 */function T_(t){const a={x:x(t,"x","tanh","float32")};return C.runKernel(G2,a)}const Wl=R({tanh_:T_});/**
 * @license
 * Copyright 2020 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
 ...
 * limitations under the License.
 * =============================================================================
 */function E_(t,e,a,r,i,l){const c=x(t,"forgetBias","basicLSTMCell"),f=x(e,"lstmKernel","basicLSTMCell"),h=x(a,"lstmBias","basicLSTMCell"),p=x(r,"data","basicLSTMCell"),g=x(i,"c","basicLSTMCell"),y=x(l,"h","basicLSTMCell"),v=Nt([p,y],1),S=Me(v,f),k=be(S,h),$=k.shape[0],A=k.shape[1]/4,M=[$,A],X=Be(k,[0,0],M),z=Be(k,[0,A],M),I=Be(k,[0,A*2],M),V=Be(k,[0,A*3],M),Z=be(le(vs(X),Wl(z)),le(g,vs(be(c,I)))),re=le(Wl(Z),vs(V));return[Z,re]}const Hv=R({basicLSTMCell_:E_});/**
 * @license
 * Copyright 2020 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
 ...
 * limitations under the License.
 * =============================================================================
 */function k_(t,e,a){const r=x(t,"x","batchToSpaceND"),i=e.reduce((f,h)=>f*h);E(r.rank>=1+e.length,()=>`input rank is ${r.rank} but should be > than blockShape.length ${e.length}`),E(a.length===e.length,()=>`crops.length is ${a.length} but should be equal to blockShape.length  ${e.length}`),E(r.shape[0]%i===0,()=>`input tensor batch is ${r.shape[0]} but is not divisible by the product of the elements of blockShape ${e.join(" * ")} === ${i}`);const l={x:r},c={blockShape:e,crops:a};return C.runKernel(_b,l,c)}const cd=R({batchToSpaceND_:k_});function __(t){let e;return t.rank===0||t.rank===1?e=ee(t,[1,1,1,t.size]):t.rank===2?e=ee(t,[1,1,t.shape[0],t.shape[1]]):t.rank===3?e=ee(t,[1,t.shape[0],t.shape[1],t.shape[2]]):e=t,e}/**
 * @license
 * Copyright 2020 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
 ...
 * limitations under the License.
 * =============================================================================
 */function R_(t,e,a){const r=x(t,"x","bincount"),i=x(e,"weights","bincount");E(r.dtype==="int32",()=>`Error in bincount: input dtype must be int32, but got ${r.dtype}`),E(a>=0,()=>`size must be non-negative, but got ${a}.`),E(i.size===r.size||i.size===0,()=>`Error in bincount: weights must have the same size as input or0-length, but got input shape: ${r.shape}, weights shape: ${i.shape}.`);const l={x:r,weights:i},c={size:a};return C.runKernel(Ab,l,c)}const fd=R({bincount_:R_});/**
 * @license
 * Copyright 2023 Google LLC.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
 ...
 * limitations under the License.
 * =============================================================================
 */function j_(t,e){let a=x(t,"broadcastTo","x");const r=a.shape;if(Gt(e),e.length<a.rank)throw new Error(`broadcastTo(): shape.length=${e.length} < input.rank=${a.rank}.`);if(e.length>a.rank){const p=a.shape.slice();for(;p.length<e.length;)p.unshift(1);a=ee(a,p)}const i=a.shape,l=Array.from(e);for(let p=e.length-1;p>=0;p--)if(i[p]===e[p])l[p]=1;else if(a.shape[p]!==1)throw new Error(`broadcastTo(): [${r}] cannot be broadcast to [${e}].`);if(l.map((p,g)=>p>1?g:-1).filter(p=>p>=0).length===0)return ta(a);const f={x:a},h={reps:l};return C.runKernel(Jh,f,h)}const Ui=R({broadcastTo_:j_});/**
 * @license
 * Copyright 2018 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
 ...
 * limitations under the License.
 * =============================================================================
 */function M_(t){const a={x:x(t,"x","ceil","float32")};return C.runKernel(Db,a)}const Zv=R({ceil_:M_});/**
 * @license
 * Copyright 2020 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
 ...
 * limitations under the License.
 * =============================================================================
 */function L_(t,e,a){const r=x(t,"x","clipByValue");if(E(e<=a,()=>`Error in clip: min (${e}) must be less than or equal to max (${a}).`),e===a)return Dr(r.shape,e,r.dtype);const i={x:r},l={clipValueMin:e,clipValueMax:a};return C.runKernel(Rb,i,l)}const Wv=R({clipByValue_:L_});function I_(t){return Nt(t,0)}const Qv=R({concat1d_:I_});function B_(t,e){return Nt(t,e)}const Jv=R({concat2d_:B_});function U_(t,e){return Nt(t,e)}const ew=R({concat3d_:U_});function q_(t,e){return Nt(t,e)}const tw=R({concat4d_:q_});/**
 * @license
 * Copyright 2020 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
 ...
 * limitations under the License.
 * =============================================================================
 */function F_(t,e,a,r,i="NHWC",l=[1,1],c){const f=x(t,"x","conv2d","float32"),h=x(e,"filter","conv2d","float32");let p=f,g=!1;f.rank===3&&(g=!0,p=ee(f,[1,f.shape[0],f.shape[1],f.shape[2]])),E(p.rank===4,()=>`Error in conv2d: input must be rank 4, but got rank ${p.rank}.`),E(h.rank===4,()=>`Error in conv2d: filter must be rank 4, but got rank ${h.rank}.`),pn("conv2d",r,c);const y=i==="NHWC"?p.shape[3]:p.shape[1];E(y===h.shape[2],()=>`Error in conv2d: depth of input (${y}) must match input depth for filter ${h.shape[2]}.`),E(sa(a,l),()=>`Error in conv2D: Either strides or dilations must be 1. Got strides ${a} and dilations '${l}'`),E(Ts(l),()=>"Error in conv2D: Dilated rates should be larger than 0."),E(Ts(a),()=>"Error in conv2D: Strides should be larger than 0.");const v={x:p,filter:h},S={strides:a,pad:r,dataFormat:i,dilations:l,dimRoundingMode:c},k=C.runKernel(Mb,v,S);return g?ee(k,[k.shape[1],k.shape[2],k.shape[3]]):k}const lo=R({conv2d_:F_});function V_(t,e,a,r,i="NWC",l=1,c){const f=x(t,"x","conv1d"),h=x(e,"filter","conv1d");let p=f,g=!1;f.rank===2&&(g=!0,p=ee(f,[1,f.shape[0],f.shape[1]])),E(p.rank===3,()=>`Error in conv1d: input must be rank 3, but got rank ${p.rank}.`),E(h.rank===3,()=>`Error in conv1d: filter must be rank 3, but got rank ${h.rank}.`),pn("conv1d",r,c),E(p.shape[2]===h.shape[1],()=>`Error in conv1d: depth of input (${p.shape[2]}) must match input depth for filter ${h.shape[1]}.`),E(sa(a,l),()=>`Error in conv1D: Either stride or dilation must be 1. Got stride ${a} and dilation '${l}'`),E(Ts(l),()=>"Error in conv1D: Dilated rates should be larger than 0."),E(Ts(a),()=>"Error in conv1D: Stride should be larger than 0."),E(i==="NWC",()=>`Error in conv1d: got dataFormat of ${i} but only NWC is currently supported.`);const y=ee(h,[1,h.shape[0],h.shape[1],h.shape[2]]),v=ee(p,[p.shape[0],1,p.shape[1],p.shape[2]]),A=lo(v,y,[1,a],r,"NHWC",[1,l],c);return g?ee(A,[A.shape[2],A.shape[3]]):ee(A,[A.shape[0],A.shape[2],A.shape[3]])}const nw=R({conv1d_:V_});/**
 * @license
 * Copyright 2020 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
 ...
 * limitations under the License.
 * =============================================================================
 */function H_(t,e,a,r,i,l="NHWC",c){E(t.length===e.rank,()=>`Length of inShape (${t.length}) and rank of dy (${e.rank}) must match`);let f=t,h=e,p=!1;e.rank===3&&(p=!0,h=ee(e,[1,e.shape[0],e.shape[1],e.shape[2]]),f=[1,t[0],t[1],t[2]]),E(f.length===4,()=>`Error in conv2dDerInput: inShape must be length 4, but got length ${f.length}.`),E(h.rank===4,()=>`Error in conv2dDerInput: dy must be rank 4, but got rank ${h.rank}`),E(a.rank===4,()=>`Error in conv2dDerInput: filter must be rank 4, but got rank ${a.rank}`);const g=l==="NHWC"?f[3]:f[1],y=l==="NHWC"?h.shape[3]:h.shape[1];E(g===a.shape[2],()=>`Error in conv2dDerInput: depth of input (${g}) must match input depth for filter ${a.shape[2]}.`),E(y===a.shape[3],()=>`Error in conv2dDerInput: depth of output (${y}) must match output depth for filter ${a.shape[3]}.`),pn("conv2dDerInput",i,c);const v={dy:h,filter:a},S={strides:r,pad:i,dataFormat:l,dimRoundingMode:c,inputShape:f},k=C.runKernel(Ib,v,S);return p?ee(k,[k.shape[1],k.shape[2],k.shape[3]]):k}const aw=R({conv2DBackpropInput_:H_});function G_(t,e,a,r,i,l){const c=x(t,"x","conv2dTranspose"),f=x(e,"filter","conv2dTranspose");return aw(a,c,f,r,i,"NHWC",l)}const sw=R({conv2dTranspose_:G_});/**
 * @license
 * Copyright 2020 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
 ...
 * limitations under the License.
 * =============================================================================
 */function K_(t,e,a,r,i="NDHWC",l=[1,1,1]){const c=x(t,"x","conv3d"),f=x(e,"filter","conv3d");let h=c,p=!1;c.rank===4&&(p=!0,h=ee(c,[1,c.shape[0],c.shape[1],c.shape[2],c.shape[3]])),E(h.rank===5,()=>`Error in conv3d: input must be rank 5, but got rank ${h.rank}.`),E(f.rank===5,()=>`Error in conv3d: filter must be rank 5, but got rank ${f.rank}.`),E(h.shape[4]===f.shape[3],()=>`Error in conv3d: depth of input (${h.shape[4]}) must match input depth for filter ${f.shape[3]}.`),E(sa(a,l),()=>`Error in conv3D: Either strides or dilations must be 1. Got strides ${a} and dilations '${l}'`),E(i==="NDHWC",()=>`Error in conv3d: got dataFormat of ${i} but only NDHWC is currently supported.`),E(Ts(l),()=>"Error in conv3D: Dilated rates should be larger than 0."),E(Ts(a),()=>"Error in conv3D: Strides should be larger than 0.");const g={x:h,filter:f},y={strides:a,pad:r,dataFormat:i,dilations:l},v=C.runKernel(Bb,g,y);return p?ee(v,[v.shape[1],v.shape[2],v.shape[3],v.shape[4]]):v}const rw=R({conv3d_:K_});/**
 * @license
 * Copyright 2020 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
 ...
 * limitations under the License.
 * =============================================================================
 */function Z_(t){const a={x:x(t,"x","cos","float32")};return C.runKernel(qb,a)}const ow=R({cos_:Z_});/**
 * @license
 * Copyright 2018 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
 ...
 * limitations under the License.
 * =============================================================================
 */function W_(t){const a={x:x(t,"x","cosh","float32")};return C.runKernel(Fb,a)}const lw=R({cosh_:W_});/**
 * @license
 ...
 * limitations under the License.
 * =============================================================================
 */function Q_(t,e=0,a=!1,r=!1){const l={x:x(t,"x","cumprod")},c={axis:e,exclusive:a,reverse:r};return C.runKernel(Vb,l,c)}const uw=R({cumprod_:Q_});/**
 * @license
 * Copyright 2018 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
 ...
 * limitations under the License.
 * =============================================================================
 */function J_(t,e=0,a=!1,r=!1){const l={x:x(t,"x","cumsum")},c={axis:e,exclusive:a,reverse:r};return C.runKernel(Hb,l,c)}const cw=R({cumsum_:J_});/**
 * @license
 * Copyright 2020 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
 ...
 * limitations under the License.
 * =============================================================================
 */function eA(t,e,a,r=!1){const i=x(t,"x","denseBincount"),l=x(e,"weights","denseBincount");E(i.dtype==="int32",()=>`Error in denseBincount: input dtype must be int32, but got ${i.dtype}`),E(i.rank<=2,()=>`Error in denseBincount: input must be at most rank 2, but got rank ${i.rank}.`),E(a>=0,()=>`size must be non-negative, but got ${a}.`),E(l.size===i.size||l.size===0,()=>`Error in denseBincount: weights must have the same shape as x or 0-length, but got x shape: ${i.shape}, weights shape: ${l.shape}.`);const c={x:i,weights:l},f={size:a,binaryOutput:r};return C.runKernel(Kb,c,f)}const fw=R({denseBincount_:eA});/**
 * @license
 * Copyright 2020 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
 ...
 * limitations under the License.
 * =============================================================================
 */function tA(t,e,a="NHWC"){const r=x(t,"x","depthToSpace","float32"),i=a==="NHWC"?r.shape[1]:r.shape[2],l=a==="NHWC"?r.shape[2]:r.shape[3],c=a==="NHWC"?r.shape[3]:r.shape[1];E(e>1,()=>`blockSize should be > 1 for depthToSpace, but was: ${e}`),E(i*e>=0,()=>`Negative dimension size caused by overflow when multiplying
    ...
    ${l} and ${e} for depthToSpace with input shape
        ${r.shape}`),E(c%(e*e)===0,()=>`Dimension size must be evenly divisible by ${e*e} but is ${c} for depthToSpace with input shape ${r.shape}`);const f={x:r},h={blockSize:e,dataFormat:a};return C.runKernel(Yb,f,h)}const hw=R({depthToSpace_:tA});/**
 * @license
 * Copyright 2020 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
 ...
 * limitations under the License.
 * =============================================================================
 */function nA(t,e,a,r,i="NHWC",l=[1,1],c){const f=x(t,"x","depthwiseConv2d","float32"),h=x(e,"filter","depthwiseConv2d","float32");let p=f,g=!1;f.rank===3&&(g=!0,p=ee(f,[1,f.shape[0],f.shape[1],f.shape[2]])),E(p.rank===4,()=>`Error in depthwiseConv2d: input must be rank 4, but got rank ${p.rank}.`),E(h.rank===4,()=>`Error in depthwiseConv2d: filter must be rank 4, but got rank ${h.rank}.`);const y=i==="NHWC"?p.shape[3]:p.shape[1];E(y===h.shape[2],()=>`Error in depthwiseConv2d: number of input channels (${y}) must match the inChannels dimension in filter ${h.shape[2]}.`),pn("depthwiseConv2d",r,c);const v={x:p,filter:h},S={strides:a,pad:r,dataFormat:i,dilations:l,dimRoundingMode:c},k=C.runKernel(Pb,v,S);return g?ee(k,[k.shape[1],k.shape[2],k.shape[3]]):k}const cu=R({depthwiseConv2d_:nA});/**
 * @license
 * Copyright 2020 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
 ...
 * limitations under the License.
 * =============================================================================
 */function aA(t){const a={x:x(t,"x","diag")};return C.runKernel(Wb,a)}const dw=R({diag_:aA});/**
 * @license
 * Copyright 2020 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
 ...
 * limitations under the License.
 * =============================================================================
 */function iA(t,e){let a=x(t,"a","equal","string_or_numeric"),r=x(e,"b","equal","string_or_numeric");[a,r]=et(a,r),it(a.shape,r.shape);const i={a,b:r};return C.runKernel(a1,i)}const dd=R({equal_:iA});/**
 * @license
 * Copyright 2020 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
 ...
 * limitations under the License.
 * =============================================================================
 */function oA(t,e,a){const r=x(e,"a","where"),i=x(a,"b","where"),l=x(t,"condition","where","bool"),c=it(it(l.shape,r.shape),i.shape),f=Ui(l,c),h=Ui(r,c),p=Ui(i,c),g={condition:f,t:h,e:p};return C.runKernel(v2,g)}const na=R({where_:oA});/**
 * @license
 * Copyright 2018 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
 ...
 * limitations under the License.
 * =============================================================================
 */function lA(t){const a={x:x(t,"x","zerosLike")};return C.runKernel(W2,a)}const Ht=R({zerosLike_:lA});/**
 * @license
 * Copyright 2020 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
 ...
 * limitations under the License.
 * =============================================================================
 */function uA(t,e){let a=x(t,"a","div"),r=x(e,"b","div");[a,r]=et(a,r);const i=Pe(a,r),l=Ht(i),c=dd(r,l);return na(c,l,i)}const gw=R({divNoNan_:uA});/**
 * @license
 * Copyright 2020 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
 ...
 * limitations under the License.
 * =============================================================================
 */function fA(t,...e){const a=e.map((i,l)=>x(i,`tensors${l}`,"einsum")),r={equation:t};return C.runKernel(e1,a,r)}const ms=R({einsum_:fA});/**
 * @license
 * Copyright 2020 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
 ...
 * limitations under the License.
 * =============================================================================
 */function hA(t){const a={x:x(t,"x","elu","float32")};return C.runKernel(t1,a)}const pd=R({elu_:hA});/**
 * @license
 * Copyright 2023 Google LLC.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
 ...
 * limitations under the License.
 * =============================================================================
 */function dA(t,e){const a=x(t,"x","ensureShape","string_or_numeric");if(!eb(a.shape,e))throw new Error(`EnsureShape: Shape of tensor ${a.shape} is not compatible with expected shape ${e}`);return t}const bw=R({ensureShape_:dA});/**
 * @license
 * Copyright 2018 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
 ...
 * limitations under the License.
 * =============================================================================
 */function pA(t){let e=x(t,"x","erf");E(e.dtype==="int32"||e.dtype==="float32",()=>"Input dtype must be `int32` or `float32`."),e.dtype==="int32"&&(e=He(e,"float32"));const a={x:e};return C.runKernel(n1,a)}const vw=R({erf_:pA});/**
 * @license
 * Copyright 2017 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
 ...
 * limitations under the License.
 * =============================================================================
 */function md(t,e){for(let a=0;a<t.length;++a)if(t[t.length-a-1]!==e-1-a)return!1;return!0}function ww(t,e,a){const r=t.length+e.length,i=[];let l=0,c=0;for(let f=0;f<r;f++)a.indexOf(f)===-1?i.push(t[l++]):i.push(e[c++]);return i}function mA(t,e){const a=[],r=t.length;for(let l=0;l<r;l++)e.indexOf(l)===-1&&a.push(t[l]);const i=e.map(l=>t[l]);return[a,i]}function uo(t,e){const a=e.map(r=>1);return ww(t,a,e)}function gA(t,e,a){E(md(e,a),()=>`${t} supports only inner-most axes for now. Got axes ${e} and rank-${a} input.`)}function yA(t,e){if(md(t,e))return null;const a=[];for(let r=0;r<e;++r)t.indexOf(r)===-1&&a.push(r);return t.forEach(r=>a.push(r)),a}function bA(t){return t.map((e,a)=>[a,e]).sort((e,a)=>e[1]-a[1]).map(e=>e[0])}function vA(t,e){const a=[];for(let r=e-t;r<e;++r)a.push(r);return a}/**
 * @license
 * Copyright 2020 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
 ...
 * limitations under the License.
 * =============================================================================
 */function wA(t,e=null,a=!1){const i={x:x(t,"x","max")},l={reductionIndices:e,keepDims:a};return C.runKernel(R1,i,l)}const ws=R({max_:wA});/**
 * @license
 * Copyright 2020 Google Inc. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
 ...
 * limitations under the License.
 * =============================================================================
 */function SA(t,e=null,a=!1){const i={x:x(t,"x","min")},l={axis:e,keepDims:a};return C.runKernel(I1,i,l)}const Ql=R({min_:SA});/**
 * @license
 * Copyright 2020 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
 ...
 * limitations under the License.
 * =============================================================================
 */function NA(t,e){let a=x(t,"base","pow"),r=x(e,"exp","pow");[a,r]=et(a,r);const i={a,b:r};return C.runKernel(J1,i)}const Er=R({pow_:NA});/**
 * @license
 * Copyright 2018 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
 ...
 * limitations under the License.
 * =============================================================================
 */function xA(t){const a={x:x(t,"x","sqrt","float32")};return C.runKernel(_2,a)}const Cn=R({sqrt_:xA});/**
 * @license
 * Copyright 2019 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
 ...
 * limitations under the License.
 * =============================================================================
 */function TA(t){const e=x(t,"x","square"),a={};return C.runKernel("Square",{x:e},a)}const dn=R({square_:TA});/**
 * @license
 * Copyright 2018 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
 ...
 * limitations under the License.
 * =============================================================================
 */function EA(t,e=null,a=!1){let r=x(t,"x","sum");r.dtype==="bool"&&(r=He(r,"int32"));const i={x:r},l={axis:e,keepDims:a};return C.runKernel(A2,i,l)}const Ye=R({sum_:EA});/**
 * @license
 * Copyright 2018 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
 ...
 * limitations under the License.
 * =============================================================================
 */function _A(t,e=null,a=!1){return co(t,"euclidean",e,a)}const Nw=R({euclideanNorm_:_A});/**
 * @license
 * Copyright 2018 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
 ...
 * limitations under the License.
 * =============================================================================
 */function AA(t){const a={x:x(t,"x","exp")};return C.runKernel(s1,a)}const qa=R({exp_:AA});/**
 * @license
 * Copyright 2020 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
 ...
 * limitations under the License.
 * =============================================================================
 */function OA(t,e=0){const a=x(t,"x","expandDims","string_or_numeric");E(e<=a.rank,()=>"Axis must be <= rank of the tensor");const r={input:a},i={dim:e};return C.runKernel(r1,r,i)}const Wn=R({expandDims_:OA});/**
 * @license
 * Copyright 2018 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
 ...
 * limitations under the License.
 * =============================================================================
 */function $A(t){const a={x:x(t,"x","expm1")};return C.runKernel(i1,a)}const xw=R({expm1_:$A});/**
 * @license
 * Copyright 2020 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
 ...
 * limitations under the License.
 * =============================================================================
 */function DA(t,e){const a=x(t,"x","tile","string_or_numeric");E(a.rank===e.length,()=>`Error in transpose: rank of input ${a.rank} must match length of reps ${e}.`);const r={x:a},i={reps:e};return C.runKernel(Jh,r,i)}const vr=R({tile_:DA});/**
 * @license
 * Copyright 2020 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
 ...
 * limitations under the License.
 * =============================================================================
 */function RA(t,e,a,r="float32"){e==null&&(e=t);const i=Rn([t,e],r),l=t<=e?t:e;for(let f=0;f<l;++f)i.set(1,f,f);const c=ee(i.toTensor(),[t,e]);if(a==null)return c;if(a.length===1)return vr(Wn(c,0),[a[0],1,1]);if(a.length===2)return vr(Wn(Wn(c,0),0),[a[0],a[1],1,1]);if(a.length===3)return vr(Wn(Wn(Wn(c,0),0),0),[a[0],a[1],a[2],1,1]);throw new Error(`eye() currently supports only 1D and 2D batchShapes, but received ${a.length}D.`)}const gd=R({eye_:RA});/**
 * @license
 * Copyright 2018 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
 ...
 * limitations under the License.
 * =============================================================================
 */function CA(t){const a={x:x(t,"x","floor","float32")};return C.runKernel(c1,a)}const yd=R({floor_:CA});/**
 * @license
 * Copyright 2018 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
 ...
 * limitations under the License.
 * =============================================================================
 */function zA(t,e,a=0,r=0){const i=x(t,"x","gather"),l=x(e,"indices","gather","int32"),c={x:i,indices:l},f={axis:a,batchDims:r};return C.runKernel(d1,c,f)}const bd=R({gather_:zA});/**
 * @license
 * Copyright 2020 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
 ...
 * limitations under the License.
 * =============================================================================
 */function jA(t,e){let a=x(t,"a","greater","string_or_numeric"),r=x(e,"b","greater","string_or_numeric");[a,r]=et(a,r),it(a.shape,r.shape);const i={a,b:r};return C.runKernel(m1,i)}const fo=R({greater_:jA});/**
 * @license
 * Copyright 2020 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
 ...
 * limitations under the License.
 * =============================================================================
 */function MA(t,e){let a=x(t,"a","greaterEqual","string_or_numeric"),r=x(e,"b","greaterEqual","string_or_numeric");[a,r]=et(a,r),it(a.shape,r.shape);const i={a,b:r};return C.runKernel(g1,i)}const vd=R({greaterEqual_:MA});/**
 * @license
 * Copyright 2020 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
 ...
 * limitations under the License.
 * =============================================================================
 */function LA(t){const a={input:x(t,"input","imag")};return C.runKernel(b1,a)}const ho=R({imag_:LA});/**
 * @license
 * Copyright 2018 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
 ...
 * limitations under the License.
 * =============================================================================
 */function IA(t){const a={x:x(t,"x","isFinite")};return C.runKernel(v1,a)}const Tw=R({isFinite_:IA});/**
 * @license
 * Copyright 2018 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
 ...
 * limitations under the License.
 * =============================================================================
 */function BA(t){const a={x:x(t,"x","isInf")};return C.runKernel(w1,a)}const Ew=R({isInf_:BA});/**
 * @license
 * Copyright 2018 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
 ...
 * limitations under the License.
 * =============================================================================
 */function UA(t){const a={x:x(t,"x","isNaN")};return C.runKernel(S1,a)}const kw=R({isNaN_:UA});/**
 * @license
 * Copyright 2020 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
 ...
 * limitations under the License.
 * =============================================================================
 */function qA(t,e=.2){const r={x:x(t,"x","leakyRelu")},i={alpha:e};return C.runKernel(N1,r,i)}const wd=R({leakyRelu_:qA});/**
 * @license
 * Copyright 2020 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
 ...
 * limitations under the License.
 * =============================================================================
 */function FA(t,e){let a=x(t,"a","less","string_or_numeric"),r=x(e,"b","less","string_or_numeric");[a,r]=et(a,r),it(a.shape,r.shape);const i={a,b:r};return C.runKernel(x1,i)}const Jl=R({less_:FA});/**
 * @license
 * Copyright 2020 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
 ...
 * limitations under the License.
 * =============================================================================
 */function VA(t,e){let a=x(t,"a","lessEqual","string_or_numeric"),r=x(e,"b","lessEqual","string_or_numeric");[a,r]=et(a,r),it(a.shape,r.shape);const i={a,b:r};return C.runKernel(T1,i)}const fu=R({lessEqual_:VA});/**
 * @license
 * Copyright 2018 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
 ...
 * limitations under the License.
 * =============================================================================
 */function HA(t,e=5,a=1,r=1,i=.5){const l=x(t,"x","localResponseNormalization");E(l.rank===4||l.rank===3,()=>`Error in localResponseNormalization: x must be rank 3 or 4 but got
               rank ${l.rank}.`),E(Nr(e),()=>`Error in localResponseNormalization: depthRadius must be an integer but got depthRadius ${e}.`);let c=l,f=!1;l.rank===3&&(f=!0,c=ee(l,[1,l.shape[0],l.shape[1],l.shape[2]]));const h={x:c},p={depthRadius:e,bias:a,alpha:r,beta:i},g=C.runKernel(D1,h,p);return f?ee(g,[g.shape[1],g.shape[2],g.shape[3]]):g}const Aw=R({localResponseNormalization_:HA});/**
 * @license
 * Copyright 2018 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
 ...
 * limitations under the License.
 * =============================================================================
 */function GA(t){const a={x:x(t,"x","log","float32")};return C.runKernel(k1,a)}const kr=R({log_:GA});/**
 * @license
 * Copyright 2018 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
 ...
 * limitations under the License.
 * =============================================================================
 */function KA(t){const a={x:x(t,"x","log1p")};return C.runKernel(_1,a)}const Sd=R({log1p_:KA});/**
 * @license
 * Copyright 2018 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
 ...
 * limitations under the License.
 * =============================================================================
 */function YA(t){return E(La(t),()=>"The f passed in grad(f) must be a function"),(e,a)=>{const r=x(e,"x","tf.grad","string_or_numeric"),i=a!=null?x(a,"dy","tf.grad"):null;return C.tidy(()=>{const{value:l,grads:c}=C.gradients(()=>t(r),[r],i);return i!=null&&Dt(l.shape,i.shape,"The shape of dy passed in grad(f)(x, dy) must match the shape returned by f(x)"),hu(c),c[0]})}}function PA(t){return E(La(t),()=>"The f passed in grads(f) must be a function"),(e,a)=>{E(Array.isArray(e),()=>"The args passed in grads(f)(args) must be an array of `Tensor`s or `TensorLike`s");const r=Ki(e,"args","tf.grads","string_or_numeric"),i=a!=null?x(a,"dy","tf.grads"):null;return C.tidy(()=>{const{value:l,grads:c}=C.gradients(()=>t(...r),r,i);return i!=null&&Dt(l.shape,i.shape,"The shape of dy passed in grads(f)([x1,...], dy) must match the shape returned by f([x1,...])"),hu(c),c})}}function XA(t){return E(La(t),()=>"The f passed in valueAndGrad(f) must be a function"),(e,a)=>{E(e instanceof Je,()=>"The x passed in valueAndGrad(f)(x) must be a tensor"),E(a==null||a instanceof Je,()=>"The dy passed in valueAndGrad(f)(x, dy) must be a tensor");const{grads:r,value:i}=C.gradients(()=>t(e),[e],a);return hu(r),{grad:r[0],value:i}}}function ZA(t){return E(La(t),()=>"The f passed in valueAndGrads(f) must be a function"),(e,a)=>{E(Array.isArray(e)&&e.every(i=>i instanceof Je),()=>"The args passed in valueAndGrads(f)(args) must be array of tensors"),E(a==null||a instanceof Je,()=>"The dy passed in valueAndGrads(f)(args, dy) must be a tensor");const r=C.gradients(()=>t(...e),e,a);return a!=null&&Dt(r.value.shape,a.shape,"The shape of dy passed in valueAndGrads(f)([x1,...], dy) must match the shape returned by f([x1,...])"),hu(r.grads),r}}function Ow(t,e){E(La(t),()=>"The f passed in variableGrads(f) must be a function"),E(e==null||Array.isArray(e)&&e.every(p=>p instanceof Gi),()=>"The varList passed in variableGrads(f, varList) must be an array of variables");const a=e!=null;if(!a){e=[];for(const p in C.registeredVariables)e.push(C.registeredVariables[p])}const r=a?e.filter(p=>!p.trainable):null,i=e.length;e=e.filter(p=>p.trainable),E(e.length>0,()=>`variableGrads() expects at least one of the input variables to be trainable, but none of the ${i} variables is trainable.`);const l=!0,{value:c,grads:f}=C.gradients(t,e,null,l);E(f.some(p=>p!=null),()=>"Cannot find a connection between any variable and the result of the loss function y=f(x). Please make sure the operations that use variables are inside the function f passed to minimize()."),E(c.rank===0,()=>`The f passed in variableGrads(f) must return a scalar, but it returned a rank-${c.rank} tensor`);const h={};return e.forEach((p,g)=>{f[g]!=null&&(h[p.name]=f[g])}),r!=null&&r.forEach(p=>h[p.name]=null),{value:c,grads:h}}function zn(t){return C.customGrad(t)}function hu(t){if(t.filter(a=>a==null).length>0)throw new Error(`Cannot compute gradient of y=f(x) with respect to x. Make sure that
 ...
 * limitations under the License.
 * =============================================================================
 */function WA(t){const a={x:x(t,"x","neg")};return C.runKernel(H1,a)}const Sn=R({neg_:WA});/**
 * @license
 * Copyright 2018 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
 ...
 * limitations under the License.
 * =============================================================================
 */function QA(t){const a={x:x(t,"x","softplus")};return C.runKernel(k2,a)}const Nd=R({softplus_:QA});/**
 * @license
 * Copyright 2018 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
 ...
 * limitations under the License.
 * =============================================================================
 */function JA(t){const e=x(t,"x","logSigmoid");return zn(r=>({value:Sn(Nd(Sn(r))),gradFunc:c=>le(c,vs(Sn(r)))}))(e)}const $w=R({logSigmoid_:JA});/**
 * @license
 * Copyright 2020 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
 ...
 * limitations under the License.
 * =============================================================================
 */function e4(t,e){let a=x(t,"a","sub"),r=x(e,"b","sub");[a,r]=et(a,r);const i={a,b:r};return C.runKernel(V2,i)}const Te=R({sub_:e4});/**
 * @license
 * Copyright 2020 Google Inc. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
 ...
 * limitations under the License.
 * =============================================================================
 */function n4(t,e=null,a=!1){const r=x(t,"x","logSumExp"),i=to(e,r.shape),l=ws(r,i,!0),c=Te(r,l),f=qa(c),h=Ye(f,i),p=kr(h),g=be(ee(l,p.shape),p);if(a){const y=uo(g.shape,i);return ee(g,y)}return g}const xd=R({logSumExp_:n4});/**
 * @license
 * Copyright 2020 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
 ...
 * limitations under the License.
 * =============================================================================
 */function a4(t,e){const a=x(t,"a","logicalAnd","bool"),r=x(e,"b","logicalAnd","bool");it(a.shape,r.shape);const i={a,b:r};return C.runKernel(A1,i)}const Zi=R({logicalAnd_:a4});/**
 * @license
 * Copyright 2020 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
 ...
 * limitations under the License.
 * =============================================================================
 */function s4(t){const a={x:x(t,"x","logicalNot","bool")};return C.runKernel(O1,a)}const Td=R({logicalNot_:s4});/**
 * @license
 * Copyright 2020 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
 ...
 * limitations under the License.
 * =============================================================================
 */function r4(t,e){const a=x(t,"a","logicalOr","bool"),r=x(e,"b","logicalOr","bool");it(a.shape,r.shape);const i={a,b:r};return C.runKernel($1,i)}const Ed=R({logicalOr_:r4});/**
 * @license
 * Copyright 2020 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
 ...
 * limitations under the License.
 * =============================================================================
 */function i4(t,e){const a=x(t,"a","logicalXor","bool"),r=x(e,"b","logicalXor","bool");return it(a.shape,r.shape),Zi(Ed(t,e),Td(Zi(t,e)))}const Rw=R({logicalXor_:i4});/**
 * @license
 * Copyright 2022 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
 ...
 * limitations under the License.
 * =============================================================================
 */const Dl=2147483648;function o4(t,e,a="left"){const r=x(t,"sortedSequence","searchSorted"),i=x(e,"values","searchSorted"),l=r.shape[r.shape.length-1],c=i.shape[i.shape.length-1],f=ee(r,[-1,l]),h=ee(i,[-1,c]);if(f.rank<2)throw new Error("Sorted input argument must be at least 2-dimensional");if(f.shape[0]!==h.shape[0])throw new Error("Leading dimension of 'sortedSequence' and 'values' must match.");if(Ue(h.shape)>=Dl)throw new Error(`values tensor size must less than ${Dl}`);if(f.shape[1]>=Dl)throw new Error(`trailing dim_size must less than ${Dl} for int32 output type, was ${f.shape[1]}`);const p={sortedSequence:f,values:h},g={side:a};return C.runKernel(b2,p,g)}const du=R({searchSorted_:o4});/**
 * @license
 * Copyright 2022 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
 ...
 * limitations under the License.
 * =============================================================================
 */function l4(t,e,a,r,i){const l=x(t,"x","maxPool"),c=1;let f=l,h=!1;l.rank===3&&(h=!0,f=ee(l,[1,l.shape[0],l.shape[1],l.shape[2]])),E(f.rank===4,()=>`Error in maxPool: input must be rank 4 but got rank ${f.rank}.`),E(sa(a,c),()=>`Error in maxPool: Either strides or dilations must be 1. Got strides ${a} and dilations '${c}'`),pn("maxPool",r,i);const p={x:f},g={filterSize:e,strides:a,pad:r,dimRoundingMode:i},y=C.runKernel(z1,p,g);return h?ee(y,[y.shape[1],y.shape[2],y.shape[3]]):y}const kd=R({maxPool_:l4});/**
 * @license
 * Copyright 2020 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
 ...
 * limitations under the License.
 * =============================================================================
 */function c4(t,e,a,r,i=!1){const c={x:x(t,"x","maxPoolWithArgmax")},f={filterSize:e,strides:a,pad:r,includeBatchInIndex:i},h=C.runKernel(M1,c,f);return{result:h[0],indexes:h[1]}}const jw=R({maxPoolWithArgmax_:c4});/**
 * @license
 * Copyright 2020 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
 ...
 * limitations under the License.
 * =============================================================================
 */function f4(t,e){let a=x(t,"a","maximum"),r=x(e,"b","maximum");[a,r]=et(a,r),a.dtype==="bool"&&(a=He(a,"int32"),r=He(r,"int32")),it(a.shape,r.shape);const i={a,b:r};return C.runKernel(C1,i)}const _d=R({maximum_:f4});/**
 * @license
 * Copyright 2020 Google Inc. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
 ...
 * limitations under the License.
 * =============================================================================
 */function h4(t,e=null,a=!1){const i={x:x(t,"x","mean")},l={axis:e,keepDims:a};return C.runKernel(L1,i,l)}const Wi=R({mean_:h4});/**
 * @license
 * Copyright 2018 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
 ...
 * limitations under the License.
 * =============================================================================
 */function d4(t,e){let a=x(t,"a","minimum"),r=x(e,"b","minimum");[a,r]=et(a,r),a.dtype==="bool"&&(a=He(a,"int32"),r=He(r,"int32")),it(a.shape,r.shape);const i={a,b:r};return C.runKernel(B1,i)}const Qi=R({minimum_:d4});/**
 * @license
 * Copyright 2020 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
 ...
 * limitations under the License.
 * =============================================================================
 */function p4(t,e,a){E(a==="reflect"||a==="symmetric",()=>`Invalid mode. Mode must be either reflect or symmetric. Got ${a}.`);const r=x(t,"x","mirrorPad");if(r.rank===0)throw new Error("mirrorPad(scalar) is not defined. Pass non-scalar to mirrorPad");E(e.length===r.rank,()=>`Padding doesn't match input. Must be ${r.rank}. Got ${e.length}.`);const i=a==="reflect"?1:0;for(let f=0;f<r.rank;f++)E(e[f].length===2,()=>"Invalid number of paddings. Must be length of 2 each."),E(e[f][0]>=0&&e[f][0]<=r.shape[f]-i&&e[f][1]>=0&&e[f][1]<=r.shape[f]-i,()=>`Padding in dimension ${f} cannot be greater than or equal to ${r.shape[f]-i} or less than 0 for input of shape ${r.shape}`);const l={paddings:e,mode:a},c={x:r};return C.runKernel(U1,c,l)}const Lw=R({mirrorPad_:p4});/**
 * @license
 * Copyright 2020 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
 ...
 * limitations under the License.
 * =============================================================================
 */function m4(t,e){let a=x(t,"a","mod"),r=x(e,"b","mod");[a,r]=et(a,r);const i={a,b:r};return C.runKernel(q1,i)}const Iw=R({mod_:m4});/**
 * @license
 * Copyright 2020 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
 ...
 * limitations under the License.
 * =============================================================================
 */function b4(t,e,a,r=!1){const i=x(t,"logits","multinomial"),l=i.size,c=i.rank;if(l<2)throw new Error(`Error in multinomial: you need at least 2 outcomes, but got ${l}.`);if(c>2)throw new Error(`Rank of probabilities must be 1 or 2, but is ${c}`);a=a||Math.random();const h={logits:c===1?ee(i,[1,-1]):i},p={numSamples:e,seed:a,normalized:r},g=C.runKernel(F1,h,p);return c===1?ee(g,[g.size]):g}const qw=R({multinomial_:b4});/**
 * @license
 * Copyright 2020 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
 ...
 * limitations under the License.
 * =============================================================================
 */function v4(t,e){let a=x(t,"a","notEqual","string_or_numeric"),r=x(e,"b","notEqual","string_or_numeric");[a,r]=et(a,r),it(a.shape,r.shape);const i={a,b:r};return C.runKernel(G1,i)}const Ad=R({notEqual_:v4});/**
 * @license
 * Copyright 2020 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
 ...
 * limitations under the License.
 * =============================================================================
 */function w4(t,e,a=1,r=0,i="int32"){if(e<2)throw new Error(`Error in oneHot: depth must be >=2, but it is ${e}`);const c={indices:x(t,"indices","oneHot","int32")},f={dtype:i,depth:e,onValue:a,offValue:r};return C.runKernel(Z1,c,f)}const eu=R({oneHot_:w4});/**
 * @license
 * Copyright 2018 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
 ...
 * limitations under the License.
 * =============================================================================
 */function S4(t){const a={x:x(t,"x","onesLike")};return C.runKernel(X1,a)}const Fw=R({onesLike_:S4});function N4(t,e){const a=x(t,"v1","outerProduct"),r=x(e,"v2","outerProduct");E(a.rank===1&&r.rank===1,()=>`Error in outerProduct: inputs must be rank 1, but got ranks ${a.rank} and ${r.rank}.`);const i=ee(a,[-1,1]),l=ee(r,[1,-1]);return Me(i,l)}const Vw=R({outerProduct_:N4});/**
 * @license
 * Copyright 2020 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
 ...
 * limitations under the License.
 * =============================================================================
 */function x4(t,e,a=0){const r=x(t,"x","pad");if(r.rank===0)throw new Error("pad(scalar) is not defined. Pass non-scalar to pad");const i={paddings:e,constantValue:a},l={x:r};return C.runKernel(Q1,l,i)}const Rr=R({pad_:x4});function T4(t,e,a=0){return E(e.length===2,()=>"Invalid number of paddings. Must be length of 2."),Rr(t,[e],a)}const Hw=R({pad1d_:T4});function E4(t,e,a=0){return E(e.length===2&&e[0].length===2&&e[1].length===2,()=>"Invalid number of paddings. Must be length of 2 each."),Rr(t,e,a)}const Gw=R({pad2d_:E4});function k4(t,e,a=0){return E(e.length===3&&e[0].length===2&&e[1].length===2&&e[2].length===2,()=>"Invalid number of paddings. Must be length of 2 each."),Rr(t,e,a)}const Kw=R({pad3d_:k4});function _4(t,e,a=0){return E(e.length===4&&e[0].length===2&&e[1].length===2&&e[2].length===2&&e[3].length===2,()=>"Invalid number of paddings. Must be length of 2 each."),Rr(t,e,a)}const Yw=R({pad4d_:_4});/**
 * @license
 * Copyright 2020 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
 ...
 * limitations under the License.
 * =============================================================================
 */function A4(t,e,a){const r=x(t,"x","spaceToBatchND");E(r.rank>=1+e.length,()=>`input rank ${r.rank} should be > than [blockShape] ${e.length}`),E(a.length===e.length,()=>`paddings.shape[0] ${a.length} must be equal to [blockShape] ${e.length}`),E(r.shape.reduce((c,f,h)=>h>0&&h<=e.length?c&&(f+a[h-1][0]+a[h-1][1])%e[h-1]===0:c,!0),()=>`input spatial dimensions ${r.shape.slice(1)} with paddings ${a.toString()} must be divisible by blockShapes ${e.toString()}`);const i={x:r},l={blockShape:e,paddings:a};return C.runKernel(O2,i,l)}const Od=R({spaceToBatchND_:A4});/**
 * @license
 * Copyright 2018 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
 ...
 * limitations under the License.
 * =============================================================================
 */function O4(t,e,a,r,i,l,c){i==null&&(i=[1,1]),l==null&&(l=1),r===0&&(r="valid");const f=x(t,"x","maxPool");let h=f,p=!1;f.rank===3&&(p=!0,h=ee(f,[1,f.shape[0],f.shape[1],f.shape[2]])),E(sa(l,i),()=>`Error in pool: Either strides or dilations must be 1. Got strides ${l} and dilations '${i}'`);const g=Uv(h.shape,e,l,i,r),y=[g.dilationHeight,g.dilationWidth];let v;r==="same"?v=D4([g.filterHeight,g.filterWidth],y):v=[[0,0],[0,0]];const S=y[0]===1&&y[1]===1,[k,$]=$4([g.inHeight,g.inWidth],y,v),A=S?r:"valid",M=S?h:Od(h,y,k),z=(a==="avg"?()=>ud(M,e,l,A,c):()=>kd(M,e,l,A,c))(),I=S?z:cd(z,y,$);return p?ee(I,[I.shape[1],I.shape[2],I.shape[3]]):I}function $4(t,e,a){const r=a.map(g=>g[0]),i=a.map(g=>g[1]),l=t.concat(r,i),c=e.map((g,y)=>(g-l[y]%g)%g),f=i.map((g,y)=>g+c[y]),h=e.map((g,y)=>[r[y],f[y]]),p=e.map((g,y)=>[0,c[y]]);return[h,p]}function D4(t,e){const r=t.map((c,f)=>c+(c-1)*(e[f]-1)).map(c=>c-1),i=r.map(c=>Math.floor(c/2)),l=r.map((c,f)=>c-i[f]);return r.map((c,f)=>[i[f],l[f]])}const Pw=R({pool_:O4});/**
 * @license
 * Copyright 2020 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
 ...
 * limitations under the License.
 * =============================================================================
 */function R4(t,e){const a=x(t,"x","prelu"),r=x(e,"alpha","prelu"),i={x:a,alpha:r};return C.runKernel(e2,i)}const $d=R({prelu_:R4});/**
 * @license
 * Copyright 2020 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
 ...
 * limitations under the License.
 * =============================================================================
 */function C4(t,e=null,a=!1){let r=x(t,"x","prod");r.dtype==="bool"&&(r=He(r,"int32"));const i={x:r},l={axis:e,keepDims:a};return C.runKernel(t2,i,l)}const Xw=R({prod_:C4});/**
 * @license
 * Copyright 2022 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
 ...
 * limitations under the License.
 * =============================================================================
 */function z4(t,e,a,r){const i=t.map((g,y)=>x(g,`tensors${y}`,"raggedGather","int32")),l=x(e,"paramsDenseValues","raggedGather"),c=x(a,"indices","raggedGather","int32"),f={paramsNestedSplits:i,paramsDenseValues:l,indices:c},h={outputRaggedRank:r},p=C.runKernel(n2,f,h);return{outputNestedSplits:p.slice(0,p.length-1),outputDenseValues:p[p.length-1]}}const Zw=R({raggedGather_:z4});/**
 * @license
 ...
 * limitations under the License.
 * =============================================================================
 */function j4(t,e,a){const r=x(t,"starts","raggedRange"),i=x(e,"limits","raggedRange",r.dtype),l=x(a,"deltas","raggedRange",r.dtype),c={starts:r,limits:i,deltas:l},f=C.runKernel(a2,c);return{rtNestedSplits:f[0],rtDenseValues:f[1]}}const Ww=R({raggedRange_:j4});/**
 * @license
 * Copyright 2022 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
 ...
 * limitations under the License.
 * =============================================================================
 */function M4(t,e,a,r,i){const l=x(t,"shape","raggedTensorToTensor","int32"),c=x(e,"values","raggedTensorToTensor"),f=x(a,"defaultValue","raggedTensorToTensor",c.dtype),h=r.map((y,v)=>x(y,`tensors${v}`,"raggedTensorToTensor","int32")),p={shape:l,values:c,defaultValue:f,rowPartitionTensors:h},g={rowPartitionTypes:i};return C.runKernel(s2,p,g)}const Qw=R({raggedTensorToTensor_:M4});/**
 * @license
 * Copyright 2020 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
 ...
 * limitations under the License.
 * =============================================================================
 */function L4(t,e,a){Gt(t);const r=Ue(t);let i=null;if(a==null||a==="float32")i=new Float32Array(r);else if(a==="int32")i=new Int32Array(r);else if(a==="bool")i=new Uint8Array(r);else throw new Error(`Unknown data type ${a}`);for(let l=0;l<r;l++)i[l]=e();return C.makeTensor(i,t,a)}const Jw=R({rand_:L4});var Ml={exports:{}},I4=Ml.exports,v0;function B4(){return v0||(v0=1,function(t){(function(e,a,r){function i(h){var p=this,g=f();p.next=function(){var y=2091639*p.s0+p.c*23283064365386963e-26;return p.s0=p.s1,p.s1=p.s2,p.s2=y-(p.c=y|0)},p.c=1,p.s0=g(" "),p.s1=g(" "),p.s2=g(" "),p.s0-=g(h),p.s0<0&&(p.s0+=1),p.s1-=g(h),p.s1<0&&(p.s1+=1),p.s2-=g(h),p.s2<0&&(p.s2+=1),g=null}function l(h,p){return p.c=h.c,p.s0=h.s0,p.s1=h.s1,p.s2=h.s2,p}function c(h,p){var g=new i(h),y=p&&p.state,v=g.next;return v.int32=function(){return g.next()*4294967296|0},v.double=function(){return v()+(v()*2097152|0)*11102230246251565e-32},v.quick=v,y&&(typeof y=="object"&&l(y,g),v.state=function(){return l(g,{})}),v}function f(){var h=4022871197,p=function(g){g=String(g);for(var y=0;y<g.length;y++){h+=g.charCodeAt(y);var v=.02519603282416938*h;h=v>>>0,v-=h,v*=h,h=v>>>0,v-=h,h+=v*4294967296}return(h>>>0)*23283064365386963e-26};return p}a&&a.exports?a.exports=c:this.alea=c})(I4,t)}(Ml)),Ml.exports}var Ll={exports:{}},U4=Ll.exports,w0;function q4(){return w0||(w0=1,function(t){(function(e,a,r){function i(f){var h=this,p="";h.x=0,h.y=0,h.z=0,h.w=0,h.next=function(){var y=h.x^h.x<<11;return h.x=h.y,h.y=h.z,h.z=h.w,h.w^=h.w>>>19^y^y>>>8},f===(f|0)?h.x=f:p+=f;for(var g=0;g<p.length+64;g++)h.x^=p.charCodeAt(g)|0,h.next()}function l(f,h){return h.x=f.x,h.y=f.y,h.z=f.z,h.w=f.w,h}function c(f,h){var p=new i(f),g=h&&h.state,y=function(){return(p.next()>>>0)/4294967296};return y.double=function(){do var v=p.next()>>>11,S=(p.next()>>>0)/4294967296,k=(v+S)/(1<<21);while(k===0);return k},y.int32=p.next,y.quick=y,g&&(typeof g=="object"&&l(g,p),y.state=function(){return l(p,{})}),y}a&&a.exports?a.exports=c:this.xor128=c})(U4,t)}(Ll)),Ll.exports}var Il={exports:{}},F4=Il.exports,S0;function V4(){return S0||(S0=1,function(t){(function(e,a,r){function i(f){var h=this,p="";h.next=function(){var y=h.x^h.x>>>2;return h.x=h.y,h.y=h.z,h.z=h.w,h.w=h.v,(h.d=h.d+362437|0)+(h.v=h.v^h.v<<4^(y^y<<1))|0},h.x=0,h.y=0,h.z=0,h.w=0,h.v=0,f===(f|0)?h.x=f:p+=f;for(var g=0;g<p.length+64;g++)h.x^=p.charCodeAt(g)|0,g==p.length&&(h.d=h.x<<10^h.x>>>4),h.next()}function l(f,h){return h.x=f.x,h.y=f.y,h.z=f.z,h.w=f.w,h.v=f.v,h.d=f.d,h}function c(f,h){var p=new i(f),g=h&&h.state,y=function(){return(p.next()>>>0)/4294967296};return y.double=function(){do var v=p.next()>>>11,S=(p.next()>>>0)/4294967296,k=(v+S)/(1<<21);while(k===0);return k},y.int32=p.next,y.quick=y,g&&(typeof g=="object"&&l(g,p),y.state=function(){return l(p,{})}),y}a&&a.exports?a.exports=c:this.xorwow=c})(F4,t)}(Il)),Il.exports}var Bl={exports:{}},H4=Bl.exports,N0;function G4(){return N0||(N0=1,function(t){(function(e,a,r){function i(f){var h=this;h.next=function(){var g=h.x,y=h.i,v,S;return v=g[y],v^=v>>>7,S=v^v<<24,v=g[y+1&7],S^=v^v>>>10,v=g[y+3&7],S^=v^v>>>3,v=g[y+4&7],S^=v^v<<7,v=g[y+7&7],v=v^v<<13,S^=v^v<<9,g[y]=S,h.i=y+1&7,S};function p(g,y){var v,S=[];if(y===(y|0))S[0]=y;else for(y=""+y,v=0;v<y.length;++v)S[v&7]=S[v&7]<<15^y.charCodeAt(v)+S[v+1&7]<<13;for(;S.length<8;)S.push(0);for(v=0;v<8&&S[v]===0;++v);for(v==8?S[7]=-1:S[v],g.x=S,g.i=0,v=256;v>0;--v)g.next()}p(h,f)}function l(f,h){return h.x=f.x.slice(),h.i=f.i,h}function c(f,h){f==null&&(f=+new Date);var p=new i(f),g=h&&h.state,y=function(){return(p.next()>>>0)/4294967296};return y.double=function(){do var v=p.next()>>>11,S=(p.next()>>>0)/4294967296,k=(v+S)/(1<<21);while(k===0);return k},y.int32=p.next,y.quick=y,g&&(g.x&&l(g,p),y.state=function(){return l(p,{})}),y}a&&a.exports?a.exports=c:this.xorshift7=c})(H4,t)}(Bl)),Bl.exports}var Ul={exports:{}},K4=Ul.exports,x0;function Y4(){return x0||(x0=1,function(t){(function(e,a,r){function i(f){var h=this;h.next=function(){var g=h.w,y=h.X,v=h.i,S,k;return h.w=g=g+1640531527|0,k=y[v+34&127],S=y[v=v+1&127],k^=k<<13,S^=S<<17,k^=k>>>15,S^=S>>>12,k=y[v]=k^S,h.i=v,k+(g^g>>>16)|0};function p(g,y){var v,S,k,$,A,M=[],X=128;for(y===(y|0)?(S=y,y=null):(y=y+"\0",S=0,X=Math.max(X,y.length)),k=0,$=-32;$<X;++$)y&&(S^=y.charCodeAt(($+32)%y.length)),$===0&&(A=S),S^=S<<10,S^=S>>>15,S^=S<<4,S^=S>>>13,$>=0&&(A=A+1640531527|0,v=M[$&127]^=S+A,k=v==0?k+1:0);for(k>=128&&(M[(y&&y.length||0)&127]=-1),k=127,$=4*128;$>0;--$)S=M[k+34&127],v=M[k=k+1&127],S^=S<<13,v^=v<<17,S^=S>>>15,v^=v>>>12,M[k]=S^v;g.w=A,g.X=M,g.i=k}p(h,f)}function l(f,h){return h.i=f.i,h.w=f.w,h.X=f.X.slice(),h}function c(f,h){f==null&&(f=+new Date);var p=new i(f),g=h&&h.state,y=function(){return(p.next()>>>0)/4294967296};return y.double=function(){do var v=p.next()>>>11,S=(p.next()>>>0)/4294967296,k=(v+S)/(1<<21);while(k===0);return k},y.int32=p.next,y.quick=y,g&&(g.X&&l(g,p),y.state=function(){return l(p,{})}),y}a&&a.exports?a.exports=c:this.xor4096=c})(K4,t)}(Ul)),Ul.exports}var ql={exports:{}},P4=ql.exports,T0;function X4(){return T0||(T0=1,function(t){(function(e,a,r){function i(f){var h=this,p="";h.next=function(){var y=h.b,v=h.c,S=h.d,k=h.a;return y=y<<25^y>>>7^v,v=v-S|0,S=S<<24^S>>>8^k,k=k-y|0,h.b=y=y<<20^y>>>12^v,h.c=v=v-S|0,h.d=S<<16^v>>>16^k,h.a=k-y|0},h.a=0,h.b=0,h.c=-1640531527,h.d=1367130551,f===Math.floor(f)?(h.a=f/4294967296|0,h.b=f|0):p+=f;for(var g=0;g<p.length+20;g++)h.b^=p.charCodeAt(g)|0,h.next()}function l(f,h){return h.a=f.a,h.b=f.b,h.c=f.c,h.d=f.d,h}function c(f,h){var p=new i(f),g=h&&h.state,y=function(){return(p.next()>>>0)/4294967296};return y.double=function(){do var v=p.next()>>>11,S=(p.next()>>>0)/4294967296,k=(v+S)/(1<<21);while(k===0);return k},y.int32=p.next,y.quick=y,g&&(typeof g=="object"&&l(g,p),y.state=function(){return l(p,{})}),y}a&&a.exports?a.exports=c:this.tychei=c})(P4,t)}(ql)),ql.exports}var Fl={exports:{}};const Z4={},W4=Object.freeze(Object.defineProperty({__proto__:null,default:Z4},Symbol.toStringTag,{value:"Module"})),Q4=uE(W4);var J4=Fl.exports,E0;function eO(){return E0||(E0=1,function(t){(function(e,a,r){var i=256,l=6,c=52,f="random",h=r.pow(i,l),p=r.pow(2,c),g=p*2,y=i-1,v;function S(I,V,Z){var re=[];V=V==!0?{entropy:!0}:V||{};var ie=M(A(V.entropy?[I,z(a)]:I??X(),3),re),F=new k(re),U=function(){for(var _=F.g(l),te=h,ue=0;_<p;)_=(_+ue)*i,te*=i,ue=F.g(1);for(;_>=g;)_/=2,te/=2,ue>>>=1;return(_+ue)/te};return U.int32=function(){return F.g(4)|0},U.quick=function(){return F.g(4)/4294967296},U.double=U,M(z(F.S),a),(V.pass||Z||function(_,te,ue,pe){return pe&&(pe.S&&$(pe,F),_.state=function(){return $(F,{})}),ue?(r[f]=_,te):_})(U,ie,"global"in V?V.global:this==r,V.state)}function k(I){var V,Z=I.length,re=this,ie=0,F=re.i=re.j=0,U=re.S=[];for(Z||(I=[Z++]);ie<i;)U[ie]=ie++;for(ie=0;ie<i;ie++)U[ie]=U[F=y&F+I[ie%Z]+(V=U[ie])],U[F]=V;(re.g=function(_){for(var te,ue=0,pe=re.i,fe=re.j,G=re.S;_--;)te=G[pe=y&pe+1],ue=ue*i+G[y&(G[pe]=G[fe=y&fe+te])+(G[fe]=te)];return re.i=pe,re.j=fe,ue})(i)}function $(I,V){return V.i=I.i,V.j=I.j,V.S=I.S.slice(),V}function A(I,V){var Z=[],re=typeof I,ie;if(V&&re=="object")for(ie in I)try{Z.push(A(I[ie],V-1))}catch{}return Z.length?Z:re=="string"?I:I+"\0"}function M(I,V){for(var Z=I+"",re,ie=0;ie<Z.length;)V[y&ie]=y&(re^=V[y&ie]*19)+Z.charCodeAt(ie++);return z(V)}function X(){try{var I;return v&&(I=v.randomBytes)?I=I(i):(I=new Uint8Array(i),(e.crypto||e.msCrypto).getRandomValues(I)),z(I)}catch{var V=e.navigator,Z=V&&V.plugins;return[+new Date,e,Z,e.screen,z(a)]}}function z(I){return String.fromCharCode.apply(0,I)}if(M(r.random(),a),t.exports){t.exports=S;try{v=Q4}catch{}}else r["seed"+f]=S})(typeof self<"u"?self:J4,[],Math)}(Fl)),Fl.exports}var Qf,k0;function tO(){if(k0)return Qf;k0=1;var t=B4(),e=q4(),a=V4(),r=G4(),i=Y4(),l=X4(),c=eO();return c.alea=t,c.xor128=e,c.xorwow=a,c.xorshift7=r,c.xor4096=i,c.tychei=l,Qf=c,Qf}var Dd=tO();/**
 * @license
 * Copyright 2017 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
 ...
 * limitations under the License.
 * =============================================================================
 */const nO=.001,eS=.1;function aO(t,e,a){return a==null&&(a=Rd()),Nh(t,e,(r,i)=>Cd(r,i,a))}function Rd(){return C.backend.floatPrecision()===32?nO:eS}function Nh(t,e,a){let r=!0;if((ht(t)||ht(e))&&(r=!1),ht(t)&&ht(e)&&(r=!0),r){const c=t.constructor.name,f=e.constructor.name;if(c!==f)throw new Error(`Arrays are of different type. Actual: ${c}. Expected: ${f}`)}if(Array.isArray(t)&&Array.isArray(e)){const c=Dn(t),f=Dn(e);if(!Nn(c,f))throw new Error(`Arrays have different shapes. Actual: [${c}]. Expected: [${f}]`)}const i=ht(t)?t:Ba(t),l=ht(e)?e:Ba(e);if(i.length!==l.length)throw new Error(`Arrays have different lengths actual: ${i.length} vs expected: ${l.length}.
Actual:   ${i}.
Expected: ${l}.`);for(let c=0;c<l.length;++c){const f=i[c],h=l[c];if(!a(f,h))throw new Error(`Arrays differ: actual[${c}] = ${f}, expected[${c}] = ${h}.
Actual:   ${i}.
Expected: ${l}.`)}typeof expect<"u"&&expect().nothing()}function sO(t,e){t().then(()=>e.fail(),()=>e()),typeof expect<"u"&&expect().nothing()}function rO(t,e){const a=typeof e=="string"||typeof e=="number"||typeof e=="boolean"?[e]:e;return Ca(t)||Ca(t[0])||Ca(e)||Ca(e[0])?Nh(t,a,(r,i)=>r==i):Nh(t,e,(r,i)=>Cd(r,i,0))}function iO(t,e,a){if(a==null&&(a=Rd()),!Cd(t,e,a))throw new Error(`Numbers differ: actual === ${t}, expected === ${e}`);typeof expect<"u"&&expect().nothing()}function Cd(t,e,a){return!isFinite(t)&&!isFinite(e)?!0:!(isNaN(t)||isNaN(e)||Math.abs(t-e)>a)}function oO(t,e,a){for(let r=0;r<t.length;r++)if(t[r]<e||t[r]>a)throw new Error(`Value out of range:${t[r]} low: ${e}, high: ${a}`)}function lO(t,e){const a=new Float32Array(t),r=new Float32Array(e);if(a.length!==r.length)throw new Error(`Expected ArrayBuffer to be of length ${r.length}, but it was ${a.length}`);for(let i=0;i<r.length;i++)if(a[i]!==r[i])throw new Error(`Expected ArrayBuffer value at ${i} to be ${r[i]} but got ${a[i]} instead`)}function tS(t){for(let e=0;e<t.length;e++){const a=t[e];Array.isArray(a)?tS(a):t[e]=so(a)}return t}function uO(t){const e=document.createElement("video");return"playsInline"in e&&(e.playsInline=!0),e.muted=!0,e.loop=!0,e.style.position="fixed",e.style.left="0px",e.style.top="0px",e.preload="auto",e.appendChild(t),new Promise(a=>{e.addEventListener("loadeddata",r=>a(e)),e.load()})}async function cO(t){await t.play(),"requestVideoFrameCallback"in t&&await new Promise(e=>{t.requestVideoFrameCallback(e)})}const fO=Object.freeze(Object.defineProperty({__proto__:null,TEST_EPSILON_FLOAT16:eS,createVideoElement:uO,encodeStrings:tS,expectArrayBuffersEqual:lO,expectArraysClose:aO,expectArraysEqual:rO,expectNumbersClose:iO,expectPromiseToFail:sO,expectValuesInRange:oO,play:cO,testEpsilon:Rd},Symbol.toStringTag,{value:"Module"}));/**
 * @license
 * Copyright 2018 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
 ...
 * limitations under the License.
 * =============================================================================
 */function pO(t,e,a=1,r="float32",i){if(Gt(t),a==null&&(a=1),r==null&&(r="float32"),r!=="float32"&&r!=="int32")throw new Error(`Unsupported data type ${r}`);const l=new hO(e,a,r,i),c=Rn(t,r);for(let f=0;f<c.values.length;f++)c.values[f]=l.nextValue();return c.toTensor()}const nS=R({randomGamma_:pO});/**
 * @license
 * Copyright 2020 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
 ...
 * limitations under the License.
 * =============================================================================
 */function mO(t,e=0,a=1,r,i){if(Gt(t),r!=null&&r==="bool")throw new Error(`Unsupported data type ${r}`);const l=new zd(e,a,r,!1,i),c=Rn(t,r);for(let f=0;f<c.values.length;f++)c.values[f]=l.nextValue();return c.toTensor()}const jd=R({randomNormal_:mO});/**
 * @license
 * Copyright 2022 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
 ...
 * limitations under the License.
 * =============================================================================
 */function gO(t,e,a){if(e!=null&&e==="bool")throw new Error(`Unsupported data type ${e}`);return jd(t,0,1,e,a)}const aS=R({randomStandardNormal_:gO});/**
 * @license
 * Copyright 2020 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
 ...
 * limitations under the License.
 * =============================================================================
 */function yO(t,e=0,a=1,r="float32",i){Gt(t);const l=Rn(t,r),c=new dO(e,a,null,i);for(let f=0;f<l.values.length;f++)l.values[f]=c.nextValue();return l.toTensor()}const pu=R({randomUniform_:yO});/**
 * @license
 * Copyright 2023 Google LLC.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
 ...
 * limitations under the License.
 * =============================================================================
 */function bO(t,e,a,r){return pu(t,e,a,"int32",r)}const sS=R({randomUniformInt_:bO});/**
 * @license
 * Copyright 2018 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
 ...
 * limitations under the License.
 * =============================================================================
 */function vO(t){const a={input:x(t,"input","real")};return C.runKernel(i2,a)}const Ar=R({real_:vO});/**
 * @license
 * Copyright 2018 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
 ...
 * limitations under the License.
 * =============================================================================
 */function wO(t){const a={x:x(t,"x","reciprocal")};return C.runKernel(o2,a)}const rS=R({reciprocal_:wO});/**
 * @license
 * Copyright 2020 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
 ...
 * limitations under the License.
 * =============================================================================
 */function SO(t){const a={x:x(t,"x","relu")};return C.runKernel(l2,a)}const po=R({relu_:SO});/**
 * @license
 * Copyright 2020 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
 ...
 * limitations under the License.
 * =============================================================================
 */function NO(t){const a={x:x(t,"x","relu6")};return C.runKernel(h2,a)}const Md=R({relu6_:NO});/**
 * @license
 * Copyright 2018 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
 ...
 * limitations under the License.
 * =============================================================================
 */function xO(t,e){const r={x:x(t,"x","reverse")},i={dims:e};return C.runKernel(d2,r,i)}const Va=R({reverse_:xO});/**
 * @license
 * Copyright 2020 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
 ...
 * limitations under the License.
 * =============================================================================
 */function TO(t){const e=x(t,"x","reverse");return E(e.rank===1,()=>`Error in reverse1D: x must be rank 1 but got rank ${e.rank}.`),Va(e,0)}const iS=R({reverse1d_:TO});/**
 * @license
 * Copyright 2020 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
 ...
 * limitations under the License.
 * =============================================================================
 */function EO(t,e){const a=x(t,"x","reverse");return E(a.rank===2,()=>`Error in reverse2D: x must be rank 2 but got rank ${a.rank}.`),Va(a,e)}const oS=R({reverse2d_:EO});/**
 * @license
 * Copyright 2020 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
 ...
 * limitations under the License.
 * =============================================================================
 */function kO(t,e){const a=x(t,"x","reverse");return E(a.rank===3,()=>`Error in reverse3D: x must be rank 3 but got rank ${a.rank}.`),Va(a,e)}const lS=R({reverse3d_:kO});/**
 * @license
 * Copyright 2020 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
 ...
 * limitations under the License.
 * =============================================================================
 */function _O(t,e){const a=x(t,"x","reverse");return E(a.rank===4,()=>`Error in reverse4D: x must be rank 4 but got rank ${a.rank}.`),Va(a,e)}const uS=R({reverse4d_:_O});/**
 * @license
 * Copyright 2018 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
 ...
 * limitations under the License.
 * =============================================================================
 */function AO(t){const a={x:x(t,"x","round")};return C.runKernel(p2,a)}const Ld=R({round_:AO});/**
 * @license
 * Copyright 2018 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
 ...
 * limitations under the License.
 * =============================================================================
 */function OO(t){const a={x:x(t,"x","rsqrt","float32")};return C.runKernel(m2,a)}const cS=R({rsqrt_:OO});/**
 * @license
 * Copyright 2020 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
 ...
 * limitations under the License.
 * =============================================================================
 */async function RO(t,e){const a=x(t,"x","setdiff1d"),r=x(e,"y","setdiff1d");E(a.dtype===r.dtype,()=>`x and y should have the same dtype, but got x (${a.dtype}) and y (${r.dtype}).`),E(a.rank===1,()=>`x should be 1D tensor, but got x (${a.shape}).`),E(r.rank===1,()=>`y should be 1D tensor, but got y (${r.shape}).`);const i=await a.data(),l=await r.data(),c=new Set(l);let f=0;for(let g=0;g<i.length;g++)c.has(i[g])||f++;const h=new Xl([f],a.dtype),p=new Xl([f],"int32");for(let g=0,y=0;g<i.length;g++)c.has(i[g])||(h.values[y]=i[g],p.values[y]=g,y++);return[h.toTensor(),p.toTensor()]}const dS=RO;/**
 * @license
 * Copyright 2018 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
 ...
 * limitations under the License.
 * =============================================================================
 */function CO(t){const a={x:x(t,"x","sign")};return C.runKernel(T2,a)}const pS=R({sign_:CO});/**
 * @license
 * Copyright 2018 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
 ...
 * limitations under the License.
 * =============================================================================
 */function zO(t){const a={x:x(t,"x","sin","float32")};return C.runKernel(N2,a)}const mS=R({sin_:zO});/**
 * @license
 * Copyright 2018 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
 ...
 * limitations under the License.
 * =============================================================================
 */function jO(t){const a={x:x(t,"x","sinh")};return C.runKernel(x2,a)}const gS=R({sinh_:jO});/**
 * @license
 * Copyright 2018 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
 ...
 * limitations under the License.
 * =============================================================================
 */function MO(t,e,a){const r=x(t,"x","slice1d");return E(r.rank===1,()=>`slice1d expects a rank-1 tensor, but got a rank-${r.rank} tensor`),Be(r,[e],[a])}const yS=R({slice1d_:MO});/**
 * @license
 * Copyright 2018 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
 ...
 * limitations under the License.
 * =============================================================================
 */function LO(t,e,a){const r=x(t,"x","slice2d");return E(r.rank===2,()=>`slice2d expects a rank-2 tensor, but got a rank-${r.rank} tensor`),Be(r,e,a)}const bS=R({slice2d_:LO});/**
 * @license
 * Copyright 2018 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
 ...
 * limitations under the License.
 * =============================================================================
 */function IO(t,e,a){const r=x(t,"x","slice3d");return E(r.rank===3,()=>`slice3d expects a rank-3 tensor, but got a rank-${r.rank} tensor`),Be(r,e,a)}const vS=R({slice3d_:IO});/**
 * @license
 * Copyright 2018 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
 ...
 * limitations under the License.
 * =============================================================================
 */function BO(t,e,a){const r=x(t,"x","slice4d");return E(r.rank===4,()=>`slice4d expects a rank-4 tensor, but got a rank-${r.rank} tensor`),Be(r,e,a)}const wS=R({slice4d_:BO});/**
 * @license
 * Copyright 2018 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
 ...
 * limitations under the License.
 * =============================================================================
 */function UO(t,e=-1){const a=x(t,"logits","softmax","float32");if(e===-1&&(e=a.rank-1),e!==a.rank-1)throw Error(`Softmax along a non-last dimension is not yet supported. Logits was rank ${a.rank} and dim was ${e}`);const r={logits:a},i={dim:e};return C.runKernel(D2,r,i)}const Id=R({softmax_:UO});/**
 * @license
 * Copyright 2020 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
 ...
 * limitations under the License.
 * =============================================================================
 */function qO(t){E(t.dtype==="complex64",()=>`The dtype for tf.spectral.fft() must be complex64 but got ${t.dtype}.`);const e={input:t};return C.runKernel(o1,e)}const mu=R({fft_:qO});/**
 * @license
 * Copyright 2020 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
 ...
 * limitations under the License.
 * =============================================================================
 */function FO(t){E(t.dtype==="complex64",()=>`The dtype for tf.spectral.ifft() must be complex64 but got ${t.dtype}.`);const e={input:t};return C.runKernel(y1,e)}const Ji=R({ifft_:FO});/**
 * @license
 * Copyright 2018 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
 ...
 * limitations under the License.
 * =============================================================================
 */function HO(t,e,a=0){const i={x:x(t,"x","split")},l={numOrSizeSplits:e,axis:a};return C.runKernel($2,i,l)}const Or=R({split_:HO});/**
 * @license
 * Copyright 2018 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
 ...
 * limitations under the License.
 * =============================================================================
 */function GO(t,e){E(t.dtype==="float32",()=>`The dtype for rfft() must be real value but got ${t.dtype}`);let a=t.shape[t.shape.length-1];const r=t.size/a;let i;if(e!=null&&e<a){const k=t.shape.map(A=>0),$=t.shape.map(A=>A);$[t.shape.length-1]=e,i=Be(t,k,$),a=e}else if(e!=null&&e>a){const k=t.shape.map($=>$);k[t.shape.length-1]=e-a,i=Nt([t,Fa(k)],t.shape.length-1),a=e}else i=t;const l=Ht(i),c=ee(aa(i,l),[r,a]),f=mu(c),h=Math.floor(a/2)+1,p=Ar(f),g=ho(f),y=Or(p,[h,a-h],p.shape.length-1),v=Or(g,[h,a-h],g.shape.length-1),S=i.shape.slice();return S[i.shape.length-1]=h,ee(aa(y[0],v[0]),S)}const gu=R({rfft_:GO});/**
 * @license
 * Copyright 2020 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
 ...
 * limitations under the License.
 * =============================================================================
 */function KO(t,e){let a=x(t,"a","squaredDifference"),r=x(e,"b","squaredDifference");[a,r]=et(a,r),it(a.shape,r.shape);const i={a,b:r},l={};return C.runKernel(L2,i,l)}const Ud=R({squaredDifference_:KO});/**
 * @license
 * Copyright 2020 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
 ...
 * limitations under the License.
 * =============================================================================
 */function YO(t,e){const a=x(t,"x","squeeze","string_or_numeric");return ee(a,tb(a.shape,e).newShape)}const mo=R({squeeze_:YO});/**
 * @license
 * Copyright 2020 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
 ...
 * limitations under the License.
 * =============================================================================
 */function PO(t,e=0){const a=Ki(t,"tensors","stack","string_or_numeric");E(a.length>=1,()=>"Pass at least one tensor to tf.stack"),a.length>0&&E(e<=a[0].rank,()=>"Axis must be <= rank of the tensor");const r=a,i={axis:e};return C.runKernel(W1,r,i)}const jn=R({stack_:PO});/**
 * @license
 * Copyright 2018 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
 ...
 * limitations under the License.
 * =============================================================================
 */function XO(t,e=0){const r={x:x(t,"x","step")},i={alpha:e};return C.runKernel(Q2,r,i)}const qd=R({step_:XO});/**
 * @license
 * Copyright 2018 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
 ...
 * limitations under the License.
 * =============================================================================
 */function ZO(t,e,a,r,i=0,l=0,c=0,f=0,h=0){const g={x:x(t,"x","stridedSlice","string_or_numeric")},y={begin:e,end:a,strides:r,beginMask:i,endMask:l,ellipsisMask:c,newAxisMask:f,shrinkAxisMask:h};return C.runKernel(B2,g,y)}const SS=R({stridedSlice_:ZO});/**
 * @license
 * Copyright 2018 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
 ...
 * limitations under the License.
 * =============================================================================
 */function WO(t){const a={x:x(t,"x","tan","float32")};return C.runKernel(H2,a)}const NS=R({tan_:WO});/**
 * @license
 * Copyright 2018 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
 ...
 * limitations under the License.
 * =============================================================================
 */function JO(t,e,a){const r=x(t,"tensor","tensorScatterupdate"),i=x(e,"indices","tensorScatterupdate","int32"),l=x(a,"updates","tensorScatterupdate");if(yu(l,i,r.shape),r.dtype!==l.dtype)throw new Error(`tensor and updates must have the same dtype, instead they are ${r.dtype} and ${l.dtype}.`);const c={tensor:r,indices:i,updates:l},f={};return C.runKernel(y2,c,f)}const _S=R({tensorScatterUpdate_:JO});/**
 * @license
 * Copyright 2018 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
 ...
 * limitations under the License.
 * =============================================================================
 */function e$(t,e=1,a=!0){const r=x(t,"x","topk");if(r.rank===0)throw new Error("topk() expects the input to be of rank 1 or higher");const i=r.shape[r.shape.length-1];if(e<0)throw new Error(`'k' passed to topk() must be >= 0 but got ${e}`);if(e>i)throw new Error(`'k' passed to topk() must be <= the last dimension (${i}) but got ${e}`);const l={x:r},c={k:e,sorted:a},[f,h]=C.runKernel(K2,l,c);return{values:f,indices:h}}const AS=R({topk_:e$});/**
 * @license
 * Copyright 2020 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
 ...
 * limitations under the License.
 * =============================================================================
 */function t$(t,e=0,a=1,r,i){if(Gt(t),r!=null&&r==="bool")throw new Error("Unsupported data type $ { dtype }");const l=new zd(e,a,r,!0,i),c=Rn(t,r);for(let f=0;f<c.values.length;f++)c.values[f]=l.nextValue();return c.toTensor()}const OS=R({truncatedNormal_:t$});/**
 * @license
 * Copyright 2020 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
 ...
 * limitations under the License.
 * =============================================================================
 */function n$(t,e=0){const a=x(t,"x","unique","string_or_numeric");E(a.rank>0,()=>"The input tensor must be at least 1D");const r={x:a},i={axis:e},[l,c]=C.runKernel(P2,r,i);return{values:l,indices:c}}const $S=R({unique_:n$});/**
 * @license
 * Copyright 2020 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
 ...
 * limitations under the License.
 * =============================================================================
 */function a$(t,e,a){const r=x(t,"x","unsortedSegmentSum"),i=x(e,"segmentIds","unsortedSegmentSum","int32");E(Nr(a),()=>"numSegments must be of dtype int");const l={x:r,segmentIds:i},c={numSegments:a};return C.runKernel(Z2,l,c)}const DS=R({unsortedSegmentSum_:a$});/**
 * @license
 * Copyright 2020 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
 ...
 * limitations under the License.
 * =============================================================================
 */function s$(t,e=0){const a=x(t,"x","unstack","string_or_numeric");E(e>=-a.shape.length&&e<a.shape.length,()=>`Axis = ${e} is not in [-${a.shape.length}, ${a.shape.length})`);const r={value:a},i={axis:e};return C.runKernel(X2,r,i)}const Ga=R({unstack_:s$});/**
 * @license
 * Copyright 2022 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
 ...
 * limitations under the License.
 * =============================================================================
 */async function r$(t){const e=x(t,"condition","whereAsync","bool"),a=await e.data(),r=zS(e.shape,a);return t!==e&&e.dispose(),r}const Hd=r$;/**
 * @license
 * Copyright 2018 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
 ...
 * limitations under the License.
 * =============================================================================
 */async function i$(t,e,a){const r=x(t,"tensor","boolMask"),i=x(e,"mask","boolMask","bool"),l=a??0,c=i.rank,f=r.shape;E(c>0,()=>"mask cannot be scalar"),Dt(f.slice(l,l+c),i.shape,"mask's shape must match the first K dimensions of tensor's shape,");let h=1;for(let $=l;$<l+c;$++)h*=f[$];const p=f.slice(0,l).concat([h],f.slice(l+c)),g=ee(r,p),y=ee(i,[-1]),v=await Hd(y),S=mo(v,[1]),k=bd(g,S,l);return t!==r&&r.dispose(),e!==i&&i.dispose(),S.dispose(),g.dispose(),y.dispose(),v.dispose(),k}const jS=i$;/**
 * @license
 * Copyright 2018 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
 ...
 * limitations under the License.
 * =============================================================================
 */function o$(t,e,a){const r=x(t,"x","transpose");if(e==null&&(e=r.shape.map((c,f)=>f).reverse()),E(r.rank===e.length,()=>`Error in transpose: rank of input ${r.rank} must match length of perm ${e}.`),e.forEach(c=>{E(c>=0&&c<r.rank,()=>`All entries in 'perm' must be between 0 and ${r.rank-1} but got ${e}`)}),r.rank<=1)return r.clone();const i={x:r},l={perm:e};return r.dtype==="complex64"?Ce(()=>{let c=Ar(r),f=ho(r);return c=C.runKernel(Cl,{x:c},l),f=C.runKernel(Cl,{x:f},l),a&&(f=Sn(f)),aa(c,f)}):C.runKernel(Cl,i,l)}const eo=R({transpose_:o$});/**
 * @license
 * Copyright 2018 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
 ...
 * limitations under the License.
 * =============================================================================
 */function l$(t,e,a,r,i=!0){const l=x(t,"v","movingAverage"),c=x(e,"x","movingAverage"),f=x(a,"decay","movingAverage");cv(l,c),E(Nn(l.shape,c.shape),()=>"Shape mismatch in v and x");const h=$e(1),p=Te(h,f);let g=le(Te(c,l),p);if(i){E(r!=null,()=>"When using zeroDebias: true, step is required.");const y=x(r,"step","movingAverage");g=Pe(g,Te(h,Er(f,y)))}return be(l,g)}const MS=R({movingAverage_:l$});/**
 * @license
 * Copyright 2018 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
 ...
 * limitations under the License.
 * =============================================================================
 */function f$(t,e,a,r=0){Gt(a);const i=x(t,"sparseIndices","sparseToDense","int32"),l=x(e,"sparseValues","sparseToDense","string_or_numeric"),c=x(r,"defaultValue","sparseToDense",l.dtype);c$(i,l,a,c);const f={sparseIndices:i,sparseValues:l,defaultValue:c},h={outputShape:a};return C.runKernel(M2,f,h)}const IS=R({sparseToDense_:f$});/**
 * @license
 * Copyright 2018 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
 ...
 * limitations under the License.
 * =============================================================================
 */function h$(t,e){const a=x(e,"indices","gatherND","int32"),i={params:x(t,"x","gatherND","string_or_numeric"),indices:a};return C.runKernel(p1,i)}const BS=R({gatherND_:h$});/**
 * @license
 * Copyright 2019 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
 ...
 * limitations under the License.
 * =============================================================================
 */function d$(t,e){if(e==null)return t.shape.slice();if(Nn(t.shape,e))return e;if(t.shape.length===e.length){const a=[];for(let r=0;r<t.shape.length;r++)e[r]==null&&t.shape[r]!=null?a.push(t.shape[r]):a.push(e[r]);return a}return e}/**
 * @license
 * Copyright 2018 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
 ...
 * limitations under the License.
 * =============================================================================
 */function p$(t,e,a,r){const i=x(t,"x","dropout");if(E(i.dtype==="float32",()=>`x has to be a floating point tensor since it's going to be scaled, but got a ${i.dtype} tensor instead.`),E(e>=0&&e<1,()=>`rate must be a float in the range [0, 1), but got ${e}.`),e===0)return t instanceof Je?i.clone():i;const l=d$(i,a),c=1-e,f=Pe(yd(be(pu(l,0,1,"float32",r),c)),c);return le(i,f)}const US=R({dropout_:p$});/**
 * @license
 * Copyright 2019 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
 ...
 * limitations under the License.
 * =============================================================================
 */async function m$(t,e,a=1){const r=x(t,"predictions","inTopK"),i=x(e,"targets","inTopK");E(r.rank>1,()=>`inTopK() expects the predictions to be of rank 2 or higher, but got ${r.rank}`),E(r.rank-1===i.rank,()=>`predictions rank should be 1 larger than targets rank, but got predictions rank ${r.rank} and targets rank ${i.rank}`),Dt(r.shape.slice(0,r.shape.length-1),i.shape,"predictions's shape should be align with the targets' shape, except the last dimension.");const l=r.shape[r.shape.length-1];E(a>0&&a<=l,()=>`'k' passed to inTopK() must be > 0 && <= the predictions last dimension (${l}), but got ${a}`);const c=await r.data(),f=await i.data(),[h,p]=[c.length/l,l],g=nb("bool",h);for(let y=0;y<h;y++){const v=y*p,S=c.subarray(v,v+p),k=[];for(let $=0;$<S.length;$++)k.push({value:S[$],index:$});k.sort(($,A)=>A.value-$.value),g[y]=0;for(let $=0;$<a;$++)if(k[$].index===f[y]){g[y]=1;break}}return t!==r&&r.dispose(),e!==i&&i.dispose(),wn(g,i.shape,"bool")}const qS=m$;/**
 * @license
 * Copyright 2020 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
 ...
 * limitations under the License.
 * =============================================================================
 */function g$(t,e,a,r,i,l="NHWC",c){let f=t;t.rank===3&&(f=ee(t,[1,t.shape[0],t.shape[1],t.shape[2]]));let h=e;h.rank===3&&(h=ee(e,[1,e.shape[0],e.shape[1],e.shape[2]])),E(f.rank===4,()=>`Error in conv2dDerFilter: input must be rank 4, but got shape ${f.shape}.`),E(h.rank===4,()=>`Error in conv2dDerFilter: dy must be rank 4, but got shape ${h.shape}.`),E(a.length===4,()=>`Error in conv2dDerFilter: filterShape must be length 4, but got ${a}.`);const p=l==="NHWC"?f.shape[3]:f.shape[1],g=l==="NHWC"?h.shape[3]:h.shape[1];E(p===a[2],()=>`Error in conv2dDerFilter: depth of input ${p}) must match input depth in filter (${a[2]}.`),E(g===a[3],()=>`Error in conv2dDerFilter: depth of dy (${g}) must match output depth for filter (${a[3]}).`),pn("conv2dDerFilter",i,c);const y={x:f,dy:h},v={strides:r,pad:i,dataFormat:l,dimRoundingMode:c,filterShape:a};return C.runKernel(Lb,y,v)}const y$=R({conv2DBackpropFilter_:g$});/**
 * @license
 * Copyright 2019 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
 ...
 * limitations under the License.
 * =============================================================================
 */function w$(t,e,a,r,i,l=[1,1],c){let f=t;t.rank===3&&(f=ee(t,[1,t.shape[0],t.shape[1],t.shape[2]]));let h=e;h.rank===3&&(h=ee(e,[1,e.shape[0],e.shape[1],e.shape[2]]));const p={x:f,dy:h},g={strides:r,pad:i,dimRoundingMode:c,dilations:l,filterShape:a};return C.runKernel(Xb,p,g)}const S$=R({depthwiseConv2dNativeBackpropFilter_:w$});/**
 * @license
 * Copyright 2020 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
 ...
 * limitations under the License.
 * =============================================================================
 */function N$(t,e,a,r,i,l=[1,1],c){let f=e,h=!1;e.rank===3&&(h=!0,f=ee(e,[1,e.shape[0],e.shape[1],e.shape[2]]));const p={dy:f,filter:a},g={strides:r,pad:i,dimRoundingMode:c,dilations:l,inputShape:t},y=C.runKernel(Zb,p,g);return h?ee(y,[y.shape[1],y.shape[2],y.shape[3]]):y}const x$=R({depthwiseConv2dNativeBackpropInput_:N$});/**
 * @license
 * Copyright 2019 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
 ...
 * limitations under the License.
 * =============================================================================
 */const FS=Object.freeze(Object.defineProperty({__proto__:null,conv2d:v$,depthwiseConv2d:E$,matMul:_$},Symbol.toStringTag,{value:"Module"}));/**
 * @license
 * Copyright 2019 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
 ...
 * limitations under the License.
 * =============================================================================
 */function A$(t){return bu(t,.54,.46)}const O$=R({hammingWindow_:A$});/**
 * @license
 * Copyright 2019 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
 ...
 * limitations under the License.
 * =============================================================================
 */function $$(t){return bu(t,.5,.5)}const VS=R({hannWindow_:$$});/**
 * @license
 * Copyright 2019 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
 ...
 * limitations under the License.
 * =============================================================================
 */function D$(t,e,a,r=!1,i=0){let l=0;const c=[];for(;l+e<=t.size;)c.push(Be(t,l,e)),l+=a;if(r)for(;l<t.size;){const f=l+e-t.size,h=Nt([Be(t,l,e-f),Dr([f],i)]);c.push(h),l+=a}return c.length===0?wr([],[0,e]):ee(Nt(c),[c.length,e])}const HS=R({frame_:D$});/**
 * @license
 * Copyright 2019 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
 ...
 * limitations under the License.
 * =============================================================================
 */function R$(t,e,a,r,i=VS){r==null&&(r=Gd(e));const l=HS(t,e,a),c=le(l,i(e));return gu(c,r)}const C$=R({stft_:R$});/**
 * @license
 * Copyright 2020 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
 ...
 * limitations under the License.
 * =============================================================================
 */function z$(t,e,a,r,i="bilinear",l=0){const c=x(t,"image","cropAndResize"),f=x(e,"boxes","cropAndResize","float32"),h=x(a,"boxInd","cropAndResize","int32"),p=f.shape[0];E(c.rank===4,()=>`Error in cropAndResize: image must be rank 4,but got rank ${c.rank}.`),E(f.rank===2&&f.shape[1]===4,()=>`Error in cropAndResize: boxes must be have size [${p},4] but had shape ${f.shape}.`),E(h.rank===1&&h.shape[0]===p,()=>`Error in cropAndResize: boxInd must be have size [${p}] but had shape ${f.shape}.`),E(r.length===2,()=>`Error in cropAndResize: cropSize must be of length 2, but got length ${r.length}.`),E(r[0]>=1&&r[1]>=1,()=>`cropSize must be atleast [1,1], but was ${r}`),E(i==="bilinear"||i==="nearest",()=>`method must be bilinear or nearest, but was ${i}`);const g={image:c,boxes:f,boxInd:h},y={method:i,extrapolationValue:l,cropSize:r};return C.runKernel(Gb,g,y)}const j$=R({cropAndResize_:z$});/**
 * @license
 * Copyright 2020 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
 ...
 * limitations under the License.
 * =============================================================================
 */function M$(t){const e=x(t,"image","flipLeftRight","float32");E(e.rank===4,()=>`Error in flipLeftRight: image must be rank 4,but got rank ${e.rank}.`);const a={image:e};return C.runKernel(u1,a,{})}const L$=R({flipLeftRight_:M$});/**
 * @license
 * Copyright 2021 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
 ...
 * limitations under the License.
 * =============================================================================
 */function I$(t){const e=x(t,"image","grayscaleToRGB"),a=e.rank-1,r=e.shape[a];E(e.rank>=2,()=>`Error in grayscaleToRGB: images must be at least rank 2, but got rank ${e.rank}.`),E(r===1,()=>`Error in grayscaleToRGB: last dimension of a grayscale image should be size 1, but got size ${r}.`);const i=new Array(e.rank);return i.fill(1,0,a),i[a]=3,vr(e,i)}const B$=R({grayscaleToRGB_:I$});/**
 * @license
 * Copyright 2023 Google LLC.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
 ...
 * limitations under the License.
 * =============================================================================
 */function F$(t,e,a=0,r=.5){const i=x(t,"image","rotateWithOffset","float32");E(i.rank===4,()=>`Error in rotateWithOffset: image must be rank 4,but got rank ${i.rank}.`);const l={image:i},c={radians:e,fillValue:a,center:r};return C.runKernel(J2,l,c)}const V$=R({rotateWithOffset_:F$});/**
 * @license
 * Copyright 2020 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
 ...
 * limitations under the License.
 * =============================================================================
 */function K$(t,e,a){const r=Y$(t,e,a),i=r<0?-(r+1):r;t.splice(i,0,e)}function Y$(t,e,a){return X$(t,e,a||P$)}function P$(t,e){return t>e?1:t<e?-1:0}function X$(t,e,a){let r=0,i=t.length,l=0,c=!1;for(;r<i;){l=r+(i-r>>>1);const f=a(e,t[l]);f>0?r=l+1:(i=l,c=!f)}return c?r:-r-1}/**
 * @license
 * Copyright 2020 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
 ...
 * limitations under the License.
 * =============================================================================
 */function eD(t,e,a,r=.5,i=Number.NEGATIVE_INFINITY,l=0){const c=x(t,"boxes","nonMaxSuppression"),f=x(e,"scores","nonMaxSuppression"),h=Cr(c,f,a,r,i,l);a=h.maxOutputSize,r=h.iouThreshold,i=h.scoreThreshold,l=h.softNmsSigma;const p={boxes:c,scores:f},g={maxOutputSize:a,iouThreshold:r,scoreThreshold:i,softNmsSigma:l},y=C.runKernel(P1,p,g);return{selectedIndices:y[0],selectedScores:y[1]}}const tD=R({nonMaxSuppressionWithScore_:eD});/**
 * @license
 * Copyright 2020 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
 ...
 * limitations under the License.
 * =============================================================================
 */function lD(t,e,a=!1,r=!1){const i=x(t,"images","resizeBilinear");E(i.rank===3||i.rank===4,()=>`Error in resizeBilinear: x must be rank 3 or 4, but got rank ${i.rank}.`),E(e.length===2,()=>`Error in resizeBilinear: new shape must 2D, but got shape ${e}.`),E(r===!1||a===!1,()=>"Error in resizeBilinear: If halfPixelCenters is true, alignCorners must be false.");let l=i,c=!1;i.rank===3&&(c=!0,l=ee(i,[1,i.shape[0],i.shape[1],i.shape[2]]));const f={images:l},h={alignCorners:a,halfPixelCenters:r,size:e},p=C.runKernel(f2,f,h);return c?ee(p,[p.shape[1],p.shape[2],p.shape[3]]):p}const uD=R({resizeBilinear_:lD});/**
 * @license
 * Copyright 2020 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
 ...
 * limitations under the License.
 * =============================================================================
 */function hD(t,e="binary",a=!1,r=.5){const i=x(t,"image","threshold"),l=.2989,c=.587,f=.114,h=i.shape[0]*i.shape[1];let p=le(tn([r]),255),g,y,v,S;if(E(i.rank===3,()=>`Error in threshold: image must be rank 3,but got rank ${i.rank}.`),E(i.shape[2]===3||i.shape[2]===1,()=>`Error in threshold: image color channel must be equal to 3 or 1but got ${i.shape[2]}.`),E(i.dtype==="int32"||i.dtype==="float32",()=>`Error in dtype: image dtype must be int32 or float32,but got dtype ${i.dtype}.`),E(e==="otsu"||e==="binary",()=>`Method must be binary or otsu, but was ${e}`),i.shape[2]===3){[g,y,v]=Or(i,[1,1,1],-1);const A=le(g,l),M=le(y,c),X=le(v,f);S=be(be(A,M),X)}else S=t;if(e==="otsu"){const A=fd(He(Ld(S),"int32"),wn([]),256);p=dD(A,h)}const k=a?fu(S,p):fo(S,p);return He(le(k,255),"int32")}function dD(t,e){let a=tn([-1]),r=tn([0]),i=tn([0]),l,c,f,h,p,g;for(let y=0;y<t.size-1;y++){l=Be(t,0,y+1),c=Be(t,y+1),p=Pe(Ye(l),e),g=Pe(Ye(c),e);const v=Ye(le(l,_r(0,l.size)));f=Pe(v,Ye(l));const S=Dr(c.shape,l.size),k=be(_r(0,c.size),S),$=le(c,k);h=Pe(Ye($),Ye(c));const A=Te(f,h),M=Te(f,h),X=le(p,g);i=le(le(X,A),M);const z=fo(i,r);r=na(z,i,r),a=na(z,tn([y]),a)}return a}const pD=R({threshold_:hD});/**
 * @license
 * Copyright 2021 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
 ...
 * limitations under the License.
 * =============================================================================
 */function yD(t,e,a){const r=x(t,"a","bandPart");E(r.rank>=2,()=>`bandPart(): Rank must be at least 2, got ${r.rank}.`);const i=r.shape,[l,c]=r.shape.slice(-2);let f,h;typeof e=="number"?(E(e%1===0,()=>`bandPart(): numLower must be an integer, got ${e}.`),E(e<=l,()=>`bandPart(): numLower (${e}) must not be greater than the number of rows (${l}).`),f=x(e<0?l:e,"numLower","bandPart")):(E(e.dtype==="int32",()=>"bandPart(): numLower's dtype must be an int32."),f=na(Jl(e,0),l,Qi(e,l))),typeof a=="number"?(E(a%1===0,()=>`bandPart(): numUpper must be an integer, got ${a}.`),E(a<=c,()=>`bandPart(): numUpper (${a}) must not be greater than the number of columns (${c}).`),h=x(a<0?c:a,"numUpper","bandPart")):(E(a.dtype==="int32",()=>"bandPart(): numUpper's dtype must be an int32."),h=na(Jl(a,0),c,Qi(a,c)));const p=ee(_r(0,l,1,"int32"),[-1,1]),g=_r(0,c,1,"int32"),y=Te(p,g),v=Zi(fu(y,f),vd(y,Sn(h))),S=Fa([l,c],r.dtype);return ee(jn(Ga(ee(r,[-1,l,c])).map(k=>na(v,k,S))),i)}const bD=R({bandPart_:yD});/**
 * @license
 * Copyright 2020 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
 ...
 * limitations under the License.
 * =============================================================================
 */function vD(t){let e;if(Array.isArray(t)){e=!1,E(t!=null&&t.length>0,()=>"Gram-Schmidt process: input must not be null, undefined, or empty");const i=t[0].shape[0];for(let l=1;l<t.length;++l)E(t[l].shape[0]===i,()=>`Gram-Schmidt: Non-unique lengths found in the input vectors: (${t[l].shape[0]} vs. ${i})`)}else e=!0,t=Or(t,t.shape[0],0).map(i=>mo(i,[0]));E(t.length<=t[0].shape[0],()=>`Gram-Schmidt: Number of vectors (${t.length}) exceeds number of dimensions (${t[0].shape[0]}).`);const a=[],r=t;for(let i=0;i<t.length;++i)a.push(C.tidy(()=>{let l=r[i];if(i>0)for(let c=0;c<i;++c){const f=le(Ye(le(a[c],l)),a[c]);l=Te(l,f)}return Pe(l,co(l,"euclidean"))}));return e?jn(a,0):a}const wD=R({gramSchmidt_:vD});/**
 * @license
 * Copyright 2020 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
 ...
 * limitations under the License.
 * =============================================================================
 */var Ot;(function(t){t[t.NONE=0]="NONE",t[t.MEAN=1]="MEAN",t[t.SUM=2]="SUM",t[t.SUM_BY_NONZERO_WEIGHTS=3]="SUM_BY_NONZERO_WEIGHTS"})(Ot||(Ot={}));function xD(t,e,a=Ot.SUM_BY_NONZERO_WEIGHTS){const r=x(t,"losses","computeWeightedLoss");let i=null;e!=null&&(i=x(e,"weights","computeWeightedLoss"));const l=i==null?r:le(r,i);if(a===Ot.NONE)return l;if(a===Ot.SUM)return Ye(l);if(a===Ot.MEAN){if(i==null)return Wi(l);{const c=r.size/i.size,f=Pe(Ye(l),Ye(i));return c>1?Pe(f,$e(c)):f}}if(a===Ot.SUM_BY_NONZERO_WEIGHTS){if(i==null)return Pe(Ye(l),$e(r.size));{const c=le(i,ja(r.shape)),f=He(Ye(Ad(c,$e(0))),"float32");return Pe(Ye(l),f)}}throw Error(`Unknown reduction: ${a}`)}const ra=R({computeWeightedLoss_:xD});/**
 * @license
 * Copyright 2020 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
 ...
 * limitations under the License.
 * =============================================================================
 */function TD(t,e,a,r=Ot.SUM_BY_NONZERO_WEIGHTS){const i=x(t,"labels","absoluteDifference"),l=x(e,"predictions","absoluteDifference");let c=null;a!=null&&(c=x(a,"weights","absoluteDifference")),Dt(i.shape,l.shape,"Error in absoluteDifference: ");const f=Vt(Te(i,l));return ra(f,c,r)}const ED=R({absoluteDifference_:TD});function kD(t,e,a,r,i=Ot.SUM_BY_NONZERO_WEIGHTS){const l=x(t,"labels","cosineDistance"),c=x(e,"predictions","cosineDistance");let f=null;r!=null&&(f=x(r,"weights","cosineDistance")),Dt(l.shape,c.shape,"Error in cosineDistance: ");const h=$e(1),p=Te(h,Ye(le(l,c),a,!0));return ra(p,f,i)}const _D=R({cosineDistance_:kD});function AD(t,e,a,r=Ot.SUM_BY_NONZERO_WEIGHTS){let i=x(t,"labels","hingeLoss");const l=x(e,"predictions","hingeLoss");let c=null;a!=null&&(c=x(a,"weights","hingeLoss")),Dt(i.shape,l.shape,"Error in hingeLoss: ");const f=$e(1);i=Te(le($e(2),i),f);const h=po(Te(f,le(i,l)));return ra(h,c,r)}const OD=R({hingeLoss_:AD});/**
 * @license
 * Copyright 2020 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
 ...
 * limitations under the License.
 * =============================================================================
 */function $D(t,e,a,r=1,i=Ot.SUM_BY_NONZERO_WEIGHTS){const l=x(t,"labels","huberLoss"),c=x(e,"predictions","huberLoss");let f=null;a!=null&&(f=x(a,"weights","huberLoss")),Dt(l.shape,c.shape,"Error in huberLoss: ");const h=$e(r),p=Vt(Te(c,l)),g=Qi(p,h),y=Te(p,g),v=be(le($e(.5),dn(g)),le(h,y));return ra(v,f,i)}const DD=R({huberLoss_:$D});/**
 * @license
 * Copyright 2020 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
 ...
 * limitations under the License.
 * =============================================================================
 */function RD(t,e,a,r=1e-7,i=Ot.SUM_BY_NONZERO_WEIGHTS){const l=x(t,"labels","logLoss"),c=x(e,"predictions","logLoss");let f=null;a!=null&&(f=x(a,"weights","logLoss")),Dt(l.shape,c.shape,"Error in logLoss: ");const h=$e(1),p=$e(r),g=Sn(le(l,kr(be(c,p)))),y=le(Te(h,l),kr(be(Te(h,c),p))),v=Te(g,y);return ra(v,f,i)}const CD=R({logLoss_:RD});/**
 * @license
 * Copyright 2020 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
 ...
 * limitations under the License.
 * =============================================================================
 */function zD(t,e,a,r=Ot.SUM_BY_NONZERO_WEIGHTS){const i=x(t,"labels","meanSquaredError"),l=x(e,"predictions","meanSquaredError");let c=null;a!=null&&(c=x(a,"weights","meanSquaredError")),Dt(i.shape,l.shape,"Error in meanSquaredError: ");const f=Ud(i,l);return ra(f,c,r)}const jD=R({meanSquaredError_:zD});/**
 * @license
 * Copyright 2020 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
 ...
 * limitations under the License.
 * =============================================================================
 */function MD(t,e){const a=x(t,"labels","sigmoidCrossEntropyWithLogits"),r=x(e,"logits","sigmoidCrossEntropyWithLogits");Dt(a.shape,r.shape,"Error in sigmoidCrossEntropyWithLogits: ");const i=po(r),l=le(r,a),c=Sd(qa(Sn(Vt(r))));return be(Te(i,l),c)}function LD(t,e,a,r=0,i=Ot.SUM_BY_NONZERO_WEIGHTS){let l=x(t,"multiClassLabels","sigmoidCrossEntropy");const c=x(e,"logits","sigmoidCrossEntropy");let f=null;if(a!=null&&(f=x(a,"weights","sigmoidCrossEntropy")),Dt(l.shape,c.shape,"Error in sigmoidCrossEntropy: "),r>0){const p=$e(r),g=$e(1),y=$e(.5);l=be(le(l,Te(g,p)),le(y,p))}const h=MD(l,c);return ra(h,f,i)}const ID=R({sigmoidCrossEntropy_:LD});/**
 * @license
 * Copyright 2020 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
 ...
 * limitations under the License.
 * =============================================================================
 */function BD(t,e,a=-1){if(a===-1&&(a=e.rank-1),a!==e.rank-1)throw Error(`Softmax cross entropy along a non-last dimension is not yet supported. Labels / logits was rank ${e.rank} and dim was ${a}`);return zn((i,l,c)=>{const h=xd(l,[a],!0),p=Te(He(l,"float32"),h);c([i,p]);const g=Sn(le(p,i));return{value:Ye(g,[a]),gradFunc:(S,k)=>{const[$,A]=k,M=uo(S.shape,[a]);return[le(ee(S,M),Te(He($,"float32"),qa(A))),le(ee(S,M),Te(qa(A),He($,"float32")))]}}})(t,e)}function UD(t,e,a,r=0,i=Ot.SUM_BY_NONZERO_WEIGHTS){let l=x(t,"onehotLabels","softmaxCrossEntropy");const c=x(e,"logits","softmaxCrossEntropy");let f=null;if(a!=null&&(f=x(a,"weights","softmaxCrossEntropy")),Dt(l.shape,c.shape,"Error in softmaxCrossEntropy: "),r>0){const p=$e(r),g=$e(1),y=$e(l.shape[1]);l=be(le(l,Te(g,p)),Pe(p,y))}const h=BD(l,c);return ra(h,f,i)}const qD=R({softmaxCrossEntropy_:UD});/**
 * @license
 * Copyright 2021 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
 ...
 * limitations under the License.
 * =============================================================================
 */function HD(t,e,a){const r=x(t,"inputIndices","sparseReshape","int32"),i=x(e,"inputShape","sparseReshape","int32"),l=x(a,"newShape","sparseReshape","int32");if(r.rank!==2)throw new Error(`Input indices should be Tensor2D but received shape
        ${r.shape}`);if(i.rank!==1)throw new Error(`Input shape should be Tensor1D but received shape ${i.shape}`);if(l.rank!==1)throw new Error(`New shape should be Tensor1D but received shape ${l.shape}`);const c={inputIndices:r,inputShape:i,newShape:l},f=C.runKernel(C2,c);return{outputIndices:f[0],outputShape:f[1]}}const GD=R({sparseReshape_:HD});/**
 * @license
 * Copyright 2021 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
 ...
 * limitations under the License.
 * =============================================================================
 */function KD(t,e,a){const r=x(t,"data","sparseSegmentMean"),i=x(e,"indices","sparseSegmentMean","int32"),l=x(a,"segmentIds","sparseSegmentMean","int32");if(r.rank<1)throw new Error("Data should be at least 1 dimensional but received scalar");if(i.rank!==1)throw new Error(`Indices should be Tensor1D but received shape
          ${i.shape}`);if(l.rank!==1)throw new Error(`Segment ids should be Tensor1D but received shape
          ${l.shape}`);const c={data:r,indices:i,segmentIds:l};return C.runKernel(z2,c)}const YD=R({sparseSegmentMean_:KD});/**
 * @license
 * Copyright 2021 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
 ...
 * limitations under the License.
 * =============================================================================
 */function PD(t,e,a){const r=x(t,"data","sparseSegmentSum"),i=x(e,"indices","sparseSegmentSum","int32"),l=x(a,"segmentIds","sparseSegmentSum","int32");if(r.rank<1)throw new Error("Data should be at least 1 dimensional but received scalar");if(i.rank!==1)throw new Error(`Indices should be Tensor1D but received shape
         ${i.shape}`);if(l.rank!==1)throw new Error(`Segment ids should be Tensor1D but received shape
         ${l.shape}`);const c={data:r,indices:i,segmentIds:l};return C.runKernel(j2,c)}const XD=R({sparseSegmentSum_:PD});/**
 * @license
 * Copyright 2021 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
 ...
 * limitations under the License.
 * =============================================================================
 */function e6(t,e){const a=x(t,"input","stringToHashBucketFast","string"),r={numBuckets:e};if(e<=0)throw new Error("Number of buckets must be at least 1");const i={input:a};return C.runKernel(F2,i,r)}const t6=R({stringToHashBucketFast_:e6});/**
 * @license
 * Copyright 2023 Google LLC.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
 ...
 * limitations under the License.
 * =============================================================================
 */function n6(t,e,a,r=!0){const i=x(t,"input","staticRegexReplace","string"),l={pattern:e,rewrite:a,replaceGlobal:r};return C.runKernel(I2,{x:i},l)}const a6=R({staticRegexReplace_:n6});/**
 * @license
 * Copyright 2020 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
 ...
 * limitations under the License.
 * =============================================================================
 */const PS={fft:mu,ifft:Ji,rfft:gu,irfft:Bd},XS={hammingWindow:O$,hannWindow:VS,frame:HS,stft:C$},Yd={flipLeftRight:L$,grayscaleToRGB:B$,resizeNearestNeighbor:fD,resizeBilinear:uD,rgbToGrayscale:q$,rotateWithOffset:V$,cropAndResize:j$,nonMaxSuppression:G$,nonMaxSuppressionAsync:J$,nonMaxSuppressionWithScore:tD,nonMaxSuppressionWithScoreAsync:aD,nonMaxSuppressionPadded:rD,nonMaxSuppressionPaddedAsync:oD,threshold:pD,transform:gD},ZS={bandPart:bD,gramSchmidt:wD,qr:ND},WS={absoluteDifference:ED,computeWeightedLoss:ra,cosineDistance:_D,hingeLoss:OD,huberLoss:DD,logLoss:CD,meanSquaredError:jD,sigmoidCrossEntropy:ID,softmaxCrossEntropy:qD},QS={sparseFillEmptyRows:VD,sparseReshape:GD,sparseSegmentMean:YD,sparseSegmentSum:XD},JS={stringNGrams:WD,stringSplit:JD,stringToHashBucketFast:t6,staticRegexReplace:a6};/**
 * @license
 * Copyright 2018 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
 ...
 * limitations under the License.
 * =============================================================================
 */const s6=new Map,xh=new Map;class eN{getClassName(){return this.constructor.className}static fromConfig(e,a){return new e(a)}}class Ra{constructor(){this.classNameMap={}}static getMap(){return Ra.instance==null&&(Ra.instance=new Ra),Ra.instance}static register(e){Ra.getMap().classNameMap[e.className]=[e,e.fromConfig]}}function tN(t,e,a){E(t.className!=null,()=>"Class being registered does not have the static className property defined."),E(typeof t.className=="string",()=>"className is required to be a string, but got type "+typeof t.className),E(t.className.length>0,()=>"Class being registered has an empty-string as its className, which is disallowed."),typeof e>"u"&&(e="Custom"),typeof a>"u"&&(a=t.className);const r=a,i=e+">"+r;return Ra.register(t),s6.set(i,t),xh.set(t,i),t}function r6(t){return xh.has(t)?xh.get(t):t.className}const i6=Object.freeze(Object.defineProperty({__proto__:null,Serializable:eN,SerializationMap:Ra,getRegisteredName:r6,registerClass:tN},Symbol.toStringTag,{value:"Module"}));/**
 * @license
 * Copyright 2018 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
 ...
 * limitations under the License.
 * =============================================================================
 */const o6=[Pd,Xd,Zd,Wd,Qd,Jd,xu];function l6(){for(const t of o6)tN(t)}/**
 * @license
 * Copyright 2018 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
 ...
 * limitations under the License.
 * =============================================================================
 */const np=Object.freeze(Object.defineProperty({__proto__:null,CompositeArrayBuffer:xn,browserFiles:m6,browserHTTPRequest:S6,concatenateArrayBuffers:bk,copyModel:Uk,decodeWeights:yv,decodeWeightsStream:vv,encodeWeights:hk,fromMemory:x6,fromMemorySync:tu,getLoadHandlers:kk,getModelArtifactsForJSON:rd,getModelArtifactsForJSONSync:sd,getModelArtifactsInfoForJSON:ro,getSaveHandlers:Ek,getWeightSpecs:Zl,http:tp,isHTTPScheme:Th,listModels:Ik,loadWeights:y6,moveModel:qk,registerLoadRouter:Tk,registerSaveRouter:xk,removeModel:Bk,weightsLoaderFactory:aN,withSaveHandler:T6,withSaveHandlerSync:E6},Symbol.toStringTag,{value:"Module"}));/**
 * @license
 * Copyright 2018 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
 ...
 * limitations under the License.
 * =============================================================================
 */const A6=Object.freeze(Object.defineProperty({__proto__:null,confusionMatrix:_6},Symbol.toStringTag,{value:"Module"}));/**
 * @license
 * Copyright 2019 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
 ...
 * limitations under the License.
 * =============================================================================
 */const W6=typeof requestAnimationFrame<"u"?requestAnimationFrame:typeof setImmediate<"u"?setImmediate:t=>t();function Q6(){return new Promise(t=>W6(()=>t()))}/**
 * @license
 * Copyright 2017 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
 ...
 * limitations under the License.
 * =============================================================================
 */var $n;(function(t){t[t.FIRST_DIM_SIZE=0]="FIRST_DIM_SIZE",t[t.VALUE_ROWIDS=1]="VALUE_ROWIDS",t[t.ROW_LENGTHS=2]="ROW_LENGTHS",t[t.ROW_SPLITS=3]="ROW_SPLITS",t[t.ROW_LIMITS=4]="ROW_LIMITS",t[t.ROW_STARTS=5]="ROW_STARTS"})($n||($n={}));function t5(t,e,a){let r=new Array;if(a==null&&e==null)return r;if(e==null)for(;r.length<t+a.length;)r.push(-1);else r=e.slice();if(a==null)return r;if(t+a.length!==r.length)throw new Error(`rt input.shape and shape=${e} are incompatible: rt input.rank = ${t+a.length}, but shape.rank = ${r.length}`);for(let i=1;i<a.length;++i){const l=a[i],c=r[r.length-a.length+i],f=r[c];if(l>=0)if(f>=0){if(f!==l)throw new Error(`rt input.shape and shape=${e} are incompatible: rt input.shape[${i+t}] = ${l} but shape[${i+t}] = ${f}`)}else r[c]=l}return r}function n5(t){const e={FIRST_DIM_SIZE:$n.FIRST_DIM_SIZE,VALUE_ROWIDS:$n.VALUE_ROWIDS,ROW_LENGTHS:$n.ROW_LENGTHS,ROW_SPLITS:$n.ROW_SPLITS,ROW_LIMITS:$n.ROW_LIMITS,ROW_STARTS:$n.ROW_STARTS},a=[];for(const r of t)if(r in e)a.push(e[r]);else break;return a}function a5(t){return t.length===0?0:t[0]===$n.FIRST_DIM_SIZE?t.length-1:t.length}function s5(t,e){if(t==null||e==null)return;const a=t.length,r=e.length;if(a>=r)throw new Error(`defaultValue.shape=${t} and ragged tensor flatValues.shape=${e}, are incompatible: defaultValue.rank = ${a} must be less than ragged tensor input flatValues.rank = ${r})`);for(let i=0;i<Math.min(a,r-1);++i){const l=t[i],c=e[i+1];if(l>=0&&c>=0&&l!==1&&l!==c)throw new Error(`defaultValue.shape=${t}, and ragged tensor input flatValues.shape=${e} are incompatible: defaultValue.shape[${i-t.length}] = ${l} but ragged tensor input.flatValues.shape[${i-t.length}] = ${c}`)}}/**
 * @license
 * Copyright 2017 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
 ...
 * limitations under the License.
 * =============================================================================
 */const ap=30;function r5(t){return t<=ap?t:Kl(t,Math.floor(Math.sqrt(t)))}/**
 * @license
 * Copyright 2020 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
 ...
 * limitations under the License.
 * =============================================================================
 */function i5(t,e,a){const r=a*(typeof t=="number"?t:t[0]),i=e*(typeof t=="number"?t:t[1]);return[r,i]}/**
 * @license
 * Copyright 2018 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
 ...
 * limitations under the License.
 * =============================================================================
 */function o5(t,e,a,r=!0){let i=[];if(r)i=i.concat(e.slice(0)),i.push(t[0]/a),i=i.concat(t.slice(1));else{i=i.concat(t[0]);const l=e.length;for(let c=0;c<l;++c)i=i.concat([t[c+1]/e[c],e[c]]);i=i.concat(t.slice(l+1))}return i}function l5(t,e,a=!0){const r=[];if(a){r.push(e);for(let i=e+1;i<t;++i)i<=2*e?(r.push(i),r.push(i-(e+1))):r.push(i)}else{const i=[],l=[];for(let c=1;c<t;++c)c>=e*2+1||c%2===1?l.push(c):i.push(c);r.push(...i),r.push(0),r.push(...l)}return r}function u5(t,e,a,r=!0){const i=[];r?i.push(t[0]/a):i.push(t[0]*a);for(let l=1;l<t.length;++l)l<=e.length?r?i.push(e[l-1]*t[l]):i.push(t[l]/e[l-1]):i.push(t[l]);return i}function c5(t,e){const a=[0];for(let r=0;r<e;++r)a.push(t[r][0]);return a}function f5(t,e,a){const r=t.slice(0,1);for(let i=0;i<a;++i)r.push(t[i+1]-e[i][0]-e[i][1]);return r}/**
 * @license
 * Copyright 2018 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
 ...
 * limitations under the License.
 * =============================================================================
 */const h5=1.7580993408473768,d5=1.0507009873554805;/**
 * @license
 * Copyright 2018 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
 ...
 * limitations under the License.
 * =============================================================================
 */const p5=.3275911,m5=.254829592,g5=-.284496736,y5=1.421413741,b5=-1.453152027,v5=1.061405429;/**
 * @license
 * Copyright 2018 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
 ...
 * limitations under the License.
 * =============================================================================
 */function w5(t,e){if(t.length!==e.length)throw new Error(`Cannot merge real and imag arrays of different lengths. real:${t.length}, imag: ${e.length}.`);const a=new Float32Array(t.length*2);for(let r=0;r<a.length;r+=2)a[r]=t[r/2],a[r+1]=e[r/2];return a}function S5(t){const e=new Float32Array(t.length/2),a=new Float32Array(t.length/2);for(let r=0;r<t.length;r+=2)e[r/2]=t[r],a[r/2]=t[r+1];return{real:e,imag:a}}function N5(t){const e=Math.ceil(t.length/4),a=new Float32Array(e),r=new Float32Array(e);for(let i=0;i<t.length;i+=4)a[Math.floor(i/4)]=t[i],r[Math.floor(i/4)]=t[i+1];return{real:a,imag:r}}function x5(t){const e=Math.floor(t.length/4),a=new Float32Array(e),r=new Float32Array(e);for(let i=2;i<t.length;i+=4)a[Math.floor(i/4)]=t[i],r[Math.floor(i/4)]=t[i+1];return{real:a,imag:r}}function T5(t,e){const a=t[e*2],r=t[e*2+1];return{real:a,imag:r}}function E5(t,e,a,r){t[r*2]=e,t[r*2+1]=a}function k5(t,e){const a=new Float32Array(t/2),r=new Float32Array(t/2);for(let i=0;i<Math.ceil(t/2);i++){const l=(e?2:-2)*Math.PI*(i/t);a[i]=Math.cos(l),r[i]=Math.sin(l)}return{real:a,imag:r}}function _5(t,e,a){const r=(a?2:-2)*Math.PI*(t/e),i=Math.cos(r),l=Math.sin(r);return{real:i,imag:l}}/**
 * @license
 * Copyright 2021 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
 ...
 * limitations under the License.
 * =============================================================================
 */const eh="->",A5=/->/g,C0=",",z0="...";function O5(t,e){t=t.replace(/\s/g,"");const a=(t.length-t.replace(A5,"").length)/eh.length;if(a<1)throw new Error("Equations without an arrow are not supported.");if(a>1)throw new Error(`Equation must contain exactly one arrow ("${eh}").`);const[r,i]=t.split(eh);E(r.indexOf(z0)===-1,()=>`The ellipsis notation ("${z0}") is not supported yet.`);const l=r.split(C0),c=l.length;if(e!==c)throw new Error(`Expected ${c} input tensors, received ${e}`);if(c>2)throw new Error("Support for more than 2 input tensors is not implemented yet.");const f=[];for(let v=0;v<i.length;++v){const S=i[v];if(!l.some(k=>k.indexOf(S)!==-1))throw new Error(`Output subscripts contain the label ${S} not present in the input subscripts.`);f.indexOf(S)===-1&&f.push(S)}for(let v=0;v<r.length;++v){const S=r[v];f.indexOf(S)===-1&&S!==C0&&f.push(S)}const h=new Array(l.length);for(let v=0;v<c;++v){if(new Set(l[v].split("")).size!==l[v].length)throw new Error(`Found duplicate axes in input component ${l[v]}. Support for duplicate axes in input is not implemented yet.`);h[v]=[];for(let S=0;S<l[v].length;++S)h[v].push(f.indexOf(l[v][S]))}const p=f.length,g=i.length,y=[];for(let v=g;v<p;++v)y.push(v);return{allDims:f,summedDims:y,idDims:h}}function $5(t,e){let a=new Array(t);a.fill(-1);for(let i=0;i<e.length;++i)a[e[i]]=i;const r=[];for(let i=0;i<t;++i)a[i]===-1&&r.push(i);return a=a.filter(i=>i!==-1),{permutationIndices:a,expandDims:r}}function D5(t,e,a){const r=new Array(t);for(let i=0;i<a.length;++i){const l=a[i].shape;for(let c=0;c<e[i].length;++c)r[e[i][c]]===void 0?r[e[i][c]]=l[c]:E(r[e[i][c]]===l[c],()=>`Expected dimension ${r[e[i][c]]} at axis ${c} of input shaped ${JSON.stringify(l)}, but got dimension ${l[c]}`)}}function R5(t,e){const a=t,r=[];let i=0;t.length===0&&a.push(-1),i=t.length+1;for(let c=0;c<i;++c)r.push([]);const l=[];for(let c=0;c<a.length;++c){const f=a[c],h=z5(e,f);for(const p of h)l.indexOf(p)===-1&&(r[c].push(p),l.push(p))}return{path:a,steps:r}}function C5(t){return t.every((e,a)=>e===a)}function z5(t,e){const a=[];for(let r=0;r<t.length;++r)(t[r].length===0||t[r].indexOf(e)!==-1||e===-1)&&a.push(r);return a}function j5(t,e,a=0){let r=[];if(typeof e=="number")E(t.shape[a]%e===0,()=>"Number of splits must evenly divide the axis."),r=new Array(e).fill(t.shape[a]/e);else{const i=e.reduce((c,f)=>(f===-1&&(c+=1),c),0);E(i<=1,()=>"There should be only one negative value in split array.");const l=e.indexOf(-1);if(l!==-1){const c=e.reduce((f,h)=>h>0?f+h:f);e[l]=t.shape[a]-c}E(t.shape[a]===e.reduce((c,f)=>c+f),()=>"The sum of sizes must match the size of the axis dimension."),r=e}return r}/**
 * @license
 * Copyright 2021 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
 ...
 */function M5(t){return`Received SparseTensor with denseShape[0] = 0 but
  indices.shape[0] = ${t}`}function L5(t,e){return`indices(${t}, 0) is invalid: ${e} < 0`}function I5(t,e,a){return`indices(${t}, 0) is invalid: ${e} >= ${a}`}/**
 * @license
 * Copyright 2021 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
 ...
 * limitations under the License.
 * =============================================================================
 */function B5(t,e){return`only one output dimension may be -1, not both ${t} and ${e}`}function U5(t,e){return`size ${t} must be non-negative, not ${e}`}function q5(){return"reshape cannot infer the missing input size for an empty tensor unless all specified input sizes are non-zero"}function F5(t,e){const a=Ue(t),r=Ue(e);return`Input to reshape is a SparseTensor with ${a}
  dense values, but the requested shape requires a multiple of ${r}. inputShape=${t} outputShape= ${e}`}function V5(t,e){const a=Ue(t),r=Ue(e);return`Input to reshape is a tensor with ${a} dense values, but the requested shape has ${r}. inputShape=${t} outputShape=${e}`}/**
 * @license
 * Copyright 2021 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
 ...
 * limitations under the License.
 * =============================================================================
 */function H5(){return"segment ids must be >= 0"}function G5(){return"segment ids are not increasing"}function K5(t,e){return`Segment id ${t} out of range [0, ${e}), possibly because segmentIds input is not sorted.`}function Y5(t,e,a){return`Bad: indices[${t}] == ${e} out of range [0, ${a})`}/**
 * @license
 * Copyright 2018 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
 ...
 * limitations under the License.
 * =============================================================================
 */function P5(t,e){let a=!1,r;for(t<=ap?(r=t,a=!0):r=Kl(t,Math.floor(Math.sqrt(t)));!a;)r>e||r===t?a=!0:r=Kl(t,r+1);return r}function X5(t,e,a){const r=[],i=t.length;for(let l=0;l<i;l++)l!==e?r.push(t[l]):r.push(a);return r}function Z5(t,e,a,r){const i=e.shape.length,l=t.shape.length;if(r!==0&&(r<-i||r>i))throw new Error(`Expect batchDims in the range of [-${i}, ${i}], but got ${r}`);if(r<0&&(r+=i),r>l)throw new Error(`batchDims (${r}) must be less than rank(x) (
    ${l}).`);if(a<r)throw new Error(`batchDims (${r}) must be less than or equal to axis (${a}).`);for(let y=0;y<r;++y)if(t.shape[y]!==e.shape[y])throw new Error(`x.shape[${y}]: ${t.shape[y]} should be equal to indices.shape[${y}]: ${e.shape[y]}.`);const c=t.shape[a],f=[];let h=1,p=1,g=1;for(let y=0;y<r;++y)f.push(t.shape[y]),h*=t.shape[y];for(let y=r;y<a;y++)f.push(t.shape[y]),p*=t.shape[y];for(let y=r;y<i;y++)f.push(e.shape[y]);for(let y=a+1;y<l;y++)f.push(t.shape[y]),g*=t.shape[y];return{batchSize:h,sliceSize:g,outerSize:p,dimSize:c,outputShape:f}}const W5=Object.freeze(Object.defineProperty({__proto__:null,collectGatherOpShapeInfo:Z5,computeOutShape:X5,segOpComputeOptimalWindowSize:P5},Symbol.toStringTag,{value:"Module"}));/**
 * @license
 * Copyright 2018 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
 ...
 * limitations under the License.
 * =============================================================================
 */function Q5(t){try{return t.map(e=>Pl(e))}catch(e){throw new Error(`Failed to decode encoded string bytes into utf-8, error: ${e}`)}}function J5(t){return t.map(e=>so(e))}const eR=Object.freeze(Object.defineProperty({__proto__:null,ERF_A1:m5,ERF_A2:g5,ERF_A3:y5,ERF_A4:b5,ERF_A5:v5,ERF_P:p5,PARALLELIZE_THRESHOLD:ap,get RowPartitionType(){return $n},SELU_SCALE:d5,SELU_SCALEALPHA:h5,applyActivation:Su,assertAndGetBroadcastShape:it,assertAxesAreInnerMostDims:gA,assertParamsConsistent:J6,assignToTypedArray:E5,axesAreInnerMostDims:md,calculateShapes:kS,checkEinsumDimSizes:D5,checkPadOnDimRoundingMode:pn,combineLocations:ww,combineRaggedTensorToTensorShapes:t5,complexWithEvenIndex:N5,complexWithOddIndex:x5,computeConv2DInfo:io,computeConv3DInfo:qv,computeDefaultPad:ld,computeDilation2DInfo:f_,computeOptimalWindowSize:r5,computeOutAndReduceShapes:mA,computeOutShape:e5,computePool2DInfo:Uv,computePool3DInfo:h_,convertConv2DDataFormat:Fv,decodeEinsumEquation:O5,eitherStridesOrDilationsAreOne:sa,expandShapeToKeepDim:uo,exponent:_5,exponents:k5,fromStringArrayToUint8:J5,fromUint8ToStringArray:Q5,getAxesPermutation:yA,getBroadcastDims:mw,getComplexWithIndex:T5,getEinsumComputePath:R5,getEinsumPermutation:$5,getFusedBiasGradient:wu,getFusedDyActivation:vu,getImageCenter:i5,getInnerMostAxes:vA,getPermuted:l5,getRaggedRank:a5,getReductionAxes:hd,getReshaped:o5,getReshapedPermuted:u5,getRowPartitionTypesHelper:n5,getSliceBeginCoords:c5,getSliceSize:f5,getSparseFillEmptyRowsIndicesDenseShapeMismatch:M5,getSparseFillEmptyRowsNegativeIndexErrorMessage:L5,getSparseFillEmptyRowsOutOfRangeIndexErrorMessage:I5,getSparseReshapeEmptyTensorZeroOutputDimErrorMessage:q5,getSparseReshapeInputOutputMismatchErrorMessage:V5,getSparseReshapeInputOutputMultipleErrorMessage:F5,getSparseReshapeMultipleNegativeOneOutputDimErrorMessage:B5,getSparseReshapeNegativeOutputDimErrorMessage:U5,getSparseSegmentReductionIndicesOutOfRangeErrorMessage:Y5,getSparseSegmentReductionNegativeSegmentIdsErrorMessage:H5,getSparseSegmentReductionNonIncreasingSegmentIdsErrorMessage:G5,getSparseSegmentReductionSegmentIdOutOfRangeErrorMessage:K5,getUndoAxesPermutation:bA,isIdentityPermutation:C5,log:h3,mergeRealAndImagArrays:w5,prepareAndValidate:uN,prepareSplitSize:j5,segment_util:W5,shouldFuse:Nu,slice_util:bN,splitRealAndImagArrays:S5,stridesOrDilationsArePositive:Ts,tupleValuesAreOne:Xi,upcastType:uu,validateDefaultValueShape:s5,validateInput:yu,validateUpdateShape:Vd,warn:Da},Symbol.toStringTag,{value:"Module"}));/**
 * @license
 * Copyright 2020 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
 ...
 * limitations under the License.
 * =============================================================================
 */const tR=Object.freeze(Object.defineProperty({__proto__:null,nonMaxSuppressionV3Impl:GS,nonMaxSuppressionV4Impl:KS,nonMaxSuppressionV5Impl:YS,whereImpl:zS},Symbol.toStringTag,{value:"Module"}));/**
 * @license
 * Copyright 2017 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
 ...
 * limitations under the License.
 * =============================================================================
 */l6();const nR=Object.freeze(Object.defineProperty({__proto__:null,Abs:fb,Acos:hb,Acosh:db,AdadeltaOptimizer:Pd,AdagradOptimizer:Xd,AdamOptimizer:Zd,AdamaxOptimizer:Wd,Add:Xh,AddN:pb,All:mb,Any:gb,ArgMax:yb,ArgMin:bb,Asin:vb,Asinh:wb,Atan:Sb,Atan2:xb,Atanh:Nb,AvgPool:Tb,AvgPool3D:Eb,AvgPool3DGrad:PE,AvgPoolGrad:YE,BatchMatMul:kb,BatchToSpaceND:_b,Bincount:Ab,BitwiseAnd:Ob,BroadcastArgs:$b,BroadcastTo:XE,Cast:Zh,Ceil:Db,ClipByValue:Rb,Complex:Cb,ComplexAbs:zb,Concat:jb,Conv2D:Mb,Conv2DBackpropFilter:Lb,Conv2DBackpropInput:Ib,Conv3D:Bb,Conv3DBackpropFilterV2:ZE,Conv3DBackpropInputV2:Ub,Cos:qb,Cosh:Fb,CropAndResize:Gb,Cumprod:Vb,Cumsum:Hb,DataStorage:EE,DenseBincount:Kb,DepthToSpace:Yb,DepthwiseConv2dNative:Pb,DepthwiseConv2dNativeBackpropFilter:Xb,DepthwiseConv2dNativeBackpropInput:Zb,Diag:Wb,Dilation2D:Qb,Dilation2DBackpropFilter:QE,Dilation2DBackpropInput:WE,Draw:Wh,get ENV(){return Yh},Einsum:e1,Elu:t1,EluGrad:JE,Environment:ub,Equal:a1,Erf:n1,Exp:s1,ExpandDims:r1,Expm1:i1,FFT:o1,Fill:l1,FlipLeftRight:u1,Floor:c1,FloorDiv:f1,FromPixels:ih,FusedBatchNorm:h1,FusedConv2D:lh,FusedDepthwiseConv2D:uh,GatherNd:p1,GatherV2:d1,Greater:m1,GreaterEqual:g1,IFFT:y1,Identity:Qh,Imag:b1,IsFinite:v1,IsInf:w1,IsNan:S1,KernelBackend:Q0,LRN:D1,LRNGrad:a3,LeakyRelu:N1,Less:x1,LessEqual:T1,LinSpace:E1,Log:k1,Log1p:_1,LogSoftmax:t3,LogicalAnd:A1,LogicalNot:O1,LogicalOr:$1,LogicalXor:e3,LowerBound:n3,MatrixBandPart:s3,Max:R1,MaxPool:z1,MaxPool3D:j1,MaxPool3DGrad:i3,MaxPoolGrad:r3,MaxPoolWithArgmax:M1,Maximum:C1,Mean:L1,Min:I1,Minimum:B1,MirrorPad:U1,Mod:q1,MomentumOptimizer:Qd,Multinomial:F1,Multiply:V1,Neg:H1,NonMaxSuppressionV3:K1,NonMaxSuppressionV4:Y1,NonMaxSuppressionV5:P1,NotEqual:G1,OP_SCOPE_SUFFIX:nd,OneHot:Z1,OnesLike:X1,Optimizer:Ka,OptimizerConstructors:vN,Pack:W1,PadV2:Q1,Pool:o3,Pow:J1,Prelu:e2,Prod:t2,RMSPropOptimizer:Jd,RaggedGather:n2,RaggedRange:a2,RaggedTensorToTensor:s2,Range:r2,get Rank(){return hh},Real:i2,RealDiv:Jb,Reciprocal:o2,get Reduction(){return Ot},Relu:l2,Relu6:h2,Reshape:u2,ResizeBilinear:f2,ResizeBilinearGrad:u3,ResizeNearestNeighbor:c2,ResizeNearestNeighborGrad:l3,Reverse:d2,RotateWithOffset:J2,Round:p2,Rsqrt:m2,SGDOptimizer:xu,ScatterNd:g2,SearchSorted:b2,Select:v2,Selu:w2,Sigmoid:E2,Sign:T2,Sin:N2,Sinh:x2,Slice:S2,Softmax:D2,Softplus:k2,SpaceToBatchND:O2,SparseFillEmptyRows:R2,SparseReshape:C2,SparseSegmentMean:z2,SparseSegmentSum:j2,SparseToDense:M2,SplitV:$2,Sqrt:_2,Square:c3,SquaredDifference:L2,StaticRegexReplace:I2,Step:Q2,StridedSlice:B2,StringNGrams:U2,StringSplit:q2,StringToHashBucketFast:F2,Sub:V2,Sum:A2,Tan:H2,Tanh:G2,Tensor:Je,TensorBuffer:Xl,TensorScatterUpdate:y2,Tile:Jh,TopK:K2,Transform:Y2,Transpose:Cl,Unique:P2,Unpack:X2,UnsortedSegmentSum:Z2,UpperBound:f3,Variable:Gi,ZerosLike:W2,_FusedMatMul:oh,abs:Vt,acos:Av,acosh:Ov,add:be,addN:$v,all:Dv,any:Rv,argMax:Cv,argMin:zv,asin:jv,asinh:Mv,atan:Lv,atan2:Iv,atanh:Bv,avgPool:ud,avgPool3d:Vv,backend:gv,backend_util:eR,basicLSTMCell:Hv,batchNorm:oo,batchNorm2d:Gv,batchNorm3d:Kv,batchNorm4d:Yv,batchToSpaceND:cd,bincount:fd,bitwiseAnd:Pv,booleanMaskAsync:jS,broadcastArgs:Xv,broadcastTo:Ui,broadcast_util:rA,browser:L6,buffer:Rn,cast:He,ceil:Zv,clipByValue:Wv,clone:ta,complex:aa,concat:Nt,concat1d:Qv,concat2d:Jv,concat3d:ew,concat4d:tw,conv1d:nw,conv2d:lo,conv2dTranspose:sw,conv3d:rw,conv3dTranspose:iw,copyRegisteredKernels:g3,cos:ow,cosh:lw,cosineWindow:bu,cumprod:uw,cumsum:cw,customGrad:zn,denseBincount:fw,deprecationWarn:J3,depthToSpace:hw,depthwiseConv2d:cu,device_util:Y3,diag:dw,dilation2d:pw,disableDeprecationWarnings:Q3,dispose:$t,disposeVariables:ek,div:Pe,divNoNan:gw,dot:yw,dropout:US,einsum:ms,elu:pd,enableDebugMode:W3,enableProdMode:Z3,enclosingPowerOfTwo:Gd,engine:tk,ensureShape:bw,env:ve,equal:dd,erf:vw,euclideanNorm:Nw,exp:qa,expandDims:Wn,expm1:xw,eye:gd,fft:mu,fill:Dr,findBackend:lk,findBackendFactory:uk,floor:yd,floorDiv:od,fused:FS,gather:bd,gatherND:BS,gather_util:I6,getBackend:mv,getGradient:ch,getKernel:Vi,getKernelsForBackend:Yl,grad:YA,grads:PA,greater:fo,greaterEqual:vd,ifft:Ji,imag:ho,image:Yd,inTopKAsync:qS,io:np,irfft:Bd,isFinite:Tw,isInf:Ew,isNaN:kw,keep:vn,kernel_impls:tR,leakyRelu:wd,less:Jl,lessEqual:fu,linalg:ZS,linspace:_w,localResponseNormalization:Aw,log:kr,log1p:Sd,logSigmoid:$w,logSoftmax:Dw,logSumExp:xd,logicalAnd:Zi,logicalNot:Td,logicalOr:Ed,logicalXor:Rw,losses:WS,lowerBound:Cw,matMul:Me,math:A6,max:ws,maxPool:kd,maxPool3d:zw,maxPoolWithArgmax:jw,maximum:_d,mean:Wi,memory:nk,meshgrid:Mw,min:Ql,minimum:Qi,mirrorPad:Lw,mod:Iw,moments:Bw,movingAverage:MS,mul:le,multiRNNCell:Uw,multinomial:qw,neg:Sn,nextFrame:Q6,norm:co,notEqual:Ad,oneHot:eu,ones:ja,onesLike:Fw,op:R,outerProduct:Vw,pad:Rr,pad1d:Hw,pad2d:Gw,pad3d:Kw,pad4d:Yw,pool:Pw,pow:Er,prelu:$d,print:id,prod:Xw,profile:ak,raggedGather:Zw,raggedRange:Ww,raggedTensorToTensor:Qw,rand:Jw,randomGamma:nS,randomNormal:jd,randomStandardNormal:aS,randomUniform:pu,randomUniformInt:sS,range:_r,ready:ik,real:Ar,reciprocal:rS,registerBackend:ck,registerGradient:d3,registerKernel:ev,relu:po,relu6:Md,removeBackend:ok,reshape:ee,reverse:Va,reverse1d:iS,reverse2d:oS,reverse3d:lS,reverse4d:uS,rfft:gu,round:Ld,rsqrt:cS,scalar:$e,scatterND:LS,scatter_util:QO,searchSorted:du,selu:fS,separableConv2d:hS,serialization:i6,setBackend:rk,setPlatform:fk,setdiff1dAsync:dS,sigmoid:vs,sign:pS,signal:XS,sin:mS,sinh:gS,slice:Be,slice1d:yS,slice2d:bS,slice3d:vS,slice4d:wS,slice_util:bN,softmax:Id,softplus:Nd,spaceToBatchND:Od,sparse:QS,sparseToDense:IS,spectral:PS,split:Or,sqrt:Cn,square:dn,squaredDifference:Ud,squeeze:mo,stack:jn,step:qd,stridedSlice:SS,string:JS,sub:Te,sum:Ye,sumOutType:I3,tan:NS,tanh:Wl,tensor:wn,tensor1d:tn,tensor2d:wr,tensor3d:Fd,tensor4d:xS,tensor5d:TS,tensor6d:ES,tensorScatterUpdate:_S,tensor_util:q3,test_util:fO,tidy:Ce,tile:vr,time:sk,topk:AS,train:Z6,transpose:eo,truncatedNormal:OS,unique:$S,unregisterGradient:m3,unregisterKernel:p3,unsortedSegmentSum:DS,unstack:Ga,upcastType:uu,upperBound:RS,util:_3,valueAndGrad:XA,valueAndGrads:ZA,variable:CS,variableGrads:Ow,version_core:X6,where:na,whereAsync:Hd,zeros:Fa,zerosLike:Ht},Symbol.toStringTag,{value:"Module"}));/**
 * @license
 * Copyright 2021 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
 ...
 * limitations under the License.
 * =============================================================================
 */const aR=ve();aR.registerFlag("KEEP_INTERMEDIATE_TENSORS",()=>!1,t=>{t&&console.warn("Keep intermediate tensors is ON. This will print the values of all intermediate tensors during model inference. Not all models support this mode. For details, check e2e/benchmarks/ model_config.js. This significantly impacts performance.")});/**
 * @license
 * Copyright 2019 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
 ...
 * limitations under the License.
 * =============================================================================
 */const sp={};function i7(t,e){const a={tfOpName:t,category:"custom",inputs:[],attrs:[],customExecutor:e};sp[t]=a}function wN(t){return sp[t]}function o7(t){delete sp[t]}/**
 * @license
 * Copyright 2018 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
 ...
 * limitations under the License.
 * =============================================================================
 */const iR=[{tfOpName:"Abs",category:"basic_math",inputs:[{start:0,name:"x",type:"tensor"}],attrs:[{tfName:"T",name:"dtype",type:"dtype",notSupported:!0}]},{tfOpName:"Acos",category:"basic_math",inputs:[{start:0,name:"x",type:"tensor"}],attrs:[{tfName:"T",name:"dtype",type:"dtype",notSupported:!0}]},{tfOpName:"Asin",category:"basic_math",inputs:[{start:0,name:"x",type:"tensor"}],attrs:[{tfName:"T",name:"dtype",type:"dtype",notSupported:!0}]},{tfOpName:"Atan",category:"basic_math",inputs:[{start:0,name:"x",type:"tensor"}],attrs:[{tfName:"T",name:"dtype",type:"dtype",notSupported:!0}]},{tfOpName:"Atan2",category:"basic_math",inputs:[{start:0,name:"x",type:"tensor"},{start:1,name:"y",type:"tensor"}],attrs:[{tfName:"T",name:"dtype",type:"dtype",notSupported:!0}]},{tfOpName:"Ceil",category:"basic_math",inputs:[{start:0,name:"x",type:"tensor"}],attrs:[{tfName:"T",name:"dtype",type:"dtype",notSupported:!0}]},{tfOpName:"ClipByValue",category:"basic_math",inputs:[{start:0,name:"x",type:"tensor"},{start:1,name:"clipValueMin",type:"number"},{start:2,name:"clipValueMax",type:"number"}],attrs:[{tfName:"T",name:"dtype",type:"dtype",notSupported:!0}]},{tfOpName:"Complex",category:"basic_math",inputs:[{start:0,name:"real",type:"tensor"},{start:1,name:"imag",type:"tensor"}],attrs:[{tfName:"T",name:"dtype",type:"dtype",notSupported:!0}]},{tfOpName:"ComplexAbs",category:"basic_math",inputs:[{start:0,name:"x",type:"tensor"}],attrs:[{tfName:"T",name:"dtype",type:"dtype",notSupported:!0}]},{tfOpName:"Cos",category:"basic_math",inputs:[{start:0,name:"x",type:"tensor"}],attrs:[{tfName:"T",name:"dtype",type:"dtype",notSupported:!0}]},{tfOpName:"Cosh",category:"basic_math",inputs:[{start:0,name:"x",type:"tensor"}],attrs:[{tfName:"T",name:"dtype",type:"dtype",notSupported:!0}]},{tfOpName:"Elu",category:"basic_math",inputs:[{start:0,name:"x",type:"tensor"}],attrs:[{tfName:"T",name:"dtype",type:"dtype",notSupported:!0}]},{tfOpName:"Exp",category:"basic_math",inputs:[{start:0,name:"x",type:"tensor"}],attrs:[{tfName:"T",name:"dtype",type:"dtype",notSupported:!0}]},{tfOpName:"Floor",category:"basic_math",inputs:[{start:0,name:"x",type:"tensor"}],attrs:[{tfName:"T",name:"dtype",type:"dtype",notSupported:!0}]},{tfOpName:"Log",category:"basic_math",inputs:[{start:0,name:"x",type:"tensor"}],attrs:[{tfName:"T",name:"dtype",type:"dtype",notSupported:!0}]},{tfOpName:"Imag",category:"basic_math",inputs:[{start:0,name:"x",type:"tensor"}],attrs:[{tfName:"T",name:"dtype",type:"dtype",notSupported:!0},{tfName:"Tout",name:"outputType",type:"dtype",notSupported:!0}]},{tfOpName:"Neg",category:"basic_math",inputs:[{start:0,name:"x",type:"tensor"}],attrs:[{tfName:"T",name:"dtype",type:"dtype",notSupported:!0}]},{tfOpName:"Real",category:"basic_math",inputs:[{start:0,name:"x",type:"tensor"}],attrs:[{tfName:"T",name:"dtype",type:"dtype",notSupported:!0},{tfName:"Tout",name:"outputType",type:"dtype",notSupported:!0}]},{tfOpName:"Prelu",category:"basic_math",inputs:[{start:0,name:"x",type:"tensor"},{start:1,name:"alpha",type:"tensor"}],attrs:[{tfName:"T",name:"dtype",type:"dtype",notSupported:!0}]},{tfOpName:"Relu",category:"basic_math",inputs:[{start:0,name:"x",type:"tensor"}],attrs:[{tfName:"T",name:"dtype",type:"dtype",notSupported:!0}]},{tfOpName:"Relu6",category:"basic_math",inputs:[{start:0,name:"x",type:"tensor"}],attrs:[{tfName:"T",name:"dtype",type:"dtype",notSupported:!0}]},{tfOpName:"Selu",category:"basic_math",inputs:[{start:0,name:"x",type:"tensor"}],attrs:[{tfName:"T",name:"dtype",type:"dtype",notSupported:!0}]},{tfOpName:"Sigmoid",category:"basic_math",inputs:[{start:0,name:"x",type:"tensor"}],attrs:[{tfName:"T",name:"dtype",type:"dtype",notSupported:!0}]},{tfOpName:"Sin",category:"basic_math",inputs:[{start:0,name:"x",type:"tensor"}],attrs:[{tfName:"T",name:"dtype",type:"dtype",notSupported:!0}]},{tfOpName:"Sinh",category:"basic_math",inputs:[{start:0,name:"x",type:"tensor"}],attrs:[{tfName:"T",name:"dtype",type:"dtype",notSupported:!0}]},{tfOpName:"Sqrt",category:"basic_math",inputs:[{start:0,name:"x",type:"tensor"}],attrs:[{tfName:"T",name:"dtype",type:"dtype",notSupported:!0}]},{tfOpName:"Rsqrt",category:"basic_math",inputs:[{start:0,name:"x",type:"tensor"}],attrs:[{tfName:"T",name:"dtype",type:"dtype",notSupported:!0}]},{tfOpName:"Square",category:"basic_math",inputs:[{start:0,name:"x",type:"tensor"}],attrs:[{tfName:"T",name:"dtype",type:"dtype",notSupported:!0}]},{tfOpName:"Tan",category:"basic_math",inputs:[{start:0,name:"x",type:"tensor"}],attrs:[{tfName:"T",name:"dtype",type:"dtype",notSupported:!0}]},{tfOpName:"Tanh",category:"basic_math",inputs:[{start:0,name:"x",type:"tensor"}],attrs:[{tfName:"T",name:"dtype",type:"dtype",notSupported:!0}]},{tfOpName:"Sign",category:"basic_math",inputs:[{start:0,name:"x",type:"tensor"}],attrs:[{tfName:"T",name:"dtype",type:"dtype",notSupported:!0}]},{tfOpName:"Round",category:"basic_math",inputs:[{start:0,name:"x",type:"tensor"}],attrs:[{tfName:"T",name:"dtype",type:"dtype",notSupported:!0}]},{tfOpName:"Expm1",category:"basic_math",inputs:[{start:0,name:"x",type:"tensor"}],attrs:[{tfName:"T",name:"dtype",type:"dtype",notSupported:!0}]},{tfOpName:"Log1p",category:"basic_math",inputs:[{start:0,name:"x",type:"tensor"}],attrs:[{tfName:"T",name:"dtype",type:"dtype",notSupported:!0}]},{tfOpName:"Reciprocal",category:"basic_math",inputs:[{start:0,name:"x",type:"tensor"}],attrs:[{tfName:"T",name:"dtype",type:"dtype",notSupported:!0}]},{tfOpName:"Softplus",category:"basic_math",inputs:[{start:0,name:"x",type:"tensor"}],attrs:[{tfName:"T",name:"dtype",type:"dtype",notSupported:!0}]},{tfOpName:"Asinh",category:"basic_math",inputs:[{start:0,name:"x",type:"tensor"}],attrs:[{tfName:"T",name:"dtype",type:"dtype",notSupported:!0}]},{tfOpName:"Acosh",category:"basic_math",inputs:[{start:0,name:"x",type:"tensor"}],attrs:[{tfName:"T",name:"dtype",type:"dtype",notSupported:!0}]},{tfOpName:"Atanh",category:"basic_math",inputs:[{start:0,name:"x",type:"tensor"}],attrs:[{tfName:"T",name:"dtype",type:"dtype",notSupported:!0}]},{tfOpName:"Erf",category:"basic_math",inputs:[{start:0,name:"x",type:"tensor"}],attrs:[{tfName:"T",name:"dtype",type:"dtype",notSupported:!0}]},{tfOpName:"LeakyRelu",category:"basic_math",inputs:[{start:0,name:"x",type:"tensor"}],attrs:[{tfName:"alpha",name:"alpha",type:"number",defaultValue:.2},{tfName:"T",name:"dtype",type:"dtype",notSupported:!0}]},{tfOpName:"IsNan",category:"basic_math",inputs:[{start:0,name:"x",type:"tensor"}],attrs:[{tfName:"T",name:"dtype",type:"dtype",notSupported:!0}]},{tfOpName:"IsFinite",category:"basic_math",inputs:[{start:0,name:"x",type:"tensor"}],attrs:[{tfName:"T",name:"dtype",type:"dtype",notSupported:!0}]},{tfOpName:"IsInf",category:"basic_math",inputs:[{start:0,name:"x",type:"tensor"}],attrs:[{tfName:"T",name:"dtype",type:"dtype",notSupported:!0}]}],oR=Object.freeze(Object.defineProperty({__proto__:null,json:iR},Symbol.toStringTag,{value:"Module"}));/**
 * @license
 * Copyright 2023 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
 ...
 * limitations under the License.
 * =============================================================================
 */const cR=[{tfOpName:"AvgPool",category:"convolution",inputs:[{start:0,name:"x",type:"tensor"}],attrs:[{tfName:"strides",name:"strides",type:"number[]"},{tfName:"padding",name:"pad",type:"string"},{tfName:"data_format",name:"dataFormat",type:"string",notSupported:!0},{tfName:"ksize",name:"kernelSize",type:"number[]"},{tfName:"T",name:"dtype",type:"dtype",notSupported:!0}]},{tfOpName:"MaxPool",category:"convolution",inputs:[{start:0,name:"x",type:"tensor"}],attrs:[{tfName:"strides",name:"strides",type:"number[]"},{tfName:"padding",name:"pad",type:"string"},{tfName:"data_format",name:"dataFormat",type:"string",notSupported:!0},{tfName:"ksize",name:"kernelSize",type:"number[]"},{tfName:"explicit_paddings",name:"explicitPaddings",type:"number[]",defaultValue:[],notSupported:!0},{tfName:"T",name:"dtype",type:"dtype",notSupported:!0}]},{tfOpName:"MaxPoolWithArgmax",category:"convolution",inputs:[{start:0,name:"x",type:"tensor"}],attrs:[{tfName:"strides",name:"strides",type:"number[]"},{tfName:"padding",name:"pad",type:"string"},{tfName:"ksize",name:"kernelSize",type:"number[]"},{tfName:"include_batch_in_index",name:"includeBatchInIndex",type:"bool"},{tfName:"T",name:"dtype",type:"dtype",notSupported:!0}]},{tfOpName:"AvgPool3D",category:"convolution",inputs:[{start:0,name:"x",type:"tensor"}],attrs:[{tfName:"strides",name:"strides",type:"number[]"},{tfName:"padding",name:"pad",type:"string"},{tfName:"data_format",name:"dataFormat",type:"string",notSupported:!0},{tfName:"ksize",name:"kernelSize",type:"number[]"},{tfName:"T",name:"dtype",type:"dtype",notSupported:!0}]},{tfOpName:"MaxPool3D",category:"convolution",inputs:[{start:0,name:"x",type:"tensor"}],attrs:[{tfName:"strides",name:"strides",type:"number[]"},{tfName:"padding",name:"pad",type:"string"},{tfName:"data_format",name:"dataFormat",type:"string",notSupported:!0},{tfName:"ksize",name:"kernelSize",type:"number[]"},{tfName:"T",name:"dtype",type:"dtype",notSupported:!0}]},{tfOpName:"Conv1D",category:"convolution",inputs:[{start:0,name:"x",type:"tensor"},{start:1,name:"filter",type:"tensor"}],attrs:[{tfName:"stride",name:"stride",type:"number"},{tfName:"padding",name:"pad",type:"string"},{tfName:"data_format",name:"dataFormat",type:"string",defaultValue:"NWC"},{tfName:"T",name:"dtype",type:"dtype",notSupported:!0},{tfName:"dilation",name:"dilation",type:"number",defaultValue:1}]},{tfOpName:"Conv2D",category:"convolution",inputs:[{start:0,name:"x",type:"tensor"},{start:1,name:"filter",type:"tensor"}],attrs:[{tfName:"T",name:"dtype",type:"dtype",notSupported:!0},{tfName:"strides",name:"strides",type:"number[]"},{tfName:"padding",name:"pad",type:"string"},{tfName:"useCudnnOnGpu",name:"useCudnnOnGpu",type:"bool"},{tfName:"data_format",name:"dataFormat",type:"string",defaultValue:"NHWC"},{tfName:"explicit_paddings",name:"explicitPaddings",type:"number[]",defaultValue:[]},{tfName:"dilations",name:"dilations",type:"number[]"}]},{tfOpName:"_FusedConv2D",category:"convolution",inputs:[{start:0,name:"x",type:"tensor"},{start:1,name:"filter",type:"tensor"},{start:2,end:0,name:"args",type:"tensors"}],attrs:[{tfName:"num_args",name:"numArgs",type:"number"},{tfName:"T",name:"dtype",type:"dtype",notSupported:!0},{tfName:"strides",name:"strides",type:"number[]"},{tfName:"padding",name:"pad",type:"string"},{tfName:"explicit_paddings",name:"explicitPaddings",type:"number[]",defaultValue:[]},{tfName:"use_cudnn_on_gpu",name:"useCudnnOnGpu",type:"bool",defaultValue:!0},{tfName:"data_format",name:"dataFormat",type:"string",defaultValue:"NHWC"},{tfName:"dilations",name:"dilations",type:"number[]",defaultValue:[1,1,1,1]},{tfName:"fused_ops",name:"fusedOps",type:"string[]",defaultValue:[]},{tfName:"epsilon",name:"epsilon",type:"number",defaultValue:1e-4},{tfName:"leakyrelu_alpha",name:"leakyreluAlpha",type:"number",defaultValue:.2}]},{tfOpName:"Conv2DBackpropInput",category:"convolution",inputs:[{start:2,name:"x",type:"tensor"},{start:1,name:"filter",type:"tensor"},{start:0,name:"outputShape",type:"number[]"}],attrs:[{tfName:"strides",name:"strides",type:"number[]"},{tfName:"padding",name:"pad",type:"string"},{tfName:"data_format",name:"dataFormat",type:"string",notSupported:!0},{tfName:"explicit_paddings",name:"explicitPaddings",type:"number[]",defaultValue:[]},{tfName:"dilations",name:"dilations",type:"number[]",notSupported:!0}]},{tfOpName:"DepthwiseConv2d",category:"convolution",inputs:[{start:0,name:"input",type:"tensor"},{start:1,name:"filter",type:"tensor"}],attrs:[{tfName:"strides",name:"strides",type:"number[]"},{tfName:"padding",name:"pad",type:"string"},{tfName:"data_format",name:"dataFormat",type:"string",defaultValue:"NHWC"},{tfName:"explicit_paddings",name:"explicitPaddings",type:"number[]",defaultValue:[]},{tfName:"dilations",name:"dilations",type:"number[]"}]},{tfOpName:"DepthwiseConv2dNative",category:"convolution",inputs:[{start:0,name:"input",type:"tensor"},{start:1,name:"filter",type:"tensor"}],attrs:[{tfName:"strides",name:"strides",type:"number[]"},{tfName:"padding",name:"pad",type:"string"},{tfName:"data_format",name:"dataFormat",type:"string",defaultValue:"NHWC"},{tfName:"explicit_paddings",name:"explicitPaddings",type:"number[]",defaultValue:[]},{tfName:"dilations",name:"dilations",type:"number[]"}]},{tfOpName:"FusedDepthwiseConv2dNative",category:"convolution",inputs:[{start:0,name:"x",type:"tensor"},{start:1,name:"filter",type:"tensor"},{start:2,end:0,name:"args",type:"tensors"}],attrs:[{tfName:"num_args",name:"numArgs",type:"number"},{tfName:"T",name:"dtype",type:"dtype",notSupported:!0},{tfName:"strides",name:"strides",type:"number[]"},{tfName:"padding",name:"pad",type:"string"},{tfName:"data_format",name:"dataFormat",type:"string",defaultValue:"NHWC"},{tfName:"dilations",name:"dilations",type:"number[]",defaultValue:[1,1,1,1]},{tfName:"fused_ops",name:"fusedOps",type:"string[]",defaultValue:[]},{tfName:"explicit_paddings",name:"explicitPaddings",type:"number[]",defaultValue:[]}]},{tfOpName:"Conv3D",category:"convolution",inputs:[{start:0,name:"x",type:"tensor"},{start:1,name:"filter",type:"tensor"}],attrs:[{tfName:"strides",name:"strides",type:"number[]"},{tfName:"padding",name:"pad",type:"string"},{tfName:"data_format",name:"dataFormat",type:"string",defaultValue:"NHWC"},{tfName:"dilations",name:"dilations",type:"number[]"}]},{tfOpName:"Dilation2D",category:"convolution",inputs:[{start:0,name:"x",type:"tensor"},{start:1,name:"filter",type:"tensor"}],attrs:[{tfName:"strides",name:"strides",type:"number[]"},{tfName:"rates",name:"dilations",type:"number[]"},{tfName:"padding",name:"pad",type:"string"}]}],fR=Object.freeze(Object.defineProperty({__proto__:null,json:cR},Symbol.toStringTag,{value:"Module"}));/**
 * @license
 * Copyright 2023 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
 ...
 * limitations under the License.
 * =============================================================================
 */const pR=[{tfOpName:"NonMaxSuppressionV2",category:"dynamic",inputs:[{start:0,name:"boxes",type:"tensor"},{start:1,name:"scores",type:"tensor"},{start:2,name:"maxOutputSize",type:"number"},{start:3,name:"iouThreshold",type:"number"}]},{tfOpName:"NonMaxSuppressionV3",category:"dynamic",inputs:[{start:0,name:"boxes",type:"tensor"},{start:1,name:"scores",type:"tensor"},{start:2,name:"maxOutputSize",type:"number"},{start:3,name:"iouThreshold",type:"number"},{start:4,name:"scoreThreshold",type:"number"}]},{tfOpName:"NonMaxSuppressionV4",category:"dynamic",inputs:[{start:0,name:"boxes",type:"tensor"},{start:1,name:"scores",type:"tensor"},{start:2,name:"maxOutputSize",type:"number"},{start:3,name:"iouThreshold",type:"number"},{start:4,name:"scoreThreshold",type:"number"}],attrs:[{tfName:"T",name:"dtype",type:"dtype",notSupported:!0},{tfName:"T_threshold",name:"threshold",type:"dtype",notSupported:!0},{tfName:"pad_to_max_output_size",name:"padToMaxOutputSize",type:"bool"}]},{tfOpName:"NonMaxSuppressionV5",category:"dynamic",inputs:[{start:0,name:"boxes",type:"tensor"},{start:1,name:"scores",type:"tensor"},{start:2,name:"maxOutputSize",type:"number"},{start:3,name:"iouThreshold",type:"number"},{start:4,name:"scoreThreshold",type:"number"},{start:5,name:"softNmsSigma",type:"number"}]},{tfOpName:"Where",category:"dynamic",inputs:[{start:0,name:"condition",type:"tensor"}],attrs:[{tfName:"T",name:"dtype",type:"dtype",notSupported:!0}]},{tfOpName:"ListDiff",category:"dynamic",inputs:[{start:0,name:"x",type:"tensor"},{start:1,name:"y",type:"tensor"}],attrs:[{tfName:"T",name:"dtype",type:"dtype",notSupported:!0}]}],mR=Object.freeze(Object.defineProperty({__proto__:null,json:pR},Symbol.toStringTag,{value:"Module"}));/**
 * @license
 * Copyright 2023 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
 ...
 * limitations under the License.
 * =============================================================================
 */const gR=[{tfOpName:"LowerBound",category:"evaluation",inputs:[{start:0,name:"sortedSequence",type:"tensor"},{start:1,name:"values",type:"tensor"}]},{tfOpName:"TopKV2",category:"evaluation",inputs:[{start:0,name:"x",type:"tensor"},{start:1,name:"k",type:"number"}],attrs:[{tfName:"sorted",name:"sorted",type:"bool"}]},{tfOpName:"UpperBound",category:"evaluation",inputs:[{start:0,name:"sortedSequence",type:"tensor"},{start:1,name:"values",type:"tensor"}]},{tfOpName:"Unique",category:"evaluation",inputs:[{start:0,name:"x",type:"tensor"}]},{tfOpName:"UniqueV2",category:"evaluation",inputs:[{start:0,name:"x",type:"tensor"},{start:1,name:"axis",type:"number"}]}],yR=Object.freeze(Object.defineProperty({__proto__:null,json:gR},Symbol.toStringTag,{value:"Module"}));/**
 * @license
 * Copyright 2023 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
 ...
 * limitations under the License.
 * =============================================================================
 */const bR=[{tfOpName:"PlaceholderWithDefault",category:"graph",inputs:[{start:0,name:"default",type:"tensor"}],attrs:[{tfName:"shape",name:"shape",type:"shape"},{tfName:"dtype",name:"dtype",type:"dtype"}]},{tfOpName:"Placeholder",category:"graph",attrs:[{tfName:"shape",name:"shape",type:"shape"},{tfName:"dtype",name:"dtype",type:"dtype"}]},{tfOpName:"Const",category:"graph"},{tfOpName:"Identity",category:"graph",inputs:[{start:0,name:"x",type:"tensor"}]},{tfOpName:"IdentityN",category:"graph",inputs:[{start:0,end:0,name:"x",type:"tensors"}]},{tfOpName:"Snapshot",category:"graph",inputs:[{start:0,name:"x",type:"tensor"}]},{tfOpName:"Rank",category:"graph",inputs:[{start:0,name:"x",type:"tensor"}]},{tfOpName:"Size",category:"graph",inputs:[{start:0,name:"x",type:"tensor"}]},{tfOpName:"Shape",category:"graph",inputs:[{start:0,name:"x",type:"tensor"}]},{tfOpName:"ShapeN",category:"graph",inputs:[{start:0,end:0,name:"x",type:"tensors"}]},{tfOpName:"Print",category:"graph",inputs:[{start:0,name:"x",type:"tensor"},{start:1,name:"data",type:"tensors"}],attrs:[{tfName:"message",name:"message",type:"string"},{tfName:"first_n",name:"firstN",type:"number",notSupported:!0},{tfName:"summarize",name:"summarize",type:"number",defaultValue:3}]},{tfOpName:"NoOp",category:"graph",inputs:[]},{tfOpName:"StopGradient",category:"graph",inputs:[{start:0,name:"x",type:"tensor"}]},{tfOpName:"FakeQuantWithMinMaxVars",category:"graph",inputs:[{start:0,name:"x",type:"tensor"}],attrs:[{tfName:"min",name:"min",type:"number"},{tfName:"max",name:"max",type:"number"}]}],vR=Object.freeze(Object.defineProperty({__proto__:null,json:bR},Symbol.toStringTag,{value:"Module"}));/**
 * @license
 * Copyright 2023 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
 ...
 * limitations under the License.
 * =============================================================================
 */const NR=[{tfOpName:"ResizeBilinear",category:"image",inputs:[{start:0,name:"images",type:"tensor"},{start:1,name:"size",type:"number[]"}],attrs:[{tfName:"align_corners",name:"alignCorners",type:"bool"},{tfName:"half_pixel_centers",name:"halfPixelCenters",type:"bool"},{tfName:"T",name:"dtype",type:"dtype",notSupported:!0}]},{tfOpName:"ResizeNearestNeighbor",category:"image",inputs:[{start:0,name:"images",type:"tensor"},{start:1,name:"size",type:"number[]"}],attrs:[{tfName:"align_corners",name:"alignCorners",type:"bool"},{tfName:"half_pixel_centers",name:"halfPixelCenters",type:"bool"},{tfName:"T",name:"dtype",type:"dtype",notSupported:!0}]},{tfOpName:"CropAndResize",category:"image",inputs:[{start:0,name:"image",type:"tensor"},{start:1,name:"boxes",type:"tensor"},{start:2,name:"boxInd",type:"tensor"},{start:3,name:"cropSize",type:"number[]"}],attrs:[{tfName:"method",name:"method",type:"string"},{tfName:"extrapolation_value",name:"extrapolationValue",type:"number"}]},{tfOpName:"ImageProjectiveTransformV3",category:"image",inputs:[{start:0,name:"images",type:"tensor"},{start:1,name:"transforms",type:"tensor"},{start:2,name:"outputShape",type:"number[]"},{start:3,name:"fillValue",type:"number"}],attrs:[{tfName:"interpolation",name:"interpolation",type:"string"},{tfName:"fill_mode",name:"fillMode",type:"string"}]}],xR=Object.freeze(Object.defineProperty({__proto__:null,json:NR},Symbol.toStringTag,{value:"Module"}));/**
 * @license
 * Copyright 2023 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
 ...
 * limitations under the License.
 * =============================================================================
 */const TR=[{tfOpName:"Equal",category:"logical",inputs:[{start:0,name:"a",type:"tensor"},{start:1,name:"b",type:"tensor"}],attrs:[{tfName:"T",name:"dtype",type:"dtype",notSupported:!0}]},{tfOpName:"NotEqual",category:"logical",inputs:[{start:0,name:"a",type:"tensor"},{start:1,name:"b",type:"tensor"}],attrs:[{tfName:"T",name:"dtype",type:"dtype",notSupported:!0}]},{tfOpName:"Greater",category:"logical",inputs:[{start:0,name:"a",type:"tensor"},{start:1,name:"b",type:"tensor"}],attrs:[{tfName:"T",name:"dtype",type:"dtype",notSupported:!0}]},{tfOpName:"GreaterEqual",category:"logical",inputs:[{start:0,name:"a",type:"tensor"},{start:1,name:"b",type:"tensor"}],attrs:[{tfName:"T",name:"dtype",type:"dtype",notSupported:!0}]},{tfOpName:"Less",category:"logical",inputs:[{start:0,name:"a",type:"tensor"},{start:1,name:"b",type:"tensor"}],attrs:[{tfName:"T",name:"dtype",type:"dtype",notSupported:!0}]},{tfOpName:"LessEqual",category:"logical",inputs:[{start:0,name:"a",type:"tensor"},{start:1,name:"b",type:"tensor"}],attrs:[{tfName:"T",name:"dtype",type:"dtype",notSupported:!0}]},{tfOpName:"LogicalAnd",category:"logical",inputs:[{start:0,name:"a",type:"tensor"},{start:1,name:"b",type:"tensor"}],attrs:[{tfName:"T",name:"dtype",type:"dtype",notSupported:!0}]},{tfOpName:"LogicalNot",category:"logical",inputs:[{start:0,name:"a",type:"tensor"}],attrs:[{tfName:"T",name:"dtype",type:"dtype",notSupported:!0}]},{tfOpName:"LogicalOr",category:"logical",inputs:[{start:0,name:"a",type:"tensor"},{start:1,name:"b",type:"tensor"}],attrs:[{tfName:"T",name:"dtype",type:"dtype",notSupported:!0}]},{tfOpName:"Select",category:"logical",inputs:[{start:0,name:"condition",type:"tensor"},{start:1,name:"a",type:"tensor"},{start:2,name:"b",type:"tensor"}],attrs:[{tfName:"T",name:"dtype",type:"dtype",notSupported:!0}]},{tfOpName:"SelectV2",category:"logical",inputs:[{start:0,name:"condition",type:"tensor"},{start:1,name:"a",type:"tensor"},{start:2,name:"b",type:"tensor"}],attrs:[{tfName:"T",name:"dtype",type:"dtype",notSupported:!0}]},{tfOpName:"BitwiseAnd",category:"logical",inputs:[{start:0,name:"x",type:"tensor"},{start:1,name:"y",type:"tensor"}]}],ER=Object.freeze(Object.defineProperty({__proto__:null,json:TR},Symbol.toStringTag,{value:"Module"}));/**
 * @license
 * Copyright 2023 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
 ...
 * limitations under the License.
 * =============================================================================
 */const MR=[{tfOpName:"FFT",category:"spectral",inputs:[{start:0,name:"x",type:"tensor"}]},{tfOpName:"IFFT",category:"spectral",inputs:[{start:0,name:"x",type:"tensor"}]},{tfOpName:"RFFT",category:"spectral",inputs:[{start:0,name:"x",type:"tensor"},{start:1,name:"fft_length",type:"number",notSupported:!0}]},{tfOpName:"IRFFT",category:"spectral",inputs:[{start:0,name:"x",type:"tensor"},{start:1,name:"fft_length",type:"number",notSupported:!0}]}],LR=Object.freeze(Object.defineProperty({__proto__:null,json:MR},Symbol.toStringTag,{value:"Module"}));/**
 * @license
 * Copyright 2023 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
 ...
 * limitations under the License.
 * =============================================================================
 */const UR=[{tfOpName:"Cast",category:"transformation",inputs:[{start:0,name:"x",type:"tensor"}],attrs:[{tfName:"SrcT",name:"sdtype",type:"dtype",notSupported:!0},{tfName:"DstT",name:"dtype",type:"dtype"}]},{tfOpName:"ExpandDims",category:"transformation",inputs:[{start:0,name:"x",type:"tensor"},{start:1,name:"axis",type:"number"}]},{tfOpName:"MirrorPad",category:"transformation",inputs:[{start:0,name:"x",type:"tensor"},{start:1,name:"padding",type:"number[]"}],attrs:[{tfName:"mode",name:"mode",type:"string"}]},{tfOpName:"Pad",category:"transformation",inputs:[{start:0,name:"x",type:"tensor"},{start:1,name:"padding",type:"number[]"}],attrs:[{tfName:"constant_value",name:"constantValue",type:"number",defaultValue:0}]},{tfOpName:"PadV2",category:"transformation",inputs:[{start:0,name:"x",type:"tensor"},{start:1,name:"padding",type:"number[]"},{start:2,name:"constantValue",type:"number",defaultValue:0}]},{tfOpName:"Reshape",category:"transformation",inputs:[{start:0,name:"x",type:"tensor"},{start:1,name:"shape",type:"number[]"}]},{tfOpName:"EnsureShape",category:"transformation",inputs:[{start:0,name:"x",type:"tensor"},{start:1,name:"shape",type:"number[]"}]},{tfOpName:"Squeeze",category:"transformation",inputs:[{start:0,name:"x",type:"tensor"}],attrs:[{tfName:"axis",tfDeprecatedName:"squeeze_dims",name:"axis",type:"number[]"}]},{tfOpName:"SpaceToBatchND",category:"transformation",inputs:[{start:0,name:"x",type:"tensor"},{start:1,name:"blockShape",type:"number[]"},{start:2,name:"paddings",type:"number[]"}]},{tfOpName:"BatchToSpaceND",category:"transformation",inputs:[{start:0,name:"x",type:"tensor"},{start:1,name:"blockShape",type:"number[]"},{start:2,name:"crops",type:"number[]"}]},{tfOpName:"DepthToSpace",category:"transformation",inputs:[{start:0,name:"x",type:"tensor"}],attrs:[{tfName:"block_size",name:"blockSize",type:"number"},{tfName:"data_format",name:"dataFormat",type:"string"}]},{tfOpName:"BroadcastTo",category:"transformation",inputs:[{start:0,name:"x",type:"tensor"},{start:1,name:"shape",type:"number[]"}],attrs:[]},{tfOpName:"BroadcastArgs",category:"transformation",inputs:[{start:0,name:"s0",type:"tensor"},{start:1,name:"s1",type:"tensor"}],attrs:[]}],qR=Object.freeze(Object.defineProperty({__proto__:null,json:UR},Symbol.toStringTag,{value:"Module"}));/**
 * @license
 * Copyright 2018 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
 ...
 * limitations under the License.
 * =============================================================================
 */const HR=(t,e,a,r=bt)=>{switch(t.op){case"BiasAdd":case"AddV2":case"Add":return[r.add(b("a",t,e,a),b("b",t,e,a))];case"AddN":return[r.addN(b("tensors",t,e,a))];case"FloorMod":case"Mod":return[r.mod(b("a",t,e,a),b("b",t,e,a))];case"Mul":return[r.mul(b("a",t,e,a),b("b",t,e,a))];case"RealDiv":case"Div":return[r.div(b("a",t,e,a),b("b",t,e,a))];case"DivNoNan":return[r.divNoNan(b("a",t,e,a),b("b",t,e,a))];case"FloorDiv":return[r.floorDiv(b("a",t,e,a),b("b",t,e,a))];case"Sub":return[r.sub(b("a",t,e,a),b("b",t,e,a))];case"Minimum":return[r.minimum(b("a",t,e,a),b("b",t,e,a))];case"Maximum":return[r.maximum(b("a",t,e,a),b("b",t,e,a))];case"Pow":return[r.pow(b("a",t,e,a),b("b",t,e,a))];case"SquaredDifference":return[r.squaredDifference(b("a",t,e,a),b("b",t,e,a))];default:throw TypeError(`Node type ${t.op} is not implemented`)}};/**
 * @license
 * Copyright 2018 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
 ...
 */class KR{constructor(e,a,r,i,l,c,f){this.name=e,this.dtype=a,this.maxSize=r,this.elementShape=i,this.identicalElementShapes=l,this.dynamicSize=c,this.clearAfterRead=f,this.tensors=[],this.closed_=!1,this.idTensor=$e(0),vn(this.idTensor)}get id(){return this.idTensor.id}get closed(){return this.closed_}clearAndClose(e){this.tensors.forEach(a=>{(e==null||!e.has(a.tensor.id))&&a.tensor.dispose()}),this.tensors=[],this.closed_=!0,this.idTensor.dispose()}size(){return this.tensors.length}read(e){if(this.closed_)throw new Error(`TensorArray ${this.name} has already been closed.`);if(e<0||e>=this.size())throw new Error(`Tried to read from index ${e}, but array size is: ${this.size()}`);const a=this.tensors[e];if(a.cleared)throw new Error(`TensorArray ${this.name}: Could not read index ${e} twice because it was cleared after a previous read (perhaps try setting clear_after_read = false?).`);return this.clearAfterRead&&(a.cleared=!0),a.read=!0,a.tensor}readMany(e){return e.map(a=>this.read(a))}write(e,a){if(this.closed_)throw new Error(`TensorArray ${this.name} has already been closed.`);if(e<0||!this.dynamicSize&&e>=this.maxSize)throw new Error(`Tried to write to index ${e}, but array is not resizeable and size is: ${this.maxSize}`);const r=this.tensors[e]||{};if(a.dtype!==this.dtype)throw new Error(`TensorArray ${this.name}: Could not write to TensorArray index ${e},
        ...
        ${r}, and tensor's shape is: ${a.shape}`);if(!this.dynamicSize&&e.length!==this.maxSize)throw new Error(`TensorArray's size is not equal to the size of lengths (${this.maxSize} vs. ${e.length}), and the TensorArray is not marked as dynamically resizeable`);const l=r===0?0:a.size/r,c=[];Ce(()=>{a=ee(a,[1,r,l]);for(let h=0;h<e.length;++h){const g=[0,h===0?0:i[h-1],0],y=[1,e[h],l];c[h]=ee(Be(a,g,y),this.elementShape)}return c});const f=[];for(let h=0;h<e.length;h++)f[h]=h;this.writeMany(f,c)}}/**
 * @license
 * Copyright 2020 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
 ...
 * limitations under the License.
 * =============================================================================
 */const WR=async(t,e,a)=>{switch(t.op){case"If":case"StatelessIf":{const r=b("thenBranch",t,e,a),i=b("elseBranch",t,e,a),l=b("cond",t,e,a),c=b("args",t,e,a);return(await l.data())[0]?a.functionMap[r].executeFunctionAsync(c,a.tensorArrayMap,a.tensorListMap):a.functionMap[i].executeFunctionAsync(c,a.tensorArrayMap,a.tensorListMap)}case"While":case"StatelessWhile":{const r=b("body",t,e,a),i=b("cond",t,e,a),l=b("args",t,e,a),c=await a.functionMap[i].executeFunctionAsync(l,a.tensorArrayMap,a.tensorListMap),f=l.map(g=>g.id);let h=await c[0].data();c.forEach(g=>{!g.kept&&f.indexOf(g.id)===-1&&g.dispose()});let p=l;for(;h[0];){const g=p;p=await a.functionMap[r].executeFunctionAsync(p,a.tensorArrayMap,a.tensorListMap);const y=p.map(S=>S.id);g.forEach(S=>{!S.kept&&f.indexOf(S.id)===-1&&y.indexOf(S.id)===-1&&S.dispose()});const v=await a.functionMap[i].executeFunctionAsync(p,a.tensorArrayMap,a.tensorListMap);h=await v[0].data(),v.forEach(S=>{!S.kept&&f.indexOf(S.id)===-1&&y.indexOf(S.id)===-1&&S.dispose()})}return p}case"LoopCond":{const r=b("pred",t,e,a);return[Jn(r)]}case"Switch":{const r=b("pred",t,e,a);let i=b("data",t,e,a);return i.kept||(i=Jn(i)),(await r.data())[0]?[void 0,i]:[i,void 0]}case"Merge":{const r=t.inputNames.find(i=>yt(i,e,a)!==void 0);if(r){const i=yt(r,e,a);return[Jn(i)]}return}case"Enter":{const r=b("frameName",t,e,a),i=b("tensor",t,e,a);return a.enterFrame(r),[Jn(i)]}case"Exit":{const r=b("tensor",t,e,a);return a.exitFrame(),[Jn(r)]}case"NextIteration":{const r=b("tensor",t,e,a);return a.nextIteration(),[Jn(r)]}case"TensorArrayV3":{const r=b("size",t,e,a),i=b("dtype",t,e,a),l=b("elementShape",t,e,a),c=b("dynamicSize",t,e,a),f=b("clearAfterRead",t,e,a),h=b("identicalElementShapes",t,e,a),p=b("name",t,e,a),g=new KR(p,i,r,l,h,c,f);return a.addTensorArray(g),[g.idTensor,$e(1)]}case"TensorArrayWriteV3":{const r=b("tensorArrayId",t,e,a),i=b("index",t,e,a),l=b("tensor",t,e,a),c=a.getTensorArray(r.id);return c.write(i,l),[c.idTensor]}case"TensorArrayReadV3":{const r=b("tensorArrayId",t,e,a),i=b("index",t,e,a);return[a.getTensorArray(r.id).read(i)]}case"TensorArrayGatherV3":{const r=b("tensorArrayId",t,e,a),i=b("indices",t,e,a),l=b("dtype",t,e,a);return[a.getTensorArray(r.id).gather(i,l)]}case"TensorArrayScatterV3":{const r=b("tensorArrayId",t,e,a),i=b("indices",t,e,a),l=b("tensor",t,e,a),c=a.getTensorArray(r.id);return c.scatter(i,l),[c.idTensor]}case"TensorArrayConcatV3":{const r=b("tensorArrayId",t,e,a),i=a.getTensorArray(r.id),l=b("dtype",t,e,a);return[i.concat(l)]}case"TensorArraySplitV3":{const r=b("tensorArrayId",t,e,a),i=b("tensor",t,e,a),l=b("lengths",t,e,a),c=a.getTensorArray(r.id);return c.split(l,i),[c.idTensor]}case"TensorArraySizeV3":{const r=b("tensorArrayId",t,e,a),i=a.getTensorArray(r.id);return[$e(i.size(),"int32")]}case"TensorArrayCloseV3":{const r=b("tensorArrayId",t,e,a),i=a.getTensorArray(r.id);return i.clearAndClose(),[i.idTensor]}case"TensorListSetItem":{const r=b("tensorListId",t,e,a),i=b("index",t,e,a),l=b("tensor",t,e,a),c=a.getTensorList(r.id);return c.setItem(i,l),[c.idTensor]}case"TensorListGetItem":{const r=b("tensorListId",t,e,a),i=b("index",t,e,a),l=b("elementShape",t,e,a),c=b("elementDType",t,e,a);return[a.getTensorList(r.id).getItem(i,l,c)]}case"TensorListScatterV2":case"TensorListScatter":{const r=b("indices",t,e,a),i=b("tensor",t,e,a),l=b("elementShape",t,e,a),c=b("numElements",t,e,a),f=XR(i,r,l,c);return a.addTensorList(f),[f.idTensor]}case"TensorListReserve":case"EmptyTensorList":{const r=b("elementShape",t,e,a),i=b("elementDType",t,e,a);let l;t.op==="TensorListReserve"?l="numElements":l="maxNumElements";const c=b(l,t,e,a),f=t.op==="TensorListReserve"?-1:c,h=PR(r,i,c,f);return a.addTensorList(h),[h.idTensor]}case"TensorListGather":{const r=b("tensorListId",t,e,a),i=b("indices",t,e,a),l=b("elementShape",t,e,a),c=b("elementDType",t,e,a);return[a.getTensorList(r.id).gather(i,c,l)]}case"TensorListStack":{const r=b("tensorListId",t,e,a),i=b("elementShape",t,e,a),l=b("elementDType",t,e,a),c=b("numElements",t,e,a);return[a.getTensorList(r.id).stack(i,l,c)]}case"TensorListFromTensor":{const r=b("tensor",t,e,a),i=b("elementShape",t,e,a),l=b("elementDType",t,e,a),c=YR(r,i,l);return a.addTensorList(c),[c.idTensor]}case"TensorListConcat":case"TensorListConcatV2":{const r=b("tensorListId",t,e,a),i=a.getTensorList(r.id),l=b("dtype",t,e,a),c=b("elementShape",t,e,a);return[i.concat(l,c)]}case"TensorListPushBack":{const r=b("tensorListId",t,e,a),i=b("tensor",t,e,a),l=a.getTensorList(r.id);return l.pushBack(i),[l.idTensor]}case"TensorListPopBack":{const r=b("tensorListId",t,e,a),i=b("elementShape",t,e,a),l=b("elementDType",t,e,a);return[a.getTensorList(r.id).popBack(i,l)]}case"TensorListSplit":{const r=b("tensor",t,e,a),i=b("elementShape",t,e,a),l=b("lengths",t,e,a),c=ZR(r,l,i);return a.addTensorList(c),[c.idTensor]}case"TensorListLength":{const r=b("tensorListId",t,e,a),i=a.getTensorList(r.id);return[$e(i.size(),"int32")]}case"TensorListResize":{const r=b("tensorListId",t,e,a),i=b("size",t,e,a),c=a.getTensorList(r.id).resize(i);return a.addTensorList(c),[c.idTensor]}default:throw TypeError(`Node type ${t.op} is not implemented`)}};/**
 * @license
 * Copyright 2018 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
 ...
 * limitations under the License.
 * =============================================================================
 */const t8=(t,e,a,r=bt)=>{switch(t.op){case"LowerBound":{const i=b("sortedSequence",t,e,a),l=b("values",t,e,a);return[r.lowerBound(i,l)]}case"TopKV2":{const i=b("x",t,e,a),l=b("k",t,e,a),c=b("sorted",t,e,a),f=r.topk(i,l,c);return[f.values,f.indices]}case"UpperBound":{const i=b("sortedSequence",t,e,a),l=b("values",t,e,a);return[r.upperBound(i,l)]}case"Unique":{const i=b("x",t,e,a),l=r.unique(i);return[l.values,l.indices]}case"UniqueV2":{const i=b("x",t,e,a),l=b("axis",t,e,a),c=r.unique(i,l);return[c.values,c.indices]}default:throw TypeError(`Node type ${t.op} is not implemented`)}};/**
 * @license
 * Copyright 2018 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
 ...
 * limitations under the License.
 * =============================================================================
 */const d8=(t,e,a,r=bt)=>{switch(t.op){case"FFT":return[r.fft(b("x",t,e,a))];case"IFFT":return[r.ifft(b("x",t,e,a))];case"RFFT":return[r.rfft(b("x",t,e,a))];case"IRFFT":return[r.irfft(b("x",t,e,a))];default:throw TypeError(`Node type ${t.op} is not implemented`)}};/**
 * @license
 * Copyright 2021 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
 ...
 * limitations under the License.
 * =============================================================================
 */function q0(t,e,a,r,i=Ce){const l=((c,f,h)=>{switch(c.category){case"arithmetic":return i(()=>HR(c,f,h));case"basic_math":return i(()=>GR(c,f,h));case"control":return WR(c,f,h);case"convolution":return i(()=>QR(c,f,h));case"creation":return i(()=>JR(c,f,h));case"dynamic":return e8(c,f,h);case"evaluation":return i(()=>t8(c,f,h));case"image":return i(()=>r8(c,f,h));case"graph":return i(()=>n8(c,f,h));case"logical":return i(()=>i8(c,f,h));case"matrices":return i(()=>o8(c,f,h));case"normalization":return i(()=>l8(c,f,h));case"ragged":return i(()=>u8(c,f,h));case"reduction":return i(()=>c8(c,f,h));case"slice_join":return i(()=>f8(c,f,h));case"sparse":return i(()=>h8(c,f,h));case"spectral":return i(()=>d8(c,f,h));case"string":return i(()=>p8(c,f,h));case"transformation":return i(()=>m8(c,f,h));case"hash_table":return s8(c,f,h,r);case"custom":const p=wN(c.op);if(p&&p.customExecutor)return p.customExecutor(new VR(c,f,h));throw TypeError(`Custom op ${c.op} is not registered.`);default:throw TypeError(`Unknown op '${c.op}'. File an issue at https://github.com/tensorflow/tfjs/issues so we can add it, or register a custom execution with tf.registerOp()`)}})(t,e,a);return Ia(l)?l.then(c=>[].concat(c)):[].concat(l)}class F0{constructor(e={},a={},r={},i={},l){this.weightMap=e,this.tensorArrayMap=a,this.tensorListMap=r,this.functionMap=i,this.parseNodeNameCache=l,this.rootContext={id:0,frameName:"",iterationId:0},this.contexts=[this.rootContext],this.lastId=0,this.generateCurrentContextIds()}newFrame(e,a){return{id:e,frameName:a,iterationId:0}}set currentContext(e){this.contexts!==e&&(this.contexts=e,this.generateCurrentContextIds())}get currentContext(){return this.contexts}get currentContextId(){return this._currentContextIds[0]}get currentContextIds(){return this._currentContextIds}generateCurrentContextIds(){const e=[];for(let a=0;a<this.contexts.length-1;a++){const r=this.contexts.slice(0,this.contexts.length-a);e.push(this.contextIdforContexts(r))}e.push(""),this._currentContextIds=e}contextIdforContexts(e){return e?e.map(a=>a.id===0&&a.iterationId===0?"":`${a.frameName}-${a.iterationId}`).join("/"):""}enterFrame(e){this.contexts&&(this.lastId++,this.contexts=this.contexts.slice(),this.contexts.push(this.newFrame(this.lastId,e)),this._currentContextIds.unshift(this.contextIdforContexts(this.contexts)))}exitFrame(){if(this.contexts&&this.contexts.length>1)this.contexts=this.contexts.slice(),this.contexts.splice(-1),this.currentContextIds.shift();else throw new Error("Cannot exit frame, the context is empty")}nextIteration(){if(this.contexts&&this.contexts.length>0){this.contexts=this.contexts.slice(),this.lastId++;const e=Object.assign({},this.contexts[this.contexts.length-1]);e.iterationId+=1,e.id=this.lastId,this.contexts.splice(-1,1,e),this._currentContextIds.splice(0,1,this.contextIdforContexts(this.contexts))}else throw new Error("Cannot increase frame iteration, the context is empty")}getWeight(e){return this.weightMap[e]}addTensorArray(e){this.tensorArrayMap[e.id]=e}getTensorArray(e){return this.tensorArrayMap[e]}addTensorList(e){this.tensorListMap[e.id]=e}getTensorList(e){return this.tensorListMap[e]}dispose(e){for(const a in this.tensorArrayMap)this.tensorArrayMap[a].clearAndClose(e);for(const a in this.tensorListMap)this.tensorListMap[a].clearAndClose(e)}}/**
 * @license
 * Copyright 2019 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
 ...
 * limitations under the License.
 * =============================================================================
 */function V0(t,e,a,r){const i=new Set,l=[];let c=null,f=null;const h=new Set,p=new Set(Object.keys(t).map(v=>Ft(v)[0]));r=r||[];const g=new Set(r.map(v=>Ft(v.name)[0])),y=[...e];for(;y.length>0;){const v=y.pop();if((gs(v)||x8(v)||T8(v))&&c==null&&(c=v,f=c.children.map(S=>S.name).filter(S=>i.has(S))),i.add(v.name),a[v.name]==null&&!p.has(v.name)&&!g.has(v.name)){if(v.inputs.length===0){l.push(v.name);continue}v.inputs.forEach(S=>{h.has(S.name)||(h.add(S.name),y.push(S))})}}return{inputs:t,outputs:e,usedNodes:i,missingInputs:l,dynamicNode:c,syncInputs:f}}function g8(t,e){const{usedNodes:a,inputs:r}=e,i=Object.keys(r).map(A=>Ft(A)[0]).map(A=>t.nodes[A]),l=t.initNodes||[],c=A=>a.has(typeof A=="string"?A:A.name);function f(A){return[...new Map(A.map(M=>[M.name,M])).values()]}const h=f([...i,...t.weights,...l]).filter(c),p=f([...h,...Object.values(t.nodes)]).filter(c),g=new Map(p.map(A=>[A.name,A])),y={};for(const A of p){y[A.name]=y[A.name]||0;for(const M of A.children)c(M)||(y[M.name]=Number.POSITIVE_INFINITY),y[M.name]=(y[M.name]||0)+1}const v=Object.entries(y).filter(([,A])=>A===0).map(([A])=>A),S=[...v];for(;v.length>0;){const A=v.pop(),M=g.get(A);for(const X of M.children.filter(c))--y[X.name]===0&&(S.push(X.name),v.push(X.name))}const k=S.map(A=>g.get(A)),$=y8(k,h);return b8($,h),$}function y8(t,e){const a=new Map(t.map(c=>[c.name,c])),r=e.map(c=>c.name),i=new Set(r);for(;r.length>0;){const c=r.pop(),f=a.get(c);for(const h of f.children)!a.has(h.name)||i.has(h.name)||(i.add(h.name),r.push(h.name))}return t.filter(c=>i.has(c.name))}class Rl extends Error{constructor(e){super(`NodesExecutionOrderError: ${e}`)}}function b8(t,e){const a=new Map(t.map((f,h)=>[f.name,h])),r=new Set(e.map(f=>f.name)),i=f=>r.has(typeof f=="string"?f:f.name),l=new Set(t.map(f=>f.name)),c=f=>l.has(typeof f=="string"?f:f.name);for(const f of t){for(const h of f.children.filter(c)){if(!a.has(h.name))throw new Rl(`Child ${h.name} of node ${f.name} is unreachable.`);if(a.get(f.name)>a.get(h.name))throw new Rl(`Node ${f.name} is scheduled to run after its child ${h.name}.`)}if(!i(f))for(const h of f.inputs){if(!a.has(h.name))throw new Rl(`Input ${h.name} of node ${f.name} is unreachable.`);if(a.get(h.name)>a.get(f.name))throw new Rl(`Node ${f.name} is scheduled to run before its input ${h.name}.`)}}}function v8(t){const e=new Map(t.map((f,h)=>[f.name,h])),a=Number.MAX_SAFE_INTEGER,r=t.map((f,h)=>gs(f)?a:h),i=f=>{const h=r[e.get(f.name)];return h??-1},l=t.map((f,h)=>f.children.map(i).reduce((p,g)=>Math.max(p,g),r[h])),c=new Map;for(let f=0;f<t.length;++f){const h=l[f];if(h===a)continue;const p=t[f],g=t[h];c.has(g.name)||c.set(g.name,[]),c.get(g.name).push(p)}return c}const w8=new Set(["Switch","Merge","Enter","Exit","NextIteration","StatelessIf","StatelessWhile","if","While"]),S8=new Set(["NonMaxSuppressionV2","NonMaxSuppressionV3","NonMaxSuppressionV5","Where"]),N8=new Set(["HashTable","HashTableV2","LookupTableImport","LookupTableImportV2","LookupTableFind","LookupTableFindV2","LookupTableSize","LookupTableSizeV2"]);function gs(t){return w8.has(t.op)}function x8(t){return S8.has(t.op)}function T8(t){return N8.has(t.op)}/**
 * @license
 * Copyright 2018 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
