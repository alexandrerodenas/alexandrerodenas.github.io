import{_ as Rn,A as Ct,s as F,J as Js,L as Ys,M as Zs,N as eu,O as En,I as tu,cW as nu,T as Pn,Q as rt,U as tn,V as je,Z as Wn,W as Se,P as Oe,X as Be,$ as Tn,a0 as au,a1 as ru,a2 as su,a3 as uu,a4 as ou,a5 as iu,a6 as du,a9 as On,aa as st,ab as cu,ac as Ft,ad as pu,ae as lu,R as mu,z as fu,b as ge,af as Bn,ag as hu,ah as gu,cX as bu,c as fe,cY as _u,aj as yu,ak as Hn,al as Ln,am as $n,an as Iu,ao as wu,ap as Vn,cZ as ku,aq as Su,at as Mu,aw as vu,ax as zn,aB as Au,aC as xu,az as Gt,c_ as Du,aD as Un,aE as Gn,aF as ut,aH as jn,aI as qn,aJ as nn,aK as Xn,aL as Kn,aM as Nu,aN as Cu,aO as Qn,aQ as Jn,aP as Yn,aR as Zn,aS as Fu,aT as ea,aU as ta,aX as Ru,aY as na,aZ as an,a_ as aa,a$ as ra,b9 as Eu,ba as sa,bb as Pu,bc as Wu,bd as Tu,be as Ou,bf as Bu,F as Hu,x as Lu,bh as ua,bi as $u,bj as Vu,bl as oa,bm as ia,bn as da,bp as ca,bq as zu,br as Uu,bs as Gu,bt as ju,bu as qu,bw as Xu,bx as Ku,by as Qu,bz as pa,bA as Ju,bB as Yu,bC as la,bD as Zu,bE as eo,bF as to,bG as no,bH as ao,c$ as ro,bI as ma,bJ as fa,a7 as ha,bK as so,bL as ga,bM as uo,bN as oo,bO as io,bP as co,bo as po,a8 as ba,bQ as _a,bR as lo,bS as ya,bU as Ia,bV as wa,bT as mo,b1 as fo,bW as ho,bX as ka,d0 as Sa,bZ as Ma,ar as go,b$ as va,c1 as bo,c2 as _o,c3 as yo,c4 as Aa,c5 as Io,c6 as xa,c7 as Da,c8 as wo,c9 as ko,ca as So,cb as Mo,cc as vo,cd as Na,ce as Ca,cf as Fa,cg as Ra,ch as Ea,ci as Pa,cj as Ao,ck as xo,cl as Do,cm as Wa,cn as rn,co as Ta,cp as No,cq as Co,cr as Fo,cs as Ro,ct as Eo,cu as Po,cv as Wo,cw as To,d1 as Oo,d2 as Bo,d3 as Ho,d4 as Lo,d5 as Oa,d6 as $o,d7 as Vo,d8 as zo,d9 as Uo,da as Go,db as kn,dc as jo,dd as qo,de as Xo,cx as Ko,cy as Qo,cA as Ba,cC as Jo,cD as Yo,cE as Zo,cF as ei,cG as ti,cH as Ha,cI as La,cJ as ni,cK as ai,cL as ri,df as si,dg as ui,cM as oi,b2 as $a,cN as ii,cO as di,cP as Va,cz as za,cQ as Ua,cR as Ga,dh as ci,cS as pi,c0 as li,cV as mi,e as Kt,K as fi,D as hi,d as gi,di as Sn,dj as Mn,dk as bi,dl as _i,r as yi}from"./index-ryqtDeIu.js";import{s as vn,c as Ii,r as wi,a as ki,b as Si,d as Mi,u as vi}from"./Unique_impl-w2jOwOt8.js";import{c as An,g as ja}from"./index-BhIzY7-W.js";import{r as We}from"./index-YyP0D_Yu.js";function qa(r,n){for(var s=0;s<n.length;s++){const o=n[s];if(typeof o!="string"&&!Array.isArray(o)){for(const a in o)if(a!=="default"&&!(a in r)){const t=Object.getOwnPropertyDescriptor(o,a);t&&Object.defineProperty(r,a,t.get?t:{enumerable:!0,get:()=>o[a]})}}}return Object.freeze(Object.defineProperty(r,Symbol.toStringTag,{value:"Module"}))}/**
 * @license
 ...
 * =============================================================================
 */var V;(function(r){r[r.float32=0]="float32",r[r.int32=1]="int32",r[r.bool=2]="bool",r[r.string=3]="string",r[r.complex64=4]="complex64"})(V||(V={}));var at;(function(r){r[r.linear=0]="linear",r[r.relu=1]="relu",r[r.relu6=2]="relu6",r[r.prelu=3]="prelu",r[r.leakyrelu=4]="leakyrelu",r[r.sigmoid=5]="sigmoid",r[r.elu=6]="elu"})(at||(at={}));/**
 * @license
 * Copyright 2019 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
 ...
 * limitations under the License.
 * =============================================================================
 */function Za(r){let n;function s(a){n=a.wasm.cwrap(r,null,["number","number","number","number","number"])}function o(a){const{backend:t,inputs:i,attrs:d}=a,{axis:c}=d,{x:u}=i,e=t.dataIdMap.get(u.dataId).id;let m=e,b=u;const{transposed:l,axes:f,inputWasTransposed:g}=xe(u,c,t);if(g){const E=t.dataIdMap.get(l.dataId).id;E!==e&&(b=l,m=E)}const w=b.shape.slice(0,-1),k=t.makeOutput(w,"int32"),y=t.dataIdMap.get(k.dataId).id,_=F(k.shape),v=b.shape[f[0]];return n(m,V[b.dtype],_,v,y),g&&t.disposeData(l.dataId),k}return{kernelName:r,backendName:"wasm",setupFunc:s,kernelFunc:o}}/**
 * @license
 * Copyright 2019 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
 ...
 * limitations under the License.
 * =============================================================================
 */let sr;function kd(r){sr=r.wasm.cwrap(Vn,null,["number","number","boolean","number","number","number"])}function Sd(r){const{backend:n,inputs:s,attrs:o}=r,{x:a,weights:t}=s,{size:i}=o,d=t.shape.reduce((m,b)=>m*b,1)!==0,c=a.shape.length===1?[i]:[a.shape[0],i],u=n.makeOutput(c,t.dtype);function e(m){return n.dataIdMap.get(m.dataId).id}return sr(e(a),i,d,e(t),V[t.dtype],e(u)),u}const Md={kernelName:Vn,backendName:"wasm",setupFunc:kd,kernelFunc:Sd};/**
 * @license
 * Copyright 2023 Google LLC.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
 ...
 * limitations under the License.
 * =============================================================================
 */let Nr;function Yc(r){Nr=r.wasm.cwrap(ca,null,["number","number","number","number","number","number","array","number"])}function Zc(r){const{backend:n,inputs:s}=r,{params:o,indices:a}=s,[t,i,d,c]=zu(o,a),u=n.makeOutput(t,o.dtype);if(i===0)return u;const e=a.shape,m=e[e.length-1],l=n.dataIdMap.get(o.dataId).id,g=n.dataIdMap.get(a.dataId).id,w=new Uint8Array(new Int32Array(c).buffer),k=n.dataIdMap.get(u.dataId).id;return Nr(l,V[o.dtype],g,i,m,d,w,k),u}const ep={kernelName:ca,backendName:"wasm",setupFunc:Yc,kernelFunc:Zc};/**
 * @license
 * Copyright 2019 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
 ...
 * limitations under the License.
 * =============================================================================
 */let Cr;function tp(r){Cr=r.wasm.cwrap("Gather",null,["number","number","array","number","number","number","array","number"])}function np(r){const{backend:n,inputs:s,attrs:o}=r,{x:a,indices:t}=s,{axis:i,batchDims:d}=o,c=rt(i,a.shape)[0],u=n.readSync(t.dataId),e=a.shape[c];for(let z=0;z<u.length;++z){const H=u[z];ge(H<=e-1&&H>=0,()=>`GatherV2: the index value ${H} is not in [0, ${e-1}]`)}const m=Gu(a,t,c,d),b=oe({inputs:{x:a},attrs:{shape:[m.batchSize,m.outerSize,m.dimSize,m.sliceSize]},backend:n}),l=F(t.shape),f=oe({inputs:{x:t},attrs:{shape:[m.batchSize,l/m.batchSize]},backend:n}),g=[m.batchSize,m.outerSize,l/m.batchSize,m.sliceSize],w=n.makeOutput(g,a.dtype);if(F(a.shape)===0)return w;const k=b.shape.length-1,_=n.dataIdMap.get(b.dataId).id,E=n.dataIdMap.get(f.dataId).id,R=n.dataIdMap.get(w.dataId).id,O=new Uint8Array(new Int32Array(fe(b.shape)).buffer),$=new Uint8Array(new Int32Array(fe(g)).buffer);return Cr(_,V[a.dtype],O,k,E,m.batchSize,$,R),n.disposeData(b.dataId),n.disposeData(f.dataId),w.shape=m.outputShape,w}const ap={kernelName:Uu,backendName:"wasm",setupFunc:tp,kernelFunc:np};/**
 * @license
 * Copyright 2019 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
 ...
 * limitations under the License.
 * =============================================================================
 */let Fr;function pp(r){Fr=r.wasm.cwrap(pa,null,["number","number","number","number"])}function lp(r){const{inputs:{x:n},attrs:{alpha:s},backend:o}=r,a=o.dataIdMap.get(n.dataId).id,t=o.makeOutput(n.shape,"float32");if(F(n.shape)!==0){const i=o.dataIdMap.get(t.dataId).id;Fr(a,V[n.dtype],s,i)}return t}const mp={kernelName:pa,backendName:"wasm",setupFunc:pp,kernelFunc:lp};/**
 * @license
 * Copyright 2019 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
 ...
 * limitations under the License.
 * =============================================================================
 */let Tr;function Lp(r){Tr=r.wasm.cwrap(ga,null,["number","number","number","number","number","number","number","number","number","number","number","number","number","number","number","number","number"])}function $p(r){const{inputs:n,attrs:s,backend:o}=r,a=n.x,t=o.dataIdMap.get(a.dataId).id;ge(a.dtype==="float32",()=>`Error in MaxPool: only float32 input is supported. Got ${a.dtype}.`);const{filterSize:i,strides:d,pad:c,dimRoundingMode:u}=s,e=st(a.shape,i,d,1,c,u),m=e.filterHeight,b=e.filterWidth,l=e.padInfo.top,f=e.padInfo.right,g=e.padInfo.bottom,w=e.padInfo.left,k=e.dilationHeight,y=e.dilationWidth,_=e.strideHeight,v=e.strideWidth,E=e.inChannels,R=e.outChannels;if(e.dataFormat!=="channelsLast")throw new Error(`wasm backend does not support dataFormat:'${e.dataFormat}'. Please use 'channelsLast'.`);const O=o.makeOutput(e.outShape,"float32"),$=o.dataIdMap.get(O.dataId).id;return Tr(t,a.shape[0],a.shape[1],a.shape[2],m,b,l,f,g,w,k,y,_,v,E,R,$),O}const Vp={kernelName:ga,backendName:"wasm",setupFunc:Lp,kernelFunc:$p};/**
 * @license
 * Copyright 2023 Google LLC.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
 ...
 * limitations under the License.
 * =============================================================================
 */let $r;function tl(r){$r=r.wasm.cwrap(ba,null,["number, number, number"])}function nl(r){const{backend:n,inputs:s,attrs:o}=r,{axis:a,keepDims:t}=o,{x:i}=s,d=n.dataIdMap.get(i.dataId).id;let c=d,u=i;const{transposed:e,axes:m,originalAxes:b,inputWasTransposed:l}=xe(i,a,n);let f=m;if(l){const v=n.dataIdMap.get(e.dataId).id;v!==d&&(u=e,c=v,f=je(f.length,u.shape.length))}Se("mean",f,u.shape.length);const[g,w]=Oe(u.shape,f),k=F(w);let y=u;u.dtype!=="float32"&&(y=De({backend:n,inputs:{x:u},attrs:{dtype:"float32"}}),c=n.dataIdMap.get(y.dataId).id);const _=n.makeOutput(g,"float32");if(F(u.shape)!==0){const v=n.dataIdMap.get(_.dataId).id;$r(c,k,v)}if(l&&n.disposeData(e.dataId),t){const v=Be(_.shape,b);_.shape=v}return u.dtype!=="float32"&&n.disposeData(y.dataId),_}const al={kernelName:ba,backendName:"wasm",setupFunc:tl,kernelFunc:nl};/**
 * @license
 * Copyright 2019 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
 ...
 * limitations under the License.
 * =============================================================================
 */let os;function _m(r){os=r.wasm.cwrap(Wa,null,["number","number","number","number","number","number","array","number","number"])}function ym(r){const{backend:n,inputs:s,attrs:o}=r,{indices:a,updates:t}=s,{shape:i}=o,d=n.makeOutput(i,t.dtype);if(F(i)===0)return d;const{sliceRank:c,numUpdates:u,sliceSize:e,strides:m,outputSize:b}=rn(t,a,i),f=n.dataIdMap.get(a.dataId).id,w=n.dataIdMap.get(t.dataId).id,k=new Uint8Array(new Int32Array(m).buffer),y=n.dataIdMap.get(d.dataId).id;return os(f,w,V[t.dtype],c,u,e,k,b,y),d}const Im={kernelName:Wa,backendName:"wasm",setupFunc:_m,kernelFunc:ym};/**
 * @license
 * Copyright 2023 Google LLC.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
 ...
 * limitations under the License.
 * =============================================================================
 */let ys;function hf(r){ys=r.wasm.cwrap($a,null,["number","number","number","number"])}function gf(r){const{backend:n,inputs:s,attrs:o}=r,{axis:a,keepDims:t}=o,{x:i}=s,d=n.dataIdMap.get(i.dataId).id;let c=d,u=i;const{transposed:e,axes:m,originalAxes:b,inputWasTransposed:l}=xe(i,a,n);let f=m;if(l){const _=n.dataIdMap.get(e.dataId).id;_!==d&&(u=e,c=_,f=je(f.length,u.shape.length))}Se("sum",f,u.shape.length);const[g,w]=Oe(u.shape,f),k=F(w),y=n.makeOutput(g,u.dtype);if(F(u.shape)!==0){const _=n.dataIdMap.get(y.dataId).id;ys(c,k,V[y.dtype],_)}if(l&&n.disposeData(e.dataId),t){const _=Be(y.shape,b);y.shape=_}return y}const bf={kernelName:$a,backendName:"wasm",setupFunc:hf,kernelFunc:gf};/**
 * @license
 * Copyright 2021 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
 ...
 * limitations under the License.
 * =============================================================================
 */let ks;function Af(r){ks=r.wasm.cwrap(Ua,null,["number","array","number","number","number","bool","number","number"])}const xf=({inputs:r,backend:n,attrs:s})=>{const{x:o}=r,{k:a,sorted:t}=s,i=n.dataIdMap.get(o.dataId).id,d=new Uint8Array(new Int32Array(o.shape).buffer),c=o.shape.slice();c[c.length-1]=a;const u=n.makeOutput(c,o.dtype),e=n.dataIdMap.get(u.dataId).id,m=n.makeOutput(c,"int32"),b=n.dataIdMap.get(m.dataId).id;return ks(i,d,o.shape.length,V[o.dtype],a,t,e,b),[u,m]},Df={kernelName:Ua,backendName:"wasm",setupFunc:Af,kernelFunc:xf};/**
 * @license
 * Copyright 2021 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
 ...
 * limitations under the License.
 * =============================================================================
 */const Bf=[Di,Ni,Ci,Fi,Ri,Wi,zi,ji,qi,Xi,Ki,Qi,Ji,Yi,Zi,nd,pd,sd,id,hd,wd,Md,vd,xd,Dd,Nd,Rd,Ed,Td,Hd,Vd,Gd,Xd,Kd,Qd,Zd,nc,sc,ic,pc,fc,bc,Ic,Sc,Ac,xc,Cc,Rc,Ec,Pc,Wc,Tc,Oc,Lc,$c,Vc,Gc,Xc,Jc,ep,ap,sp,op,Ti,ip,dp,cp,mp,hp,bp,Ip,kp,wp,Mp,vp,xp,Np,Rp,Wp,Bp,Hp,Vp,Gp,Xp,Jp,el,al,ul,ol,cl,hl,gl,bl,_l,wl,Ml,xl,Nl,Rl,Pl,Tl,Yr,Hl,Vl,Gl,ql,Xl,Kl,Ql,Jl,ld,em,am,um,dm,lm,hm,gm,bm,Im,Sm,Am,xm,Cm,Fm,Rm,Em,yd,ll,Pm,Tm,Hm,Vm,Um,jm,Km,Jm,Ym,Zm,ef,af,uf,df,pf,mf,ff,bf,_f,yf,kf,vf,Df,Ff,Li,Ef,Wf,Of];for(const r of Bf)mi(r);/**
 * @license
 * Copyright 2020 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
